...
$(document).ready(function(){
	...
	columns = [
				{name:"organization.orgName",caption:"区域",width:120,mode:"string"},
   			    {name:"contradictionSum",caption:"民生服务",width:80,mode:"number",format:"#"},
   			    {name:"resolveTheContradictionSum",caption:"矛盾劝解",width:80,mode:"number",format:"#"},
   			    {name:"securityPrecautionSum",caption:"参与治安防控",width:80,mode:"number",format:"#"},
   			    {name:"specialPopulationSum",caption:"参与特殊人群服务管理",width:80,mode:"number",format:"#"},
   			    {name:"socialConditionSum",caption:"社情民意收集",width:80,mode:"number",format:"#"},
   			    {name:"policiesAndLawSum",caption:"法律法规宣传",width:80,mode:"number",format:"#"},
			    {name:"emergencieSum",caption:"突发事件报告",width:80,mode:"number",format:"#"},
			    {name:"otherManageSum",caption:"其它",width:80,mode:"number",format:"#"}
			];
