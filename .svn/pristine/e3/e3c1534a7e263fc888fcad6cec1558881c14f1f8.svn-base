...
if(<%=AnalyseUtilNew.IS_NEWANALYSE_JOB%>){
	var area_data_table_url = "${path}/baseinfo/companyPlaceManageNew/statisticsBaseInfo.action";
	var data_month_table_url = "${path}/baseinfo/companyPlaceManageNew/statisticsSummary.action";
}else{
	var area_data_table_url = "${path}/baseinfo/companyPlaceManage/statisticsBaseInfo.action";
	var data_month_table_url = "${path}/baseinfo/companyPlaceManage/statisticsSummary.action";
}
