...
<div id="dialog-form" title="" class="container container_24">
	...
	<pop:token />
		...
		<div class="grid_6 lable-right">
			<label class="form-lbl">管理人员：</label>
		</div>
		...
		<div class="grid_6 lable-right">
			<label class="form-lbl">管理时间：</label>
		</div>
		<div class="grid_15">
		...
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_6 lable-right">
			<label class="form-lbl">管理地点：</label>
		</div>
		<div class="grid_15">
		...
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_6 lable-right">
			<label class="form-lbl">管理情况：</label>
		</div>
		<div class="grid_15">
	...
	<s:if test='"edit".equals(mode)'>
		...
		$("#helpPrecordForm").formValidate({
			...
			messages:{
				...
				"helpPrecord.address":{
					required:"管理地址不能为空",
					maxlength:$.format("管理地址最多输入{0}个字符")
				}
				,
				"helpPrecord.events":{
					maxlength:$.format("管理情况最多输入{0}个字符")
				}
