...
<jsp:include page="/baseinfo/leaderView/populationStatistics/gridCommonStatistics.jsp" >
	<jsp:param name="populationType" value="householdStaff" />
	<jsp:param name="areaDataTableUrl" value="${path}/baseinfo/leaderViewManage/statisticsYouthsCount.action?tableType=${keyType}&isGrid=true" />
	<jsp:param name="dataMonthTableUrl" value="${path}/baseinfo/leaderViewManage/statisticsYouthsMonthSummary.action?tableType=${keyType}&isGrid=true"/>
</jsp:include>
