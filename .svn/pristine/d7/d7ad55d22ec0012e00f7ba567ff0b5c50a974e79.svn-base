...
<div id="tabList">
	<ul>
		<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=need&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">待办&nbsp;&nbsp;&nbsp;&nbsp;<label id="doingCount" class="issueCount"></label></a> </li>
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=done&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">程序性办结&nbsp;&nbsp;&nbsp;&nbsp;<label id="doneCount" class="issueCount"></label></a></li>
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=period&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">阶段性办结&nbsp;&nbsp;&nbsp;&nbsp;<label id="periodCount" class="issueCount"></label></a></li>
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=completed&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">实质性办结&nbsp;&nbsp;&nbsp;&nbsp;<label id="completedCount" class="issueCount"></label></a></li>
		<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=createAndDone&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">已办&nbsp;&nbsp;&nbsp;&nbsp;<label id="createAndDoneCount" class="issueCount"></label></a> </li>
		<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=feedback&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">待反馈&nbsp;&nbsp;&nbsp;&nbsp;<label id="feedbackCount" class="issueCount"></label></a> </li>
		<c:if test="${!(fn:endsWith(loginAction.user.organization.departmentNo, '1jg')||fn:endsWith(loginAction.user.organization.departmentNo, 'lxw')||fn:endsWith(loginAction.user.organization.departmentNo, '1lx'))}">
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=assign&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">上级交办&nbsp;&nbsp;&nbsp;&nbsp;<label id="assignCount" class="issueCount"></label></a> </li>
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=submit&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">上报&nbsp;&nbsp;&nbsp;&nbsp;<label id="submitCount" class="issueCount"></label></a> </li>
		</c:if>
		<c:if test="${isShow}">	
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=support&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">协办&nbsp;&nbsp;&nbsp;&nbsp;<label id="supportCount" class="issueCount"></label></a></li>
		</c:if>
		<c:if test="${isShowNotice}">	
			<li><a href="${path}/account/steadyRecord/ledgerSteadyWorkRecordViewList.jsp?viewType=notice&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">抄告&nbsp;&nbsp;&nbsp;&nbsp;<label id="noticeCount" class="issueCount"></label></a></li>
		</c:if>
	</ul>
 	</div>
<script>
