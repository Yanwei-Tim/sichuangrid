...
public class PreciseInboxDaoImpl extends AbstractBaseDao implements
	...
	public Long findPreciseInboxByFromUserNameTotal(String fromUserName) {
		...
		return (Long) getSqlMapClientTemplate()
				.queryForObject(
						"preciseInbox.countFindPreciseInboxAndInboxAndIssuesByFromUserName",
						map);
	}
	...
	public ArrayList<PreciseInbox> findPreciseInboxPaging(
		...
		return (ArrayList<PreciseInbox>) getSqlMapClientTemplate()
				.queryForList("preciseInbox.findPreciseInboxPaging", map);
	}
	...
	public List<PreciseInbox> findPreciseInboxsByDealStateAndIsRead(
		...
		return (List<PreciseInbox>) getSqlMapClientTemplate().queryForList(
				"preciseInbox.findPreciseInboxsByDealStateAndIsRead",
				preciseInbox);
	}
