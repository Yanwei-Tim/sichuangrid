...
<div class="container container_24">
	<s:action name="ajaxOrganization" var="findById" namespace="/sysadmin/orgManage" executeResult="false">
		<s:param name="organization.id" value="@com.tianque.util.ThreadVariable@getOrganization().id"></s:param>
	</s:action>
...
$(document).ready(function(){
	$("#OrgName").treeSelect({
		...
		listWidth:260,
		maxHeight:300,
		rootId:'<s:if test="#findById.organization.orgType.internalId==@com.tianque.domain.property.OrganizationType@FUNCTIONAL_ORG"><s:property value="#findById.organization.parentOrg.id"/></s:if><s:else><s:property value="@com.tianque.util.ThreadVariable@getOrganization().id"/></s:else>',
		onSelect:function(){
