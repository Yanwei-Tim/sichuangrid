...
@Service("baseInfoStatTypeNewService")
public class BaseInfoStatTypeNewServiceImpl extends AbstractBaseService
		implements BaseInfoStatTypeNewService {
	...
	private void deleteAllDataByYearAndMonthAndPlaceMap(String baseinfotype,
		...
		baseInfoStatTypeNewDao.deleteByYearAndMonth(baseinfotype, types, year,
				month);
	}
	...
	private void createBaseInfoStatType(int total, String propertyDictName,
		...
		baseInfoStatTypeNewDao.addBaseInfoStatType(baseInfoStatType);
	}
	...
	private int getObjectSumfor(Map<String, Object> map) {
		...
		return baseInfoStatTypeNewDao.getOBjectSumOrMonthCreate(map);
	}
