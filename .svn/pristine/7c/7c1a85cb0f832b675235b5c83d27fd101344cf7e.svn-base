		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${town.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${town.beneficiaryNumber}</td>
					</tr>
					<c:if test="${town.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TOWN_PROJECT_BUILD_TYPE" defaultValue="${town.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${town.projectCategory.id != null}">
			       	<tr>
			        	<td class="title">项目类别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TOWN_PROJECT" defaultValue="${town.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${town.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">建设类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TOWN_PROJECT_SUB" defaultValue="${town.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			    	<tr>
						<td class="title">建设起点</td><td class="contable">${town.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${town.toAddress}</td>
					</tr>
			       	<tr>
						<td class="title">项目库编号</td><td class="contable">${town.projectNumber}</td>
					</tr>
					<tr>
						<td class="title">数量</td><td class="contable">${town.scopeNumber}</td>
					</tr>
					<tr>
						<td class="title">面积</td><td class="contable">${town.area}</td>
					</tr>
					<tr>
						<td class="title">里程(公里)</td><td class="contable">${town.mileage}</td>
					</tr>
					
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${town.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${town.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${town.gapFund}</td>
					</tr>
