...
<s:iterator  value="leaderTeamList" var="leaderTeam" status="s" >
	<li data-id="<s:property value="#leaderTeam.id" />" data-index="<s:property value="#s.index+1" />" id="leaderInfo<s:property value="#leaderTeam.id" />">
			...
			<div class="smallText">
				<span class="post">姓名:</span><span class="name"><s:property value="#leaderTeam.name" /></span>
			   ...
			   <s:elseif test="#leaderTeam.gender !=null && #leaderTeam.gender ==1 ">
				...
				</br><span class="post">年龄：</span><s:property value="#leaderTeam.age" />
				</br><span class="post">职务：</span><strong class="post"><s:if test="#leaderTeam.duty!=null"><s:property value="#leaderTeam.duty" /></s:if></strong>
				<span class="post">介绍：</span><p class="info">
				<s:if test="#leaderTeam.introduction!=null">
...
function updateLeaderInfo(obj){
	   ...
	   $("#leaderTeamMaintanceDialog").createDialog({
			...
			title:'修改领导班子成员',
			modal : true,
			url:"${path}/baseinfo/basicInfomationManage/dispatchLeaderOperate.action?mode=edit&newVillageLeaderTeam.id="+leaderId,
			buttons :{
				"保存" : function(){
