...
/**
 * @Description:刑释人员自动取消关注job
 * @author zhangyouwei@hztianque.com
 * @date: 2015-6-11 上午09:41:28
 */
@Component("positiveInfoNewDispatch")
public class PositiveInfoNewDispatch implements Serializable {

	private static Logger logger = LoggerFactory
			.getLogger(PositiveInfoNewDispatch.class);
	@Autowired
	...
	public void emphasisPositiveInfoJob() {
