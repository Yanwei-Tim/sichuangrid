...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			...
			<li><a href="${path }/statAnalyse/baseInfoStat/idleyouth/statisticsIdleyouthColumn.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/idleyouth/statisticsIdleyouthPie.jsp">年龄区间分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/idleyouth/statisticsIdleyouthList.jsp">列表信息</a></li>
