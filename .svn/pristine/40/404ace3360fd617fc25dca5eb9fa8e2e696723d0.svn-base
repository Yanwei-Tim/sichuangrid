...
<!-- 			</div> -->
		...
		<pop:JugePermissionTag ename="searchChlidPeopleAspiration">
		...
		<pop:JugePermissionTag ename="normalChlidPeopleAspiration">
...
// 	    	{name:"operator", index:'id',label:'操作',formatter:operatorFormatter,width:65,frozen:true,sortable:false,align:'center' },
			...
			{name:'', index:'',label:'记录情况', width:100, sortable:true, align:'center', hidden:false}	,
	...
	$("#searchPeopleAspiration").click(function(event){
		$("#peopleaspirationsDialog").createDialog({
			...
			title:'民生诉求表查询-请输入查询条件',
 	 		url:'${path}/xichang/working/peopleAspiration/searchPeopleAspirationDlg.jsp?orgId='+$("#orgId").val()+"&displayLevel="+$("#displayLevel").val(),
			buttons: {
		   		"查询" : function(event){
