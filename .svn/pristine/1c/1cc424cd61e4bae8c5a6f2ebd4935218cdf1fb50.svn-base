	...
	<table id="issueAccordingPrint" width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <div id="copyAddFamilyMembersParent">
        	...
        	<tr class="tr1">
        		 ...
        		 <td style="text-align: left;font-Size:10px; height:20px;" colspan = "9">
        		  社区矫正人员<input disabled type="checkbox" name="steadyWorkProblemType" value="社区矫正人员">易肇事肇祸严重精神障碍患者<input disabled type="checkbox" name="steadyWorkProblemType" value="易肇事肇祸严重精神障碍患者">重点青少年或群体<input disabled type="checkbox" name="steadyWorkProblemType" value="重点青少年或群体">
