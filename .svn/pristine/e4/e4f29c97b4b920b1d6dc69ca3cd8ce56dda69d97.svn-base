		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${energy.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${energy.beneficiaryNumber}</td>
					</tr>
					<c:if test="${energy.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_BUILD_TYPE" defaultValue="${energy.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       	...
			       	<tr>
			        	...
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_PROJECT" defaultValue="${energy.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${energy.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">工程类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_PROJECT_SUB_TYPE" defaultValue="${energy.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${energy.lineCategory.id != null}">
			       	<tr>
			        	<td class="title">线路类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_LINE_CATEGORY" defaultValue="${energy.lineCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${energy.pipeLineCategory.id != null}">
			       	<tr>
			        	<td class="title">管道类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_PIPELINE_CATEGORY" defaultValue="${energy.pipeLineCategory.id}" /></td>
			       	</tr>
			       	</c:if>
					<c:if test="${energy.pipeMaterialCategory.id != null}">
			       	<tr>
			        	<td class="title">管道材质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_PIPE_MATERIAL_CATEGORY" defaultValue="${energy.pipeMaterialCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${energy.securityCategory.id != null}">
			       	<tr>
			        	<td class="title">安全设施类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENERGY_SECURITY_CATEGORY" defaultValue="${energy.securityCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	
			       	<tr>
						<td class="title">容积(立方米)</td><td class="contable">${energy.capacity}</td>
					</tr>
					
					<tr>
						<td class="title">长度（公里）</td><td class="contable">${energy.mileage}</td>
					</tr>
					<tr>
						<td class="title">填埋深度（米）</td><td class="contable">${energy.depth}</td>
					</tr>
					
			       	
					<tr>
						<td class="title">数量</td><td class="contable">${energy.energyNumber}${energy.securityNum}</td>
					</tr>
					
					<tr>
						<td class="title">建设起点</td><td class="contable">${energy.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${energy.toAddress}</td>
					</tr>
					
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${energy.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${energy.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${energy.gapFund}</td>
					</tr>
