...
/** * 事件 */
public class FourTeamsIssueNew extends BaseDomain {
	/** 服务单号 */
	...
	/** 当前处理步骤，如果完全结束后，重置为空 */
	private FourTeamsIssueStep currentStep;
	/** 经度 */
	private Double lon;
	/** 纬度 */
	private Double lat;
	 ...
	 * 主要当事人
	 */
	private List<FourTeamsIssueRelatedPeople> issueRelatedPeoples;
	...
	public FourTeamsIssueStep getCurrentStep() {
		return currentStep;
	}

	public void setCurrentStep(FourTeamsIssueStep currentStep) {
	...
	public void setIssueRelatedPeoples(
			List<FourTeamsIssueRelatedPeople> issueRelatedPeoples) {
		this.issueRelatedPeoples = issueRelatedPeoples;
	}

	public List<FourTeamsIssueRelatedPeople> getIssueRelatedPeoples() {
