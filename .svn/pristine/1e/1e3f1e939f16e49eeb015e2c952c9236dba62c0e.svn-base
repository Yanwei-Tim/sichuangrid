...
<table style="width: 5000px;" class="countlist" id="tableId">
	<tr> 
		<td colspan="26" id="timeShow" style="height: 50px;text-align: center;font-size: 24px;color: black;font-weight: bold;">
		中江县三本台账工作民生信息情况统计表(医疗卫生类)(第一部分)
		</td>
		<td colspan="24" id="timeShow" style="height: 50px;text-align: center;font-size: 24px;color: black;font-weight: bold;">
		中江县三本台账工作民生信息情况统计表(医疗卫生类)(第二部分)
		</td>
	</tr>
	<tr>
	...
	<tr class="countlistHead" style="text-align: center;">
		...
		<td colspan="8" style="text-align: center;">合计</td>
		<td colspan="7" style="text-align: center;">食品卫生</td>
		<td colspan="7" style="text-align: center;">公共卫生服务</td>
		<td colspan="3" style="text-align: center;">医疗服务</td>
		<td colspan="4" style="text-align: center;">医疗服务</td>
		<td colspan="2" style="text-align: center;">新农合</td>
		<td colspan="7" style="text-align: center;">服务能力建设</td>
