...
<div class="zt_tabs_style">
	<div id="chartsTabs">
	<ul>
		 <li><a href="${path }/statAnalyse/baseInfoStat/careObject/statisticTotalListColumn.ftl?type=all_civil_population">区域分布图</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/careObject/statisticTotalPie.ftl?type=all_civil_population">类型分布图</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/careObject/statisticTotalList.ftl?type=all_civil_population">列表信息</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/common/tendencyChartForPositiveinfo.ftl?tableNameKey=all_civil_population">趋势图</a></li>
	</ul>
	</div>
