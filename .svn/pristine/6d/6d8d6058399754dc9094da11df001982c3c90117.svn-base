 ...
 */
@DynamicIbatisDAO(value = "UserActivateReportNewDAO", sqlMapClientTemplate = "sqlMapClientTemplate")
@Repository("UserActivateReportNewDAO")
public interface UserActivateReportNewDAO {
