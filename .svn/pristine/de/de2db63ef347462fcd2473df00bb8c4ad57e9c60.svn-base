...
public class UserAccountLoginDetailController extends SearchBaseAction{
	...
	private List<UserAccountLoginStatisticsVo> listVo;
	private Long userId;
	/** 导出本页或全部标识 */
	private boolean pageOnly;
	private UserAccountSearchVo userAccountSearchVo;
	 ...
	 * @return
	 */
	@Actions(value = { @Action(value = "viewUserAccountLoginStatistics", results = {
			@Result(name = "success", location = "/userCount/viewAccountLoginStatistics.jsp"),
			@Result(name = "error", type = "json", params = { "root",
					"errorMessage", "ignoreHierarchy", "false" }) }) })
	public String viewUserAccountLoginStatistics() throws Exception{
		if(organization==null || organization.getId()==null){
			errorMessage="查询失败，未获得参数信息";
			return ERROR;
		}
		organization = organizationDubboService.getSimpleOrgById(organization.getId());
		listVo = userAccountLoginDetailService.getAccountLoginDetailStatistics(organization.getId());
		return SUCCESS;
	}
	 ...
	 * @return
	 */
	@Actions(value = { @Action(value = "searchAccount", results = {
			@Result(name = "success", location = "/userCount/searchAccountDialog.jsp"),
			@Result(name = "error", type = "json", params = { "root",
					"errorMessage", "ignoreHierarchy", "false" }) }) })
	public String searchAccount() throws Exception{
		if(organization==null || searchType==null){
			errorMessage="查询失败，未获得参数信息";
			return ERROR;
		}
		return SUCCESS;
	...
	@Action(value = "searchUserAccountForPageResult", results = {
			@Result(name = "success", type = "json", params = { "root",
					"gridPage", "ignoreHierarchy", "false" }),
			@Result(name = "error", type = "json", params = { "root",
					"errorMessage", "ignoreHierarchy", "false" }) })
	public String searchUserAccountForPageResult() throws Exception {
		if(userAccountSearchVo==null || userAccountSearchVo.getOrganization()==null || userAccountSearchVo.getSearchType()==null){
			errorMessage="查询失败，未获得正确查询参数";
			return ERROR;
		}
		PageInfo<UserAccountLoginDetail> pageInfo = ControllerHelper
		.proccessRelativeOrgNameByPageInfo(userAccountLoginDetailService.searchUserAccountForPageResult(userAccountSearchVo, page, rows, "orgCode", sord),
	...
	public String findUserAccountForPageResult() throws Exception {
		...
		PageInfo<UserAccountLoginDetail> pageInfo = ControllerHelper
		.proccessRelativeOrgNameByPageInfo(userAccountLoginDetailService.findUserAccountLoginDetailForPageResult(organization, searchType, page, rows, "orgCode", sord),
				organizationDubboService);
		gridPage = new GridPage<UserAccountLoginDetail>(pageInfo);
		return SUCCESS;
	}
	...
	public UserAccountSearchVo getUserAccountSearchVo() {
		return userAccountSearchVo;
	}

	public void setUserAccountSearchVo(UserAccountSearchVo userAccountSearchVo) {
		this.userAccountSearchVo = userAccountSearchVo;
	}

	public List<UserAccountLoginStatisticsVo> getListVo() {
		return listVo;
	}

	public void setListVo(List<UserAccountLoginStatisticsVo> listVo) {
		this.listVo = listVo;
	}
