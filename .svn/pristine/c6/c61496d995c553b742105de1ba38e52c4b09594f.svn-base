...
public class User extends BaseDomain {
	...
	private String imei;
	/** 新版本首次登录时间 */
	private Date newVersionFirstLoginTime;
	/** 手机型号 */
	...
	@JSON(format = "yyyy-MM-dd HH:mm:ss")
	public Date getNewVersionFirstLoginTime() {
		return newVersionFirstLoginTime;
	}

	public void setNewVersionFirstLoginTime(Date newVersionFirstLoginTime) {
		this.newVersionFirstLoginTime = newVersionFirstLoginTime;
	}
