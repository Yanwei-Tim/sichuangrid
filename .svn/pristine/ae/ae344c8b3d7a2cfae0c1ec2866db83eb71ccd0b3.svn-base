 ...
 * 
 */
@Component("issueClassificationReportStatJob")
public class IssueClassificationReportStatJob extends
	...
	public List<Long> queryTasks(String taskParameter, String ownSign,
		...
		List<Long> result = issueReportService.findOrgByCondition(taskItemNum,
				...
				QueryType.ISSUE_CLASSIFICATION_STAT_TAB);
		return result;
	}
	...
	public boolean execute(Long taskId, String ownSign) throws Exception {
		...
		issueReportService.addIssueClassificationStats(date, taskId,null);
		return true;
	}
	...
	public String getJobRemark() {
		return ScheduleNameConstant.ISSUE_CLASSIFICATION_REPORTSTAT_JOB_REMARK;
	}
