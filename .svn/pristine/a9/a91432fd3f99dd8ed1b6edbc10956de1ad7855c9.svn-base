package com.tianque.fourTeams.fourTeamsIssue.approval.dao.impl;
...
import com.tianque.fourTeams.fourTeamsIssue.approval.dao.FourTeamsApprovalItemDao;

@Repository("fourTeamsApprovalItemDao")
public class FourTeamsApprovalItemDaoImpl extends
		BaseDaoImpl<ApprovalItem, ApprovalItem> implements
		FourTeamsApprovalItemDao {
