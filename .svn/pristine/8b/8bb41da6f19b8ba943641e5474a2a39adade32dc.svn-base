...
var gridOption = {
		colNames:['id','encryptId','orgId','操作','关注程度','姓名','性别','身份证号码','常住地址','所属区域(网格)','户籍地',
		          '工作单位或就读学校','危险从业类别','有无服务成员','最新服务时间','数据来源','数据更新时间','从业资格证书','从业资格证书号','有效期','法人代表','法人联系手机','法人联系电话',
	   	...
	   	colModel:[
		    ...
		    {name:'dangerousWorkingType',formatter:dangerousWorkingTypeFormatter,sortable:true,width:100},
