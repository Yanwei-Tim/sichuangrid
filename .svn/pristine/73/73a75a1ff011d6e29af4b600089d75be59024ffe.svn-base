		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${waterResource.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${waterResource.beneficiaryNumber}</td>
					</tr>
					<c:if test="${waterResource.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LEDGER_WATEER_BUILD_TYPE" defaultValue="${waterResource.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
					<c:if test="${waterResource.projectCategory.id != null}">
			       	<tr>
			        	<td class="title">项目类别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LEDGER_WATEER_PROJECT" defaultValue="${waterResource.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${waterResource.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">工程类别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LEDGER_WATEER_PROJECT_SUB_TYPE" defaultValue="${waterResource.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
					
					<tr>
						<td class="title">集中供水(处)</td><td class="contable">${waterResource.centralized}</td>
					</tr>
					<tr>
						<td class="title">数量(口、节)</td><td class="contable">${waterResource.num}</td>
					</tr>
					<tr>
						<td class="title">分散供水(日供水量:方)</td><td class="contable">${waterResource.scatter}</td>
					</tr>
					<tr>
						<td class="title">蓄水量</td><td class="contable">${waterResource.impoundage}</td>
					</tr>
					<tr>
						<td class="title">里程(公里)</td><td class="contable">${waterResource.mileage}</td>
					</tr>
					<tr>
						<td class="title">建设起点</td><td class="contable">${waterResource.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${waterResource.toAddress}</td>
					</tr>
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${waterResource.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${waterResource.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${waterResource.gapFund}</td>
					</tr>
