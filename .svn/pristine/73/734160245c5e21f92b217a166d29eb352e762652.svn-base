...
<html>
   ...
   <style>
    ...
    <body>
        <div class="page cell">
            <h1 class="page_title" style="color:black">发现治安隐患报送</h1>
            ...
            <!-- 消息类型 -->
            <input id="inboxType" name="preciseInbox.inboxType"  type="hidden" value="1" />
            ...
            <form id = "hiddenDanger" action="<%=proxyIp%>/weChat/preciseInbox/addPreciseInbox.action" method="post">
            ...
            <div class="weui_cell">
               ...
               <div class="weui_cell_bd weui_cell_primary">
                   <input class="weui_input" id="reportPeoplePhoneNumber" maxlength="11" name="preciseInbox.reportPeoplePhoneNumber" value="${redCuffTeam.phoneNumber}" type="number" placeholder="请输入手机号码">
               </div>
            </div>
            
            <div class="weui_cells_title"><label style="color:red;">*</label><span style="color:black;">异常类型:</span></div>
            <div class="weui_cells weui_cells_split">
               <div class="weui_cell weui_cell_select">
                   <div class="weui_cell_bd weui_cell_primary">
                       <select class="weui_select" id="exceptionType" name="preciseInbox.exceptionType.id" oninvalid="这是必选选项" >
            ...
            <div class="weui_cells_title"><label style="color:red;">*</label><span style="color:black;">异常情况:</span></div>
            <div class="weui_cells weui_cells_form">
                <div class="weui_cell">
                    <div class="weui_cell_bd weui_cell_primary">
                        <textarea class="weui_textarea"  id="profile" name="preciseInbox.profile" placeholder="请输入异常情况" oninvalid="这是必填选项" ></textarea>
                    </div>
                </div>
            </div>
            <div class="weui_cell">  
     ...
     <script type="text/javascript">
    	...
    	$(function(){
        	...
        	var dataList = "preciseInbox.org.id="+orgId+
   			  ...
   			  "&preciseInbox.exceptionType.id="+exceptionType+
    ...
    function reset(){
   	     document.getElementById("hiddenDanger").reset();
   	}
        ...
        var geocoder = null;
            ...
            geocoder = new qq.maps.Geocoder({
                complete : function(result){
                    if(result.detail.address!=null){
                    	$('#occurLocation').val(result.detail.address);
                    }
                }
            });
