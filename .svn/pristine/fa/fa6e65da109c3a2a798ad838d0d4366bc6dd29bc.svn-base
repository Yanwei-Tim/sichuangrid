package com.tianque.plugin.dataManage.location.enterpriseDownKeyTemp.validator;
...
@Repository("enterpriseDownKeyTempValidator")
public class EnterpriseDownKeyTempValidatorImpl implements
		DomainValidatorTemp<EnterpriseDownKeyTemp> {
	@Autowired
	...
	@Override
	public ValidateResult validate(EnterpriseDownKeyTemp domain) {
