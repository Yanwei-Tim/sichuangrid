...
@Component("userAccountLoginDetailMonthJob")
public class UserAccountLoginDetailMonthJob {
	private static Logger logger = LoggerFactory
	.getLogger(UserAccountLoginDetailMonthJob.class);
	@Autowired
	...
	public void createUserAccountLoginDetail() {
		...
		try {
			...
			userAccountLoginDetailService.createUserAccountLoginDetailForMonth(year, month);
