...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/baseInfoStat/otherAttentionPersonnel/otherAttentionPersonnelPersonColumnList.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/otherAttentionPersonnel/otherAttentionPersonnelCountList.jsp">列表信息</a></li>
