...
<div class="content">
	<div id="gridbox" class="SigmaReport" style="height:400px !important;overflow:auto !important;"></div>
	<div id="number"> </div>
</div>
...
function getStatisticsCompanyPlaceList(orgLevelDistance,moduleType){
	var url = "/baseInfoStat/companyPlaceStanalsManageNew/getStatisticsCompanyPlaceList.action?orgId="+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&moduleType="+moduleType;
...
$(document).ready(function(){
	...
	$("#createStatistic").click(function(){
		...
		$.ajax({
			url:'/baseInfoStat/companyPlaceStanalsManageNew/createStatisticsCompanyPlaceList.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&moduleType="+moduleType,
	...
	$(".print").click(function(){
		var moduleType='${param.moduleType}';
		var url = "${path}/statAnalyse/companyPlaceStanalsManageNew/companyPlaceSituationPrint.jsp?parentOrgId="+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&moduleType="+moduleType;
