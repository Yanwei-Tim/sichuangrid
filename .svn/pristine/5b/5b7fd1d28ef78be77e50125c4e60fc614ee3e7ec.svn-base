		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${education.projectName}</td>
					</tr>
					<tr>
						<td class="title">建设起点</td><td class="contable">${education.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${education.toAddress}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${education.beneficiaryNumber}</td>
					</tr>
					<c:if test="${education.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_BUILD_TYPE" defaultValue="${education.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       	...
			       	<tr>
			        	...
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_PROJECT" defaultValue="${education.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${education.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">项目内容</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_PROJECT_SUB" defaultValue="${education.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			     
					
					<tr>
						<td class="title">建设单位名称</td><td class="contable">${education.buildCompanyName}</td>
					</tr>
					<tr>
						<td class="title">建设面积</td><td class="contable">${education.buildArea}</td>
					</tr>
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${education.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${education.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${education.gapFund}</td>
					</tr>
					<tr>
						<td class="title">学生姓名</td><td class="contable">${education.studentName}</td>
					</tr>
					<tr>
						<td class="title">学生就读学校</td><td class="contable">${education.schoolName}</td>
					</tr>
					<c:if test="${education.degreeCategory.id != null}">
				       	<tr>
				        	<td class="title">就学类型</td><td class="contable">
				        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_DEGREE_TYPE" defaultValue="${education.degreeCategory.id}" /></td>
				       	</tr>
			       	</c:if>
					<tr>
						<td class="title">时间</td><td class="contable">${education.studyDate}</td>
					</tr>
					<c:if test="${education.modeCategory.id != null}">
				       	<tr>
				        	<td class="title">方式</td><td class="contable">
				        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_MODE_TYPE" defaultValue="${education.modeCategory.id}" /></td>
				       	</tr>
			       	</c:if>
					
					<c:if test="${education.itemCategory.id != null}">
				       	<tr>
				        	<td class="title">项目名称</td><td class="contable">
				        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_ITEM_TYPE" defaultValue="${education.itemCategory.id}" /></td>
				       	</tr>
			       	</c:if>
					<c:if test="${education.distanceCategory.id != null}">
				       	<tr>
				        	<td class="title">路程</td><td class="contable">
				        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_DISTANCE_TYPE" defaultValue="${education.distanceCategory.id}" /></td>
				       	</tr>
			       	</c:if>
			       	<c:if test="${education.roadConditionCategory.id != null}">
				       	<tr>
				        	<td class="title">路况</td><td class="contable">
				        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@EDUCATION_ROAD_CONDITION_TYPE" defaultValue="${education.roadConditionCategory.id}" /></td>
				       	</tr>
			       	</c:if>
