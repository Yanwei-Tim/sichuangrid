package com.tianque.statAnalyse.issueManage.issueAnalysisChartManage.controller;
...
@Controller("issueAnalysisChartController")
@Scope("request")
@Namespace("/issueAnalysisChartManage")
public class IssueAnalysisChartController extends BaseAction {
	private static Logger logger = LoggerFactory
			.getLogger(IssueAnalysisChartController.class);
