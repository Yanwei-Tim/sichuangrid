...
function onOrgChanged(){
	$("#positiveinfoPie").pieChart({
		url:"${path}/baseInfo/statisticManageNew/getStatisticPie.action?orgId="+getCurrentOrgId()+"&year="+$("#queryYear").val()+"&month="+$("#queryMonth").val()+"&type=<@s.property value='#parameters.type'/>",
