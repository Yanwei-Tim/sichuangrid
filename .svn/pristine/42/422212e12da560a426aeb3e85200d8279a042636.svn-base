 ...
 *
 */
@Component("scienceDataConverter")
@Scope("prototype")
public class ScienceDataConverter extends ThreeAbstractDataConverter<Science> {

	@Autowired
	private PeopleAspirationDubboService ledgerPeopleAspirationsService;

	@Override
	public ValidateResult validate(Science domain, int realRow) {
		return null;
	}

	@Override
	public Science persistenceDomain(Science domain) {
		...
		return ledgerPeopleAspirationsService.addScience(domain);
	}

	@Override
	public Science updateDomain(Science domain) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Science convertToDomain(String[] cellValues, ValidateResult result) {
		// TODO Auto-generated method stub
		return null;
	}
