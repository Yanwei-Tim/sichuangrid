...
/**
 * @Description:社区矫正人员-矫正日到期job
 * @author zhangyouwei@hztianque.com
 * @date: 2015-6-11 上午09:43:49
 */
@Component("rectificativePersonDispatch")
public class RectificativePersonDispatch implements Serializable {

	private static Logger logger = LoggerFactory
			.getLogger(RectificativePersonDispatch.class);
	...
	public void emphasisRectificativePersonJob() {
