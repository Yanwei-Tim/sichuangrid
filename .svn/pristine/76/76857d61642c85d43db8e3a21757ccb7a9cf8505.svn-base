...
$(document).ready(function(){
	$("#serviceRecordList").jqGridFunction({
		url:'${path}/baseinfo/searchServiceRecordManage/searchServiceRecordsByTeamIdAndMemberId.action',
		postData:{
			"searchServiceRecordVo.teamId":'${searchServiceRecordVo.teamId}',
			"searchServiceRecordVo.memberId":'${searchServiceRecordVo.memberId}'
		},
		datatype: "json",
		height:360,
