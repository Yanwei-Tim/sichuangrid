...
.xc-imgLogo{position: absolute;left: 20px;top:20px;z-index:10;}
.xc-loginArea{position:relative;}
.xc-loginArea .xc-login{width:758px;height:428px;margin:-214px 0 0 -379px;background:url(/resource/system/images/login/jinjiang/icon_login.png) no-repeat;position:absolute;top:50%;left:50%;z-index:1;}
.xc-loginArea .xc-formC{width:282px;height:215px;position:absolute;bottom:50px;left:53%;z-index:1;_bottom:25px;}
.xc-loginArea .xc-formC .item{margin:0 0 15px 0;}
.xc-loginArea .xc-formC .item-input{width:190px;height:37px;padding:0 0 0 20px;background:url(/resource/system/images/login/jinjiang/icon_inputTxt.png) no-repeat -3px -4px;position:relative;}
.xc-loginArea .xc-formC .item-input .inputTxt{width:150px;height:23px;margin:5px 0 0;border:1px solid #fff;font:18px/20px "";color:#000000;}
.xc-loginArea .xc-formC .public-mark{width:23px;height:22px;display:block;background:url(/resource/system/images/login/jinjiang/icon_inputTxt.png) no-repeat;position:absolute;left:10px;top:5px;}
...
.xc-loginArea .xc-formC .item-checkbox{margin-left:0px;font:12px/25px "microsoft yahei";color:#4A4C4E;vertical-align:top;}
.xc-loginArea .xc-formC .item .loginBtn{float:left;width:100px;height:39px;display:inline-block;*display:inline;*zoom:1;margin-left:-50px;font:18px/39px "";text-align:center;color:#fff;text-shadow:1px 1px 1px #115B8B; text-decoration:none;background:url(/resource/system/images/login/jinjiang/icon_inputTxt.png) no-repeat -4px -75px;}
.xc-loginArea .xc-formC .item .loginReset{margin-left:50px;}
...
<div class="xc-loginArea">
	<img src="${resource_path}/resource/system/images/login/jinjiang/bg.jpg" id="imgArea"/>
	<img src="${resource_path}/resource/system/images/login/jinjiang/ico_logo.png" class="xc-imgLogo"/>
    <div class="xc-login">
    	<div class="xc-formC">
