 ...
 *
 */
@Component("townDataConverter")
@Scope("prototype")
public class TownDataConverter extends ThreeAbstractDataConverter<Town> {

	@Autowired
	private PeopleAspirationDubboService ledgerPeopleAspirationsService;

	@Override
	public ValidateResult validate(Town domain, int realRow) {
		return null;
	}

	@Override
	public Town persistenceDomain(Town domain) {
		...
		return ledgerPeopleAspirationsService.addTown(domain);
	}

	@Override
	public Town updateDomain(Town domain) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Town convertToDomain(String[] cellValues, ValidateResult result) {
		// TODO Auto-generated method stub
		return null;
	}
