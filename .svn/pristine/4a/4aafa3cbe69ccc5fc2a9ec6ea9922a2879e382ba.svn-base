...
<div class="zt_tabs_style">
	<div id="chartsTabs">
	<ul>
		 <li><a href="${path }/statAnalyseNew/baseInfoStat/keyPeople/statisticTotalListColumn.ftl?type=all_attention_population">区域分布图</a></li>
		 <li><a href="${path }/statAnalyseNew/baseInfoStat/keyPeople/statisticTotalPie.ftl?type=all_attention_population">类型分布图</a></li>
		 <li><a href="${path }/statAnalyseNew/baseInfoStat/keyPeople/statisticTotalList.ftl?type=all_attention_population">列表信息</a></li>
		 <li><a href="${path }/statAnalyseNew/baseInfoStat/common/tendencyChartForPositiveinfo.ftl?tableNameKey=all_attention_population">趋势图</a></li>
	</ul>
	</div>
