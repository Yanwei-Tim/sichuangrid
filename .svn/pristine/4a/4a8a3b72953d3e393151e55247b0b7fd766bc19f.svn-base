...
<div id="dialog-form" title="研判分析改造历史统计" class="container container_24">
	 <form id="maintainForm" method="post"	action="${path}/sysadmin/jobMonitor/packetStatistics.action" >
	 	 <pop:token/>
		...
		<label class="form-lbl">统计类型： </label>
	 	 ...
	 	 <div class="grid_18" >
	 	 <select name="packetStatisticsVo.typeName" id="typeName" class='form-txt'>
	 	 	<option value='packetAll'>统计所有</option>
	 	 	<s:iterator value="@com.tianque.plugin.analysisNew.util.PacketStatisticsTables@statisticsKeyNames" >   
