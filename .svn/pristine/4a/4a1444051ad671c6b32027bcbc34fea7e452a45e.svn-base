...
function importPersonelSituationPrint(){
	$.ajax({
		url:'/baseInfoStat/companyPlaceStanalsManage/getStatisticsCompanyPlaceList.action?orgId='+'<s:property value="#parameters.parentOrgId"/>'+'&year='+'<s:property value="#parameters.year"/>'+'&month='+'<s:property value="#parameters.month"/>'+'&moduleType='+'<s:property value="#parameters.moduleType"/>&orgLevelDistance=<s:property value="#parameters.orgLevelDistance"/>',
		success:function(data){
