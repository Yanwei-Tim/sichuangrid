...
<div class="content" >
    <div class="ui-corner-all container_24" id="nav">
		<div class="grid_10">
		<pop:JugePermissionTag ename="searchPeopLiveService">
	        <a id="search" href="javascript:void(0)"><span>查询</span></a>
	    </pop:JugePermissionTag>
        	<a id="reload" href="javascript:void(0)"><span>刷新</span></a>
		</div>
		<div class="grid_5 lable-right">
			<label class="form-lbl">民生服务类型：</label>
		</div>
        <div class="grid_8">
		    <pop:IssueTypeSelectTag afterChange="searchSecuritytrouble" name="issueTypeId" domainName="@com.tianque.issue.constants.IssueTypes@PEOPLELIVE_SERVICE" id="issueTypeId"></pop:IssueTypeSelectTag>
		</div>
		<div class="grid_1">
		</div>
    </div>
...
var issueStatus = '<s:property value="#parameters.issueStatus"/>';
    $(function(){
        ...
        $("#reload").click(function(){
            ...
            $("#securitytroubleList").setGridParam({
                url:'${path}/peopLiveService/searchPeopLiveServiceManage/searchPeopLiveService.action',
                datatype: "json",
                page:1
            });
            $("#securitytroubleList").setPostData({
                "orgId":getCurrentOrgId(),
                "searchPeopleLiveServiceVo.issueTypeDomainName":condictionIssueTypeDomainName
            });
    ...
    function searchSecuritytrouble(){
        ...
        $("#securitytroubleList").setPostData({
            "orgId":getCurrentOrgId(),
            "searchPeopleLiveServiceVo.name":nameCondition,
            "searchPeopleLiveServiceVo.inputFrom":inputFromCondition,
            "searchPeopleLiveServiceVo.inputEnd":inputEndCondition,
            "searchPeopleLiveServiceVo.fromPerson":fromPersonCondition,
            "searchPeopleLiveServiceVo.status":conditionStatus,
            "searchPeopleLiveServiceVo.issueNo":conditionIssueNo,
            "searchPeopleLiveServiceVo.issueTypeId":condictionIssueTypeId,
            "searchPeopleLiveServiceVo.issueTypeDomainName":condictionIssueTypeDomainName
        });
        $("#securitytroubleList").trigger("reloadGrid");
    }
