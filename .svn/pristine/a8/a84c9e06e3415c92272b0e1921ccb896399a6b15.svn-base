...
var gridOption = {
		colModel:[
			        ...
			        {name:"attentionExtent",label:'关注程度',index:"attentionExtent",width:100,formatter:attentionExtentColor,sortable:false,frozen:true},
			        ...
			        {name:'death',sortable:false,hidden:true,hidedlg:true,width:80},
		      		...
		      		{name:'attentionReason', sortable:false, label:'关注原因', width:160},
			        ...
			        {name:'currentAddress',label:'常住地址',sortable:false,width:150},
			        {name:'nativePoliceStation',label:'户籍派出所',sortable:false,width:160,hidden:true},
			        {name:'nativePlaceAddress',label:'户籍详址',sortable:false,width:150},
