 ...
 */
@Scope("prototype")
@Namespace("/baseInfo/primaryOrganizationStatNew")
@Controller("primaryOrganizationsStatisticsNewController")
public class PrimaryOrganizationsStatisticsNewController extends
		StatisticAction {

	private static Logger logger = LoggerFactory
			.getLogger(PrimaryOrganizationsStatisticsNewController.class);
	@Autowired
	...
	public String primaryOrgnizationColmunData() throws Exception {
		...
		if (validateNowMonth()) {
			...
			personnelColumn = primaryOrganizationsStatisticsNewService
	...
	public String primaryOrgnizationTrendData() throws Exception {
		...
		highchartColumnVo = primaryOrganizationsStatisticsNewService
	...
	public String primaryOrganizationStatisticList() throws Exception {
		...
		if (orgId != null) {
			listDataColumnVo = primaryOrganizationsStatisticsNewService
	...
	public String createHistoryStatistic() throws Exception {
		...
		primaryOrganizationsStatisticsNewService.createHistoryStatisticByType(
