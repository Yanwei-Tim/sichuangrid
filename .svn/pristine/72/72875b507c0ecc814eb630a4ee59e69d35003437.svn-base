...
<div class="ui-corner-all" id="nav" >
	<div class="btnbanner btnbannerData">
		...
		<pop:JugePermissionTag ename="searchReceiveWorkInfo">
		<a id="search" href="javascript:void(0)"><span>高级搜索</span></a>
		</pop:JugePermissionTag>
		<span class="lineBetween"></span>
		<pop:JugePermissionTag ename="receiveWorkInfo">
		<a id="receive" href="javascript:void(0)"><span>签收文件</span></a>
		</pop:JugePermissionTag>
		<pop:JugePermissionTag ename="readReceiveWorkInfo">
		<a id="read" href="javascript:void(0)"><span>阅读</span></a>
		</pop:JugePermissionTag>
		<pop:JugePermissionTag ename="transpondReceiveWorkInfo">
		<a id="transmit" href="javascript:void(0)"><span>转发</span></a>
		</pop:JugePermissionTag>
		<pop:JugePermissionTag ename="deleteReceiveWorkInfo">
...
$(document).ready(function(){
	...
	function sendTypeFormatter(el, options, rowData){ 
		if(rowData.postObj=='1' || rowData.postObj==1){
			return "抄送";
		}else{
			return "主送";
		}
   ...
   function operateFormatter(el, options, rowData){
		...
		return "<pop:JugePermissionTag ename='deleteReceiveWorkInfo'><a href='javascript:deleteReceiveDocuments("+rowData.id+")'><span>删除</span></a></pop:JugePermissionTag>";
	}
	function titleFont(el,options,rowData){
		return "<pop:JugePermissionTag ename='readReceiveWorkInfo'><a href='javascript:viewReceiveDialog("+rowData.id+")'></pop:JugePermissionTag>"+rowData.title+"<pop:JugePermissionTag ename='readReceiveWorkInfo'></a></pop:JugePermissionTag>";
	}
	$("#receiveDocumentsList").jqGridFunction({
	    ...
	    sortorder: "desc",
	   	colModel:[
	        ...
	        {name:"postObj",label:'主送/抄送',formatter:sendTypeFormatter,width:80,align:'center'},
