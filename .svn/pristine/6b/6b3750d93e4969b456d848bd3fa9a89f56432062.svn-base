...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href='${path }/statAnalyse/baseInfoStat/keyPlace/statisticsPlaceforColumn.jsp?keyTpe=<s:property value="#parameters.keyTpe[0]"/>'>区域分布图</a></li>
			<li><a href='${path }/statAnalyse/baseInfoStat/keyPlace/statisticsPlaceforList.jsp?keyTpe=<s:property value="#parameters.keyTpe[0]"/>'>列表信息</a></li>
