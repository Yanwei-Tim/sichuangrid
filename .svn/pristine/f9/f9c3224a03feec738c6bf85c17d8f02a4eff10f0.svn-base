...
/**
 * 事件类型越级规则设置:实体类(ISSUE_SKIPRULE)
 * 
 * @author
 * @date 2013-11-22 14:51:41
 */
public class IssueSkiprule extends com.tianque.core.base.BaseDomain implements
	...
	public IssueSkiprule(String messageFlag, Long orgId, Long issueTypeId,
			Long issueTypeDomainId, PropertyDict issueUrgentLevel,
			Long submitOrgId, String orgInternalCode, String ccOrgIds,
			PropertyDict submitLevel) {
