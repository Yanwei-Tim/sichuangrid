		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${science.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${science.beneficiaryNumber}</td>
					</tr>
					<c:if test="${science.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@SCIENCE_BUILD_TYPE" defaultValue="${science.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       
			       	<c:if test="${science.projectCategory.id != null}">
			       	<tr>
			        	<td class="title">类别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@SCIENCE_PROJECT" defaultValue="${science.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${science.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">项目类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@SCIENCE_PROJECT_SUB" defaultValue="${science.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			     	<c:if test="${science.projectLevelCategory.id != null}">
			       	<tr>
			        	<td class="title">项目级别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@SCIENCE_PROJECT_LEVEL" defaultValue="${science.projectLevelCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<tr>
						<td class="title">项目名称</td><td class="contable">${science.itemName}</td>
					</tr>
			       	
					<c:if test="${science.contentCategory.id != null}">
							<tr>
						      	<td class="title">广播电视播放方式</td><td class="contable">
						        <pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@SCIENCE_BROADCAST" defaultValue="${science.contentCategory.id}" /></td>
						    </tr>
			       	</c:if>
					<tr>
						<td class="title">数量（户、个、场）</td><td class="contable">${science.scienceScope}</td>
					</tr>
					<tr>
						<td class="title">宣传次数</td><td class="contable">${science.publicizeNum}</td>
					</tr>
					<tr>
						<td class="title">主题内容</td><td class="contable">${science.content}</td>
					</tr>
			       	
					<tr>
						<td class="title">建设起点</td><td class="contable">${science.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${science.toAddress}</td>
					</tr>
					<tr>
						<td class="title">规模</td><td class="contable">${science.scienceScope}</td>
					</tr>
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${science.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${science.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${science.gapFund}</td>
					</tr>
