...
<div id="nav" class="ui-corner-all">
		...
		<!--
			<pop:JugePermissionTag ename="reProduceDataAdminLoginStanals">
		...
		<s:else>
			<!--
			<pop:JugePermissionTag ename="reProduceDataFuncationLoginStanals">
				<a id="produceDate" href="javascript:void(0)"><span>生成数据</span></a>
			</pop:JugePermissionTag>
			 -->
...
<div class="container_24">
	...
	<div id="gridbox" class="SigmaReport" style="overflow-x:hidden;overflow-y:hidden;position:relative;height: 100%;width:100%"></div>
</div>
...
/**
	...
	$("#export").click(function(event){
			$("#MainDialog").createDialog({
				...
				postData:{
					downloadUrl:'${path}/statAnalyse/orgLoginStanalsManager/downloadOrgLoginStanals.action?orgId='+getCurrentOrgId()+'&nowYear='+$("#statYear").val()+'&nowMonth='+$("#statMonth").val()+'&internalId='+ $("#internalId").val(),
					gridName:''
					},
				buttons: {
		   			"导出" : function(event){
