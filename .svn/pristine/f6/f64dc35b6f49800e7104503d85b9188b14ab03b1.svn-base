...
<form id="maintainForm" method="post" enctype="multipart/form-data" action="${path }/baseinfo/basicInfomationManage/updateOrSaveVillageProfileImgUrl.action">
		...
		submitHandler: function(form){
			$(form).ajaxSubmit({
				success:function(data){
					...
					$("#basicInfoMationId").val(jsonData.id);
