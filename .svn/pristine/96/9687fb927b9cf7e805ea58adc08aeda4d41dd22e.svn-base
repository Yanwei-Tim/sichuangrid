...
public class MoveCompanyPlaceDatasTwoInitialization {
	...
	private static void developmentMode() throws Exception {
		new DevelopmentMoveCompanyPlaceDatasTwoBuilder().builderTestEnv();
	}

	private static void productionMode() throws Exception {
		new ProductionMoveCompanyPlaceDatasTwoBuilder().builderTestEnv();
	}
}
