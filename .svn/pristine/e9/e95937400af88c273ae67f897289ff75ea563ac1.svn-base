...
<div class="zt_tabs_style">
	...
	<ul>
		...
		<li><a href="${path }/statAnalyse/baseInfoStat/elderlyPeople/statisticElderlyPeopleColumn.jsp">区域分布图</a></li>
		 
		<li><a href="${path }/statAnalyse/baseInfoStat/elderlyPeople/statisticElderlyPeopleList.jsp">列表信息</a></li>
