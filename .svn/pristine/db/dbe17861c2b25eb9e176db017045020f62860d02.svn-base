 ...
 * 时限考核成绩job
 * */
@Component("statisticsAccountTimeoutsDispatch")
public class StatisticsAccountTimeoutsDispatch implements Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(StatisticsAccountTimeoutsDispatch.class);
	@Autowired
