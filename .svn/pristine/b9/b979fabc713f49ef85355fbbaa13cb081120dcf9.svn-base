...
var dialogHeight=600;
	...
	function operateFormatter(el,options,rowData){
		return "<pop:JugePermissionTag ename='viewElderlyPeople'><a href='javascript:;' onclick='viewDialog(event,"+rowData.id+");'><U><font color='#6633FF'>查看</font></U></a></pop:JugePermissionTag>";
	}
	...
	var gridOption = {
	   	colModel:[
	        ...
	        {name:'organization.orgName',sortable:false,hidden:true,index:'organization.orgName',label:'所属网格',width:350},
	        ...
	        {name:"birthday", index:'birthday', label:'出生日期',hidden:true, width:80 },
	        {name:'elderPeopleId', sortable:true, label:'老年人证号',hidden:true, width:100},
	        {name:'peopleType',formatter:peopleTypeFormatter, sortable:false, label:'人员类型', width:100},
	        ...
	        {name:'spouseStatus',formatter:spouseStatusFormatter,  sortable:false, label:'配偶情况', width:100,hidden:true},
	        {name:'incomeSource',formatter:incomeSourceFormatter,  sortable:false, label:'经济来源',width:100,hidden:true},
	        {name:'enterWorkDate', sortable:true, label:'参加工作日期', width:100,hidden:true},
	        {name:'retireUnitAndDuty', sortable:false, label:'离退休单位', width:100,hidden:true},
	        {name:'retireDate', sortable:true, label:'离退休日期',hidden:true, width:100},
	        ...
	        {name:"stature",sortable:false,label:"身高(cm)",width:100, hidden:true },
