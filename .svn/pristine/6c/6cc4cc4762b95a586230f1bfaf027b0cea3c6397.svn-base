...
@Component("fourTeamsAdministrativeOrgTimeLimitStandardValidator")
public class FourTeamsAdministrativeOrgTimeLimitStandardValidatorImpl implements
		DomainValidator<FourTeamsAdministrativeOrgTimeLimitStandard> {
	...
	public ValidateResult validate(
			FourTeamsAdministrativeOrgTimeLimitStandard administrativeStandard) {
