...
orgId:<input id="autonomyTeamOrgId" type="hidden" name="serviceManageTeam.organization.id" value="<s:property value="@com.tianque.util.ThreadVariable@getOrganization().id"/>" />
