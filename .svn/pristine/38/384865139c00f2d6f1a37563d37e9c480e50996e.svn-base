package com.tianque.plugin.dataManage.location.actualHouseTemp;
...
@Component("actualHouseTempService")
public class ActualHouseTempServiceImpl extends LocationDataManageServiceImpl {
	@Autowired
	...
	public BaseDomain dataConvertForLocation(BaseDomain population) {
		...
		ActualHouseTemp temp = (ActualHouseTemp) population;
