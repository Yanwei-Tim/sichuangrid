...
function onOrgChanged(){
	...
	$("#importantPlacePie").pieChart({
		url:"${path}/baseInfoStat/companyPlaceStanalsManageNew/getStatisticsCompanyPlacePie.action?orgId="+getCurrentOrgId()+"&year="+$("#pyear").val()+"&month="+$("#pmonth").val()+"&moduleType="+moduleType,
