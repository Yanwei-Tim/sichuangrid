...
<div id="dialog-form" title="数据补全" class="container container_24">
	 <form id="maintainForm" method="post"	action="${path}/sysadmin/jobMonitor/complentionIssueForMobile.action" >
	 	 <pop:token/>
	 	 <input type="hidden" name="jobType" id="jobType"  value="<s:property value='#parameters.type[0]'/>"  />
