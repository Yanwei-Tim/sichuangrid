...
function onOrgChanged(){
	$("#idleyouthPie1").pieChart({
		url:"${path}/baseInfo/statisticManage/getStatisticPie.action?orgId="+getCurrentOrgId()+"&year="+$("#iqueryYear").val()+"&month="+$("#iqueryMonth").val()+"&type=<@s.property value='#parameters.type'/>&domainName=政治面貌",
