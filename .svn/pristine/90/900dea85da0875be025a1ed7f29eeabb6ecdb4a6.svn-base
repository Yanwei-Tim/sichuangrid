 ...
 */
@DynamicIbatisDAO(value = "CompanyPlaceLeaderViewDAO", sqlMapClientTemplate = "sqlMapClientTemplate")
@Repository("CompanyPlaceLeaderViewDAO")
public interface CompanyPlaceLeaderViewDAO {
