 ...
 */
@Component("issueOvertimeHandlerDispatch")
public class IssueOvertimeHandlerDispatch implements Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(IssueOvertimeHandlerDispatch.class);
	@Autowired
