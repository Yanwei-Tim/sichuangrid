...
function getDepartmentPartyStatisticList(orgLevelDistance){
	var url = "${path}/baseInfo/departmentPartyManage/departmentPartyStatisticList.action?orgId="+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val();
...
// 	setTimeout('onOrgChanged()',350);
	...
	$("#createStatistic").click(function(){
		$.ajax({
			url:"${path}/baseInfo/departmentPartyManage/createHistoryStatistic.action?orgId="+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type="+$("#type").val(),
			success:function(responseData){
	...
	$(".print").click(function(){
		var url = "${path}/statAnalyse/baseInfoStat/departmentParty/departmentPartyPrint.jsp?parentOrgId="+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type="+$("#type").val()+"&moduleName="+document.title;
