...
function getPositiveInfo(){
	$.ajax({
		url:'/baseInfo/statisticManageNew/getBaseInfoStatisticList.action?orgId='+'<s:property value="#parameters.parentOrgId"/>'+'&year='+'<s:property value="#parameters.year"/>'+'&month='+'<s:property value="#parameters.month"/>'+'&type='+'<s:property value="#parameters.type"/>',
