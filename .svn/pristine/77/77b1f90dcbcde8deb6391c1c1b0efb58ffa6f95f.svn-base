...
<jsp:include page="/common/orgSelectedComponent.jsp"/>
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/companyPlaceStanalsManageNew/commonPopylationColumn.jsp?moduleType=<s:property value='#parameters.moduleType[0]'/>">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/companyPlaceStanalsManageNew/statisticsCompanyPlacePie.jsp?moduleType=<s:property value='#parameters.moduleType[0]'/>">类型分布图</a></li>
			<li><a href="${path }/statAnalyse/companyPlaceStanalsManageNew/companyPlaceList.jsp?moduleType=<s:property value='#parameters.moduleType[0]'/>">列表信息</a></li>
			<li><a href="${path }/statAnalyse/companyPlaceStanalsManageNew/tendencyChartForCompanyPlace.jsp?moduleType=<s:property value='#parameters.moduleType[0]'/>">趋势图</a></li>
		</ul>
	</div>
