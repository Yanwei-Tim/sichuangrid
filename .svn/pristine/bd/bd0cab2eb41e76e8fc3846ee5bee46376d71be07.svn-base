...
<div class="incident-container" id="incidentCaseLibrary">
	<div class="incident-left" id="incidentCaseLibraryLeft">
		<jsp:include page="/incident/emergencyDisposal/right/incidentDegree.jsp">
			 <jsp:param value="caseLibrary" name="tabType"/>
		</jsp:include>
	</div>
	<div class="incident-right" id="incidentCaseLibraryRight" style="margin:0 0 0 180px;">
...
<script type="text/javascript">
	...
	function loadCaseLibraryDate(incidentId){
		if(incidentId=="" || incidentId=="undefined" || incidentId==null){
			cleanViewDatas();
			return;
		}
		$.ajax({
			url:'${path}/incident/emergencyDisposal/loadCaseLibrary.action',
			type:'post',
			data:{	
			...
			success:function(result){
				...
				//	proccessLoginResult(result,function(){hideLoading();$("#incidentCaseLibraryRight").html(result);});
			}
		});	
	}
