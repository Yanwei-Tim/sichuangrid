...
<script type="text/javascript">
		...
		jQuery(document).ready(function() {
			...
			$("#areaDatatable").jqGridFunction({
				...
				colModel:[
			 		...
			 		{name:'attentionCount',index:'attentionCount',label:"未注销人数",sortable:false,width:80},
		...
		function getPersonMonthGeneralConditionData(){
			$("#personMonthGeneralConditionTable").setGridParam({
				url:"${path}/baseinfo/leaderViewManage/populationMonthGeneralCondition.action",
				datatype:"json",
				page:1,
				loadComplete:function(){
