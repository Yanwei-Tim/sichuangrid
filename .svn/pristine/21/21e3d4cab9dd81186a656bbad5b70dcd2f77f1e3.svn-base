...
@Component("defaultIssueValidator")
public class DefaultIssueValidator extends AbstractValidator implements
		IssueValidator {
	@Autowired
	...
	private void validateIssueSubject(IssueNew issue, ValidateResult vr) {
	...
	private void validateIssueOccurLocation(IssueNew issue, ValidateResult vr) {
	...
	private void validateIssueOccurDate(IssueNew issue, ValidateResult vr) {
	...
	private void validateIssueMainCharacters(IssueNew issue, ValidateResult vr) {
	...
	private void validateIssueRelatePeopleCount(IssueNew issue,
			ValidateResult vr) {
	...
	private void validateIssueContent(IssueNew issue, ValidateResult vr) {
	...
	private void validateIssueOccurOrg(IssueNew issue, ValidateResult vr) {
	...
	private void validateIssueTypes(IssueNew issue, ValidateResult vr) {
	...
	@Override
	public ValidateResult validate(IssueNew issue) {
	...
	@Override
	public ValidateResult validateAttachFiles(List<IssueAttachFile> files) {
		ValidateResult result = new ValidateResult();
