package com.tianque.plugin.dataManage.location.companyPlaceTemp.validator;
...
@Component("companyPlaceTempValidator")
public class CompanyPlaceTempValidatorImpl implements
		DomainValidatorTemp<CompanyPlaceTemp> {
	@Autowired
	...
	@Override
	public ValidateResult validate(CompanyPlaceTemp domain) {
	...
	private void validatorifClassifiCation(CompanyPlaceTemp domain,
			ValidateResult result) {
