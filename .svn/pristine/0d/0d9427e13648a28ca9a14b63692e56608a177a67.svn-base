package com.tianque.statAnalyse.issueManage.listManage.helper;
...
public class IssueReportStatHelper {
	...
	public static void autoFillCompletionRate(IssueAreaStat issueAreaStat) {
	...
	public static void autoFillExtendedRate(IssueAreaStat issueAreaStat) {
