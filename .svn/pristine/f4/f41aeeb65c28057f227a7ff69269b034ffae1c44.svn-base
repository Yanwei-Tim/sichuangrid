...
<table style="width: 2000px;" class="countlist" id="tableId">
	...
	<tr class="countlistHead" style="text-align: center;">
		...
		<td colspan="7" style="text-align: center;">就业</td>
		<td colspan="9" style="text-align: center;">社会保障（保险）</td>
		<td colspan="5" style="text-align: center;">农民工工资</td>
	...
	<tr class="countlistHead">
		...
		<td rowspan="2">件数</td>
		<td rowspan="2">反映群体人数</td>
		<td rowspan="2">小计（人）</td>
		<td rowspan="2">求职意愿登记（人）</td>
		<td rowspan="2">就业登记（人）</td>
		<td rowspan="2">失业登记（人）</td>
		<td rowspan="2">就业职能培训（人）</td>
		...
		<td rowspan="2">件数</td>
		<td rowspan="2">反映群体人数</td>
		<td rowspan="2">工资拖欠施工单位个数</td>
		<td rowspan="2">涉及人数</td>
		<td rowspan="2">涉及金额（元）</td>
