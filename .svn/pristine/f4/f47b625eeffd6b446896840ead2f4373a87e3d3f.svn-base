 ...
 * 
 */
public class PropertyDictLevelSelectTag extends TagSupport {
	...
	private String createRelationSelectJs() {
		...
		sb.append("\n$(\"#"
				+ reletionId
				+ "\").append(\"<option value='' internalId='' id=''>请选择</option>\");");

		sb.append(
				"\nfor(var i=0;i<responseData.length;i++){\nif(currentInternalId*100<responseData[i].internalId&&responseData[i].internalId<currentInternalId*100+100){\n"
						+ "has"
						+ arrayName
						+ "=true;\n"
						+ "$(\"#"
						+ reletionId
						+ "\").append(\"<option internalId='\"+responseData[i].internalId+\"' value='\"+responseData[i].id+\"'>\"+responseData[i].displayName+\"</option>\");\n}}"
						+ "\nif(!has"
						+ arrayName
						+ "){$(\"#"
						+ reletionId
		...
		sb.append("\n$(\"#" + id + "\").change(function(){")
				...
				.append("\nfor(var i=0;i<" + arrayName
						+ ".length;i++){\nif(currentInternalId*100<"
						+ arrayName + "[i].internalId&&" + arrayName
						+ "[i].internalId<currentInternalId*100+100){\n"
						+ "has" + arrayName + "=true;\n" + "$(\"#" + reletionId
						+ "\").append(\"<option internalId='\"+" + arrayName
						+ "[i].internalId+\"' value='\"+" + arrayName
						+ "[i].id+\"'>\"+" + arrayName
						+ "[i].displayName+\"</option>\");\n}}");
		sb.append("\n$(\"#" + reletionId + "\").trigger(\"change\");");
