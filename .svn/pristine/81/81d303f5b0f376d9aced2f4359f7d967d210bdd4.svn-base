...
@Repository("issueTypeStanalDao")
public class IssueTypeStanalDaoImpl extends AbstractBaseDao implements IssueTypeStanalDao {

	@Override
	public List<Organization> findOrganizations() {
		return getSqlMapClientTemplate().queryForList("issueTypeStanal.findOrganizations");
	}
	...
	public IssueTypeStanal addIssueTypeStanal(IssueTypeStanal issueTypeStanal) {
		Long id = (Long) getSqlMapClientTemplate().insert("issueTypeStanal.addIssueTypeStanal",
				issueTypeStanal);
	...
	public List<IssueTypeDomain> findIssueTypeDomains() {
		return getSqlMapClientTemplate().queryForList("issueTypeStanal.findIssueTypeDomains",
				IssueTypes.CORE_MODULE);
	}
	...
	public List<IssueTypeStanal> stanalIssueTypeDomains(Long orgId, Date startDate, Date endDate) {
		...
		map.put("issueType", IssueTypes.CORE_MODULE);
		return getSqlMapClientTemplate()
				.queryForList("issueTypeStanal.stanalIssueTypeDomains", map);
	}
	...
	public List<IssueTypeStanal> stanalIssueTypes(Long orgId, Long domainId, Date startDate,
		...
		map.put("startDate", startDate);
		map.put("endDate", endDate);
		return getSqlMapClientTemplate().queryForList("issueTypeStanal.stanalIssueTypes", map);
	}
	...
	public void deleteIssueTypeStanalByStartEndDateOrgCode(Date startDate, Date endDate,
		...
		getSqlMapClientTemplate().delete(
				"issueTypeStanal.deleteIssueTypeStanalByStartEndDateOrgCode", map);
	...
	public void deleteAllStatIssueByOrgId(long orgId) {
		getSqlMapClientTemplate().delete("issueTypeStanal.deleteAllStatIssueByOrgId", orgId);

	}

	@Override
	public List<IssueTypeStanal> getIssueTypeDomains() {
		return getSqlMapClientTemplate().queryForList("issueTypeStanal.getIssueTypeDomains",
				IssueTypes.CORE_MODULE);
	}
	...
	public List<OrgGroupedObject> getPeriodIssueTypeStatInfoByOrgCodeGroupByTypeDomain(
		...
		map.put("month", month);
		return getSqlMapClientTemplate().queryForList(
				"issueTypeStanal.getPeriodIssueTypeStatInfoByOrgCodeGroupByTypeDomain", map);
	}
	...
	public List<OrgGroupedObject> getPeriodIssueTypeStatInfoListByOrgCodeGroupByTypeDomain(
		...
		map.put("endDate", endDate);
		return getSqlMapClientTemplate().queryForList(
				"issueTypeStanal.getPeriodIssueTypeStatInfoListByOrgCodeGroupByTypeDomain", map);
	}
	...
	public List<OrgGroupedObject> getPeriodIssueTypeStatDetailInfoByOrgAndTypeDomain(
		...
		map.put("endDate", endDate);
		return getSqlMapClientTemplate().queryForList(
				"issueTypeStanal.getPeriodIssueTypeStatDetailInfoByOrgAndTypeDomain", map);
	}
	...
	public List<OrgGroupedObject> getPeriodIssueTypeStatInfoByOrgIdGroupByTypeDomain(Long year,
		...
		map.put("month", month);
		return getSqlMapClientTemplate().queryForList(
				"issueTypeStanal.getPeriodIssueTypeStatInfoByOrgIdGroupByTypeDomain", map);
	}
	...
	public List<OrgGroupedObject> getPeriodIssueTypeStatInfoListByOrgIdGroupByTypeDomain(
		...
		map.put("endDate", endDate);
		return getSqlMapClientTemplate().queryForList(
				"issueTypeStanal.getPeriodIssueTypeStatInfoListByOrgIdGroupByTypeDomain", map);
	}
	...
	public List<OrgGroupedObject> getPeriodIssueTypeStatDetailInfoByOrgIdAndTypeDomain(Long orgId,
		...
		map.put("endDate", endDate);
		return getSqlMapClientTemplate().queryForList(
				"issueTypeStanal.getPeriodIssueTypeStatDetailInfoByOrgIdAndTypeDomain", map);
	}
