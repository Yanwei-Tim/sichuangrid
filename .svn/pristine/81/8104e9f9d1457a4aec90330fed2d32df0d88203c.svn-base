...
<@s.include value="/baseinfo/commonPopulation/jsFunctionInclude.jsp">
	<@s.param name="moduleName">fireSafetyEnterpriseTemp</@s.param>
</@s.include>
<script type="text/javascript">
	...
	var gridOption={
		colModel:[
			...
			{name:"name-Font", index:"name", label: '消防安全重点名称',formatter:nameFontClaim,frozen:true,width:200},
			{name:"name", index:"name", label: '消防安全重点名称',hidden:true,frozen:true,width:150},
			{name:"address",sortable:false,label:"消防安全重点地址",width:200},
			{name:"manager", index:"manager", label:'负责人',width:100},
			{name:"type", index:"type", label:'消防安全重点类型', formatter:typeFormatter,width:150},
...
<#assign moduleName="fireSafetyEnterpriseTemp"/>
<#assign moduleCName="消防安全重点"/>
