...
@Repository("statisticsBaseInfoDao")
public class StatisticsBaseInfoDaoImpl extends AbstractBaseDao implements
		StatisticsBaseInfoDao {
	...
	public Integer getCountByOrgInternalCodeAndTableNameAndMap(
		...
		if (sum == null) {
			sum = (Integer) this
					...
					.queryForObject(
							"statisticsBaseInfo.getCountByOrgInternalCodeAndTableNameAndMap",
							map);
	...
	public int getCountFromHistory(Map<String, Object> map) {
		return (Integer) this.getSqlMapClientTemplate().queryForObject(
				"statisticsBaseInfo.getCountFromHistory", map);
	...
	public List<Map<String, Object>> getHelpedCountFromHistory(Long orgId,
		...
		return getSqlMapClientTemplate().queryForList(
				"statisticsBaseInfo.getIsHelpCountFromHistory", map);
	}
	...
	public int getIsHelpFromHistory(String orgInternalCode, String typeName,
		...
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"statisticsBaseInfo.getIsHelpFromHistory", map);
	}
	...
	public int getNoHelpFromHistory(String orgInternalCode, String typeName,
		...
		map.put("baseinfotype", baseinfotype);
		return (Integer) getSqlMapClientTemplate().queryForObject(
				"statisticsBaseInfo.getNoHelpFromHistory", map);
	}
