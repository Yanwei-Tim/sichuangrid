...
public class IssueSolrDocumentConvert {
	...
	public static IssueSolrDocument createIssueSolrDocument(IssueNew issue,
		...
		if(step.getSource().getOrgInternalCode() != null && step.getSource().getOrgLevel().getId() != null){
			issueSolrDocument.setCurrentOrginternalCode(step.getSource().getOrgInternalCode());
			issueSolrDocument.setCurrentOrgLevel(step.getSource().getOrgLevel().getId());
		}
		issueSolrDocument.setCurrentOrgFunctionalType(step.getSource().getFunctionalOrgType() == null ?
				0L :step.getSource().getFunctionalOrgType().getId());
	...
	public static IssueSolrDocument createIssueSolrDocument(
		...
		issueSolrDocument.setCurrentOrgFunctionalType(issueViewObject.getCurrentOrgFunctionalType());
		issueSolrDocument.setCurrentOrginternalCode(issueViewObject.getCurrentOrginternalCode());
		issueSolrDocument.setCurrentOrgLevel(issueViewObject.getCurrentOrgLevel());
