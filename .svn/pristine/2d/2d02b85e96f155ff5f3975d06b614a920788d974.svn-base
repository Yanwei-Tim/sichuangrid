...
public class BaseSituationStatement extends BaseDomain implements Serializable {
	...
	private int currentFloatingPersionCount;// 本月流口变量
	private int currentPositivePersionCount;// 本月刑释人员变量
	private int currentRectificativePersonCount;// 本月矫正人员变量
	private int currentMentalPatientPersionCount;// 本月精神病变量
	private int currentDruggyPersionCount;// 本月吸毒人员变量
	private int currentIdleYouthCount;// 本月重点青少年变量
	private int currentPreventionCount;// 本月群防群治人数变量

	// private int togetherOrganizeCount;// 截止上月总数综治组织
	// private int rentalHouseCount;// 截止上月总数出租房
	// private String togetherOrganizeChain;// 综治组织环比
	// private String preventionChain;// 群防群治人数环比
	// private String floatingPersionChain;// 流口环比

	// private String rentalHouseChain;// 出租屋环比

	// private String positivePersionChain;
	// private int positivePersionVisitCount;//刑释人员走访数

	// private String rectificativePersonChain;
	// private int rectificativePersonVisitCount;//社区矫正员走访数

	// private String mentalPatientPersionChain;
	// private int mentalPatientPersionVisitCount;//严重精神障碍患者走访数

	// private String druggyPersionChain;
	// private int druggyPersionVisitCount;//吸毒人员走访数

	// private String idleYouthChain;
	// private int idleYouthVisitCount;//重点青少年走访数
	// private int newSecurityCount;// 截止上月总数治安重点单位场所
	// private String newSecurityChain;// 治安重点单位场所环比
	// private int doneIssueCount;// 截止上月总数已办事件
	// private String doneIssueChain;// 有效事件环比
