...
<script type="text/javascript">
	...
	<pop:formatterProperty name="manCareer" domainName="@com.tianque.domain.property.PropertyTypes@CAREER" />
	...
	var gridOption = {
	   	colModel:[
	        ...
	        {name:"attentionExtent",index:"attentionExtent",label:"关注程度",sortable:false,width:100,formatter:attentionExtentColor,forzen:true},
	        {name:"name", index:'name', label:'姓名',formatter:nameFont,sortable:false,width:80,frozen:true },
	        {name:'gender',formatter:genderFormatter, label:'性别', sortable:false,align:'center', width:50,hidden:true},
	        {name:'idCardNo',index:'idCardNo', label:'身份证号码',sortable:false,width:160,frozen:true},
	        {name:"usedName", index:'usedName', label:'曾用名/别名',sortable:false, width:95 ,hidden:true},
	        ...
	        {name:'marriageRegistrationTime', sortable:false,label:'离婚时间',align:'center',width:100},
	        ...
	        {name:"birthday", index:'birthday', label:'出生日期',sortable:false,align:'center', width:80 ,hidden:true},
	        ...
	        {name:'workUnit',sortable:false, label:'工作单位或就读学校', width:180, hidden:true },
	        ...
	        {name:'province',index:'province',sortable:false,label:'户籍地',formatter:householdRegisterFormatter,width:200,hidden:true},
	        {name:'nativePlaceAddress', sortable:false, label:'户籍地详址', width:150,hidden:true},
	        {name:"schooling",sortable:false,label:"育妇文化程度",formatter:schoolingFormatter,width:100,hidden:true},
	        {name:"maritalState",sortable:false,label:"育妇婚姻状况",formatter:maritalStateFormatter,align:'center',width:100,hidden:true},
	        {name:'otherAddress', sortable:false, label:'临时居所', width:150,hidden:true},
	        {name:'firstMarriageTime',sortable:false,label:'初婚时间',width:80,align:'center',hidden:true},
	        {name:'licenseSituation',sortable:false,label:'领证情况',formatter:licenseSituationFormatter,width:100,hidden:true},
	        {name:'marriageOrDivorceTime',sortable:false,label:'最近再婚时间',align:'center',width:100,hidden:true},
	        {name:'fertilityServicesNo',sortable:false,label:'生育服务证',width:90,hidden:true},
	        {name:'licenseTime',sortable:false,label:'领证时间',align:'center',width:80,hidden:true},
	        {name:'contraceptiveMethod',sortable:false,label:'避孕方法',width:80,hidden:true},
	        {name:'contraceptiveTime',sortable:false,label:'避孕起始时间',align:'center',width:100,hidden:true},
	        {name:'onechildOfCouple',sortable:false,label:'夫妻双方独生子女情况',formatter:onechildOfCoupleFormatter,width:150,hidden:true},
	        {name:'manIdcardNo',sortable:false,label:'男方身份证号码',width:150,hidden:true},
	        {name:'manName',sortable:false,label:'男方姓名',width:80,hidden:true},
	        {name:'manMaritalState',sortable:false,label:'男方婚姻状况',formatter:maritalStateFormatter,width:100,hidden:true},
	        {name:'manFirstMarriageTime',sortable:false,label:'男方初婚时间',align:'center',width:100,hidden:true},
	        {name:'manMobileNumber',sortable:false,label:'男方联系手机',align:'center',width:100,hidden:true},
	        {name:'manTelephone',sortable:false,label:'男方固定电话',align:'center',width:120,hidden:true},
	        {name:'manBirthday',sortable:false,label:'男方出生日期',align:'center',width:100,hidden:true},
	        {name:'manNation',sortable:false,label:'男方民族',formatter:nationFormatter,width:80,hidden:true},
	        {name:'manPoliticalBackground',sortable:false,label:'男方政治面貌',formatter:politicalBackgroundFormatter,width:150,hidden:true},
	        {name:'manSchooling',sortable:false,label:'男方文化程度',formatter:schoolingFormatter,width:100,hidden:true},
	        {name:'manCareer',sortable:false,label:'男方职业',formatter:manCareerFormatter,width:80,hidden:true},
	        {name:'manWorkUnit',sortable:false,label:'男方工作单位或就读学校',width:200,hidden:true},
	        ...
	        {name:'manCurrentAddress',sortable:false,label:'男方常住地址',width:200,hidden:true},
...
<jsp:include page="/baseinfo/commonPopulation/commonPopulationList.jsp">
	<jsp:param value="NurturesWomen" name="moduleName"/>
	<jsp:param value="育龄妇女" name="moduleCName"/>
	<jsp:param value="7" name="newStartRow"/>
