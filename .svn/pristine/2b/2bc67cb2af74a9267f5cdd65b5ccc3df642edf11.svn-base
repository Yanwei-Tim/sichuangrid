...
/**
 * @Description:育龄妇女自动注销job
 * @author zhangyouwei@hztianque.com
 * @date: 2015-6-11 上午09:18:15
 */
@Component("nurturesWomenDispatch")
public class NurturesWomenDispatch implements Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(NurturesWomenDispatch.class);
	@Autowired
