...
<div class="content">
	<div class="ui-corner-all" id="nav">
		...
		<div class="nav-sub-buttons">
				...
				<a id="OrgLoginStanalsJob" href="javascript:void(0)" onclick="manualJobCompletion('issueHistoryReport')"><span><strong class="ui-ico-dc"></strong>事件研判分析历史列表补全</span></a>
		</div>
		...
		<a href="javascript:;" class="nav-dropdownBtn"><span>手机数据字典项job</span><b class="nav-dropdownBtn-arr"><b class="nav-ico-dArr"></b></b></a>
		<div class="nav-sub-buttons">
			<a id="allAttentionPeople" href="javascript:void(0)" onclick="mobilDictionaryJob('<s:property value="@com.tianque.core.util.NewBaseInfoTables@ALL_MOBILE_DICTIONARY"/>')"><span>全部字典项</span></a>
			<a id="allAttentionPeople" href="javascript:void(0)" onclick="mobilDictionaryJob('<s:property value="@com.tianque.core.util.NewBaseInfoTables@INCREMENT_MOBILE_DICTIONARY"/>')"><span>增量字典项</span></a>
		</div>
		</s:if>
...
//手机数据字典项job
function mobilDictionaryJob(jobType){
// 	$.messageBox({message:jobType+"的job开始执行"});
// 	return;
	$.ajax({
		url:"${path}/sysadmin/jobMonitor/mobilDictionaryJob.action",
		type:"post",
		data:{
			"jobType":jobType
		}
