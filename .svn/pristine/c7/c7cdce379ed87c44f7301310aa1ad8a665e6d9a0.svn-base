...
<div class="container container_24">
	<form id="serviceTeamMember_form" method="post" action="" >
		...
		<div class="grid_7">
			<select name="searchServiceTeamMemberVo.genderId" class="form-select">
		...
		<div class="grid_9">
			<input type="text" name="searchServiceTeamMemberVo.teamName" style="width:95%" class="form-txt"/>
		</div>
	    <div class='clearLine'>&nbsp;</div>
		...
		<div class="grid_7">
			<select id="teamClazz" name="searchServiceTeamMemberVo.teamClazzId" class="form-select" >
		...
		<div class="grid_9">
			<select id="teamTypeId" name="searchServiceTeamMemberVo.teamTypeId" style="width:96%" class="form-select"></select>
	  	</div>
