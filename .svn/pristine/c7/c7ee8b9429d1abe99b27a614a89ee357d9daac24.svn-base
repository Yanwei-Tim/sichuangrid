...
function onOrgChanged(){
	$("#statementStatisticList").setGridParam({
		url:'${path}/supervisionEvaluation/statementStatisticManage/findStatementStatisticsForPageByOrgId.action',
		datatype:'json'
	});
	$("#statementStatisticList").setPostData({
		"organization.id":getCurrentOrgId(),
		"year":$("#yearSelectOptions").val(),
		"month":$("#monthSelectOptions").val(),
		"page":1
	});
