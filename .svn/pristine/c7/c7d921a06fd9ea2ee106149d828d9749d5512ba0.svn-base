...
public class MemCacheConstant {
	...
	/**任务清单-新报表key*/
	public static final String TASK_LIST_NEW_STATISTICS="task_list_new_statistics";
	/** 任务清单-特殊人群key*/
	...
	/**服务清单报表*/
	public static final String SERVICE_LIST_ALL_NAMESPACE="service_list";
	public static final String SERVICE_LIST_ALL_KEY="service_list_all";
	/**用户登录详情查看报表namespace*/
	public static final String USER_ACCOUNT_LOGIN_DETAIL_STATISTICS="user_account_login_detail_statistics";
	/**用户登录详情查看报表key*/
	public static final String USER_ACCOUNT_LOGIN_DETAIL_STATISTICS_KEY = "user_account_login_detail_statistics_key";
	public static String getUserAccountDetailCachKey(String cacheKey,Long orgId){
		if (null == cacheKey || null == orgId) {
			return null;
		}
		String key = cacheKey+"_"+orgId;
		return key;
	}
	/***
	 * 任务清单获取缓存key
	 ...
	 * @return
	 */
	public static String getTaskListReportCachKey(String cacheKey,Long orgId,Integer searchType,Integer year,Integer month,Integer week,Integer searchYear){
		if (null == cacheKey || null == orgId) {
			return null;
		}
		String key = "";
		if(searchType==0){
			...
			key = cacheKey+"_"+searchYear+"_"+orgId+"_ByYear";
		}
		return key;
	}
	 ...
	 * 新农村项目 缓存
	 */
	public static final String NEW_VILLAGE_ACCEPTANCE_NAMESPACE="new_village_acceptance_namespace";
	public static final String NEW_VILLAGE_ACCEPTANCE_KEY="new_village_acceptance_key";
	
	public static final String getNewVillageAcceptanceCachKey(String key,Integer year){
