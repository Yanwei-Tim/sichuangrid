...
@Component("businessManageImportValidator")
public class BusinessManageValidatorImpl implements
		DomainValidator<BusinessManage> {
	@Autowired
	...
	@Override
	public ValidateResult validate(BusinessManage domain) {
	...
	//pc新增修改验证
	public void validatorBusinessManage(BusinessManage domain) {
