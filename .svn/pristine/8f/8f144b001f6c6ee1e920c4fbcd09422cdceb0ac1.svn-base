...
<jsp:include page="/baseinfo/commonPopulation/jsFunctionInclude.jsp">
	<jsp:param value="SuperiorVisit" name="moduleName"/>
</jsp:include>
...
var gridOption = {
	colModel:[
		...
		{name:"operation",index:"id",label:"操作",formatter:operateFormatter,sortable:false,width:90,frozen :true,align:"center"},
		...
		{name:"organization.orgName", index:"orgInternalCode",sortable:false, width:150,label:"所属网格",hidden:true},
		{name:"usedName", index:'usedName', label:'曾用名', width:80 ,sortable:false,hidden:true},
		{name:"telephone",label:"联系电话", width:120,align:"center",hidden:true,sortable:false},
		...
		{name:"currentAddress",label:"常住地址", width:200,sortable:false,hidden:true},
		{name:"otherAddress",label:"临时居所",width:200,sortable:false,hidden:true},
		{name:"visitState", label:"上访状态",sortable:false,width:100,align:"center", formatter:visitStateFormatter},
		{name:"visitReason",label:"上访原因",sortable:false, width:130},
...
<jsp:include page="/baseinfo/commonPopulation/commonPopulationList.jsp">
	<jsp:param value="SuperiorVisit" name="moduleName"/>
	<jsp:param value="重点上访人员" name="moduleCName"/>
	<jsp:param value="服务人员" name="supervisorPerson" />
</jsp:include>
<div style="display:none;">
	<input type="hidden" id="_populationType_" name="population.populationType" value='<s:property value="@com.tianque.core.util.BaseInfoTables@SUPERIORVISIT_KEY"/>'/>
		<input type="hidden" id="_supervisorName_"
	value='<s:property value="@com.tianque.service.util.ServiceTeamMemberOrRecord@getMemberAlias(@com.tianque.core.util.BaseInfoTables@SUPERIORVISIT_KEY)" escape="false"/>'/>
	<input type="hidden" id="_superviceRecordName_"
	value='<s:property value="@com.tianque.service.util.ServiceTeamMemberOrRecord@getRecordAlias(@com.tianque.core.util.BaseInfoTables@SUPERIORVISIT_KEY)" escape="false"/>'/>
</div>