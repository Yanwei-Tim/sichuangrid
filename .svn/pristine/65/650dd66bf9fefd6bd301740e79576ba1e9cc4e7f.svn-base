...
@Component("countyDataConverterPoxy")
public class CountyDataConverterPoxy extends AbstractDataConverter<Countrymen> {
	...
	DataConvert<Countrymen> convert;

	public void setConvert(DataConvert<Countrymen> convert) {
	...
	public Countrymen updateDomain(DataConvert convertt, Countrymen domain) {
	...
	public Countrymen persistenceDomain(DataConvert<Countrymen> convertt,
			Countrymen domain) {
