...
<table width="200" class="tablelist">
	<tr>
   	...
   	<tr>
	    ...
	    <td class="content"><span><pop:PropertyDictViewTag name="@com.tianque.domain.property.PropertyTypes@MASSEDUTY_TYPE" defaultValue="${serviceManageTeam.teamType.id}" /></span></td>
