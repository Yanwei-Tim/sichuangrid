...
<@s.include value="${path}/baseinfo/commonPopulation/jsFunctionInclude.jsp">
	<@s.param name="moduleName">RentalHouseTemp</@s.param>
</@s.include>
...
var gridOption = {
	colModel:[
		        ...
		        {name:"hiddenDangerLevel",index:"hiddenDangerLevel",label:'隐患程度',width:80,sortable:true,formatter :hiddenDangerLevelColor},
		        {name:"rentalPerson",index:'rentalPerson',label:'房主姓名',width:80,sortable:true},
...
<#assign moduleName="RentalHouseTemp"/>
<#assign bigType="house"/>
<#assign moduleCName="出租房"/>
