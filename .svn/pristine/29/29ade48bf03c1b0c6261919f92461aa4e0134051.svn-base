...
<div class="content">
	<jsp:include page="${path}/fourTeamsManage/fourTeamsIssueManage/partyMemberPioneerServiceTeam/partyMemberPioneerFourTeamsIssueForViewButtons.jsp"/>
...
function onOrgChanged(isEvaluate){
	...
	$("#issueList").setPostData({
		...
		"fourTeamsType":"<s:property value='@com.tianque.domain.property.FourTeamsType@PARTYMEMBERPIONEERSERVICETEAM'/>",
