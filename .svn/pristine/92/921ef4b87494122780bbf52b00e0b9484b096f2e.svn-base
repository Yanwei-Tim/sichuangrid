 ...
 */
@Component("houseLeaderViewSummaryCountJob")
public class HouseLeaderViewSummaryCountJob implements Job {
	private static Logger logger = LoggerFactory
			.getLogger(HouseLeaderViewSummaryCountJob.class);
	@Autowired
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		createHouseLeaderViewSummaryData();
	}
}
