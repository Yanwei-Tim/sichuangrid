...
<style>
	...
	#reportName , #selectedMonthForDis{
			text-align:center;border:0px;border-style:none;height:33.0pt;font-size:25px; font-weight:bold;
	}
</style>
<table id='tb' class="tb" border=0 cellpadding=0 cellspacing=0 style='border-collapse:collapse;table-layout:fixed;width:691pt'>
	<s:if test='"add".equals(mode)'>
		<tr>
			<td colspan=9 height=44 id="reportName" class=head >${dailyYear.name}年<span id="selectedMonthForDis"></span>${organization.orgName}矛盾纠纷排查情况表</td>
		</tr>
	</s:if>
	<s:else>
		<tr>
			<td colspan=9 height=44 id="reportName" class=head >${disputEsexamine.name}</td>
		</tr>
	</s:else>
</table>
	
	<table class="tb" border=0 cellpadding=0 cellspacing=0 style='border-collapse:collapse;table-layout:fixed;width:692pt'>
		<tr>
			...
			<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@MONTH_REPORT">
				<td colspan=4 class=head style="border:0px; text-align:right;margin-right:20px;">填报月份：
		  	...
		  	<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@QUARTER_REPORT">
			  	<td colspan=4 class=head style="border:0px; text-align:right;margin-right:20px;">填报季度：
				  	<select id="reportTime" <s:if test='!"add".equals(mode)'>disabled="disabled"</s:if>>
						<s:iterator value="dateMap" id="date" >
						    <s:property value="#date"/>
							<option value='<s:property value="key"/>'><s:property value="value"/></option>
		  	...
		  	<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@SEMIYEARLY_REPORT">
			  	<td colspan=4 class=head style="border:0px; text-align:right;margin-right:20px;">填报半年度：
				  	<select id="reportTime" <s:if test='!"add".equals(mode)'>disabled="disabled"</s:if>>
		  	...
		  	<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@YEAR_REPORT">
			  	<td colspan=4 class=head style="border:0px; text-align:right;margin-right:20px;">填报年度：
	...
	<div class="tableCtt">
	<table id='tb' class="tb" border=0 cellpadding=0 cellspacing=0 style='border-collapse:collapse;table-layout:fixed;width:766pt'>
	
	<tr id='c_0_' >
		<td width="32" height=26 class=order >1</td>
		<td colspan=2 rowspan=5 class=label style='width:196pt'>总<span
	...
	<tr id='c_428_' >
		...
		<td class=label >起数</td>
		<td name="issuehigherCountyStagescount" yearCountTarget="issuehigherYearStagescount" class="inputClick toDataJosn" countName="issuehigherUnStagescount-data" countTarget="issuehigherUnStagescount">${disputEsexamine.issuehigherCountyStagescount}</td>
		<td name="issuehigherTwonStagescount" yearCountTarget="issuehigherYearStagescount" class="inputClick toDataJosn" countName="issuehigherUnStagescount-data" countTarget="issuehigherUnStagescount">${disputEsexamine.issuehigherTwonStagescount}</td>
	...
	<tr id='c_430_'>
		...
		<td name="concentrateCountyFinishcount" yearCountTarget="concentrateYearFinishcount" class="inputClick toDataJosn" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateCountyFinishcount}</td>
		<td name="concentrateTwonFinishcount" yearCountTarget="concentrateYearFinishcount" class="inputClick toDataJosn" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateTwonFinishcount}</td>
		<td name="concentrateVilFinishcount" yearCountTarget="concentrateYearFinishcount" class="inputClick toDataJosn" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateVilFinishcount}</td>
	...
	<table id='tb' class="tb" border=0 cellpadding=0 cellspacing=0 style='border-collapse:collapse;table-layout:fixed;width:692pt'>
	<tr  >
		<td colspan=3 class=bottom>签发人：<input  id="checkUser" type= "text"   maxLength= "12 " value="${disputEsexamine.dealPerson}"   name="disputEsexamine.dealPerson"  size= "12 "   style= "BORDER-BOTTOM:   #000000   1px solid; BORDER-LEFT:   #ffffff   0px   solid;   BORDER-RIGHT:   #ffffff   0px   solid;   BORDER-TOP:   #ffffff   0px   solid "/>  </td>
