...
@Scope("prototype")
@Namespace("/baseInfo/baseSituationStatement")
@Controller("baseSituationStatementController")
public class BaseSituationStatementController extends StatisticAction {
	...
	public String baseSituationStatementList() throws Exception {
		...
		listColumnVo = baseSituationStatementService
	...
	public String baseSituationStatementReportGeneration() throws Exception {
		...
		baseSituationStatementService.addBaseStituationStatementHistory(year,
				month);
		return SUCCESS;
	}
