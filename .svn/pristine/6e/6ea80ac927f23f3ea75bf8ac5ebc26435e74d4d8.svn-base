...
function getList(){
	$.ajax({
		url:'${path }/plugin/taskListManage/common/getHiddenDangerVisitList.action?orgId='+getCurrentOrgId()+'&searchType='+$("#searchType").val()+'&year='+$("#year").val()+'&month='+$("#month").val()+'&week='+$("#week").val()+'&searchYear='+$("#yearVal").val(),
