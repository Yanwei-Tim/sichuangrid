...
function onOrgChanged(){
	var chartCount=$("#SimplyColumn").columnChart({
		url: "/baseInfoStat/statisticsPopulation/getStatisticsPopulationColumn.action?populationType=<@s.property value='#parameters.populationType[0]'/>&orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val(),
