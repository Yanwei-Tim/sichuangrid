...
<div>
	...
	<input type="hidden" name="drugsSafty.isSign"  value="${drugsSafty.isSign}" />
	<div class="container container_24"> 
		...
		<div class="grid_8 lable-left">
			<input id='inputTime' name='drugsSafty.inputTime' value='<s:date name="drugsSafty.inputTime" format="yyyy-MM-dd HH:mm:ss"/>' class="form-txt" readonly="readonly" />
		</div>
	    <div class="grid_4 lable-right">
	    	<em class="form-req">*</em>
		...
		<div class="grid_8 lable-left">
			<input name='drugsSafty.address' value='${drugsSafty.address}' title="${drugsSafty.address}" maxlength="40" class="form-txt {required:true,messages:{required:'地点不能为空'}}" <s:if test='"view".equals(mode)'>readonly="readonly"</s:if> />
		</div>
		...
		<div class="grid_8 ">
			<input name='drugsSafty.details' value='${drugsSafty.details}' title="${drugsSafty.details}" maxlength="50" class="form-txt {required:true,messages:{required:'情况描述不能为空'}}" <s:if test='"view".equals(mode)'>readonly="readonly"</s:if> />
		</div>
		<div class='clearLine'>&nbsp;</div>
		...
		<div class="grid_8 ">
			<input name='drugsSafty.personnel' value='${drugsSafty.personnel}' title="${drugsSafty.personnel}" maxlength="50" class="form-txt" <s:if test='"view".equals(mode)'>readonly="readonly"</s:if> />
		</div>
		<div class='clearLine'>&nbsp;</div>
		...
		<div class="grid_20 heightAuto">
            <textarea rows="4" name="drugsSafty.remake" maxlength="300"  cols="" class="form-txt" <s:if test='"view".equals(mode)'>disabled="disabled"</s:if> >${drugsSafty.remake}</textarea>
    	</div>
		<div class='clearLine'>&nbsp;</div>
	...
	<div class="container container_24"> 
		...
		<div class="grid_8 lable-left">
			<input id='createUser' value='${drugsSafty.telephone}'  readonly="readonly" class="form-select "/>
		</div>
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_4 lable-right">
	    	<em class="form-req">*</em>
