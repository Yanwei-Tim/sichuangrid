...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/baseInfoStat/mentalPatient/mentalPatientColumnList.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/mentalPatient/mentalPatientPieList.jsp">危险程度分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/mentalPatient/mentalPatientCountList.jsp">列表信息</a></li>
