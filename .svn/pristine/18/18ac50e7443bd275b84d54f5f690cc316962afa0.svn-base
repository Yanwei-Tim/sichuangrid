...
<div id=tabs>
	<ul>
		...
		<li id="videoSystem"><a href="${path}/videoSystemManage/dispatchByEncrypt.action?mode=${param.mode}&videoSystem.id=${param.id}">基本信息</a></li>
	</ul>
</div>
<script>
...
$(function() {
	...
	if(publicSecurityType=="<s:property value='@com.tianque.publicSecurity.constant.PublicSecurityType@VIDEOSYSTEM'/>"){
		$("#tabs #skynet,#bayonet,#snapshotSystem").remove();
	}
