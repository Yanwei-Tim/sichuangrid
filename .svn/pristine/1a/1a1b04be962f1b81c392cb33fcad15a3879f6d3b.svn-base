...
/**
 * @Description:三本台账乡镇报表
 * @author zhangyouwei@hztianque.com
 * @date: 2014-11-20 上午10:04:27
 */
@Component("accountReportTownJob")
public class AccountReportTownJob extends IScheduleTaskDealSingleBase<Long> {
	private static Logger logger = LoggerFactory
			.getLogger(AccountReportTownJob.class);
	@Autowired
	private AccountReportJobOptmizeHelper accountReportJobOptmizeHelper;

	@Override
	public boolean execute(Long townOrgId, String ownSign) throws Exception {
		return true;
	}
	...
	public List<Long> queryTasks(String taskParameter, String ownSign,
		...
		size.set(accountReportJobOptmizeHelper
				.executeDataByModelForAccountReportTown(year, month, idModList,
						taskParameter));
	...
	public String getJobRemark() {
		return ScheduleNameConstant.ACCOUNT_REPORT_TOWN;
	}
