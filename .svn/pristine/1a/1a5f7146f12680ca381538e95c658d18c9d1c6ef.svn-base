...
<div id="viewManageTeamMember" class="container container_24">
...
<%-- 		</pop:JugePermissionTag> --%>
		...
		<input id="dataId" type="hidden" value="<s:property value='#parameters.id'/>"/>
	</div>
<div id="addMemberDialog"></div>

	<div id="tabs">
		<ul>
			<li id="liHava"><a id="hava"  href='${path}/fourTeamsManage/manageTeamMemberList.jsp'>队伍成员</a></li>
		</ul>
	</div>
