...
<div class="content">
	<div class="ui-cornRr-all" id="nav">
			...
			<a id="deletePerson" href="javascript:void(0)"><span>删除</span></a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#logoutPerson").click(function(){
			...
			$.confirm({
				title:"确认注销",
				message:"该治安负责人信息注销后，将无法恢复,您确认注销该人员信息吗?",
				width: 400,
				okFunc: function(){
				$.ajax({
		...
		$("#deletePerson").click(function(){
			...
			$.confirm({
				title:"确认删除",
				message:"是否确认删除该治安管理人信息？",
				width: 400,
				okFunc:function(){
					$.ajax({
						url:"${path}/baseinfo/personInCharegeManage/deletePersonInCharege.action?personInCharges.id="+id[0],
						success:function(data){
						    $.messageBox({message:"已经成功删除该治安管理人信息!"});
						    $("#personInChargeList").trigger("reloadGrid");
						}
					});}
			})
