...
public class AnalyseUtil {
	...
	/** 用户月登录统计详情历史表 */
	public static final String USER_LOGIN_DETAILS_NAME = "userLoginStatistics";
	
	/** 任务清单研判详情历史月表-表名 */
	public static final String TASK_LIST_GENERALSITUATION_MONTH_TABLENAME="generalSituationMonth";
	/** 任务清单研判详情历史季度表-表名 */
	public static final String TASK_LIST_GENERALSITUATION_QUARTER_TABLENAME="generalSituationQuarter";
	/** 任务清单研判详情历史上半年表-表名 */
	public static final String TASK_LIST_GENERALSITUATION_FIR_YEAR_TABLENAME="generalSituationFirYear";
	/** 任务清单研判详情历史下半年表-表名 */
	public static final String TASK_LIST_GENERALSITUATION_SCO_YEAR_TABLENAME="generalSituationHalfYear";
	/** 任务清单研判详情历史全年表-表名 */
	public static final String TASK_LIST_GENERALSITUATION_YEAR_TABLENAME="generalSituationYear";
	
	/** 任务清单研判详情历史表-建表sql */
	public static final String TASK_LIST_GENERALSITUATION_SQL="create table %s "
		...
		+" year number(4) ,"
		+" month number(2) ,"
		+" basesicType varchar2(20),"
		+" detailType varchar2(40),"
		+" subType varchar2(40),"
		+" monthCreateSign number(10),"
		+" policeStationSign number(10),"
		+" clinicSign number(10),"
		+" allCountSign number(10),"
		+" monthCreateCount number(10),"
		+" allCount number(10),"
		+" createUser varchar2(60),"
		+" createDate Date)";

	/** 用户月登录统计详情历史表sql */
	public static final String USER_LOGIN_DETAILS_SQL = "create table %s "
			+ "(id 					number(10)  			not null primary key,"
	...
	/** 党委部门数据统计索引primaryorgtype字段 */
	public static final String PRIMARYORGTYPE_COLUMN = "primaryorgtype";
	/** 党委部门数据统计索引primaryorgtype字段名称 */
	public static final String PRIMARYORGTYPE_COLUMN_NAME = "pOrgtype";
	...
	/** 党委部门数据统计索引map */
	public static final Map<String, String> DEPARTMENTPARTY_INDEX_MAP = new HashMap<String, String>();
	static {
		DEPARTMENTPARTY_INDEX_MAP.put(ORGINTERNALCODE_COLUMN,
				ORGINTERNALCODE_COLUMN_NAME);
		DEPARTMENTPARTY_INDEX_MAP.put(PRIMARYORGTYPE_COLUMN,
				PRIMARYORGTYPE_COLUMN_NAME);
