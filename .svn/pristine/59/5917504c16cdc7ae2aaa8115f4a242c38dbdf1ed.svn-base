...
<form id="mForm" method="post" enctype="multipart/form-data" action="${path}/dataTransfer/importToDomain.action">
	<div id="upload-div" class="container container_24">
		<div class="grid_24 heightAuto">
		    <label class="form-lbl" id="templateVersion">
		           如数据模板不正确，您可以下载新模版：
		    <a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.provinceTemplates).url"/>'><b><font color="dimgray"><i>省级用户模板</i></font></b></a>
            &nbsp;&nbsp;<a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.cityTemplates).url"/>'><b><font color="dimgray"><i>市级用户模板</i></font></b></a>
            &nbsp;&nbsp;<a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.districtTemplates).url"/>'><b><font color="dimgray"><i>县级以下用户模板</i></font></b></a>
...
<%--             &nbsp;&nbsp;<a href='${path}/dataTransfer/downloadDataTemplate.action?dataTemplatesName=<s:property value="@com.tianque.datatransfer.ImportTemplatesSetting@getImportTemplatesVo(#parameters.villageTemplates).url"/>'><b><font color="dimgray"><i>网格用户模板</i></font></b></a> --%>
            </label>
		</div>
		<div id="importBox">
