...
public class IssueOperateLog extends BaseDomain {
	/** 服务办事 **/
	private Issue issue;
	/** 处理目标id **/
	...
	/** 针对的日志编号 **/
	private IssueOperateLog forIssueLog;
	/** 回退的日志 **/
	private IssueOperateLog backIssueLog;
	/** 处理步骤编号 **/
	...
	public IssueOperateLog getForIssueLog() {
		return forIssueLog;
	}

	public void setForIssueLog(IssueOperateLog forIssueLog) {
	...
	public IssueOperateLog getBackIssueLog() {
		return backIssueLog;
	}

	public void setBackIssueLog(IssueOperateLog backIssueLog) {
