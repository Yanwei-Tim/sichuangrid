...
<%@ include file="/includes/baseInclude.jsp" %>
    <div id="mentalPatient" class="container container_24">
	...
	<input id="populationType" type="hidden" name="population.populationType" value="${populationType}" />
		<div id=tabs>
			<ul>
				<li id="populationBaseInfo"><a href="${path}/baseinfo/mentalPatientManage/viewCommonPopulation.action?population.id=${population.encryptId}">基本信息</a> </li>
				<li><a href="${path}/baseinfo/mentalPatientManage/viewMentalPatient.action?population.id=${population.encryptId}">业务信息</a> </li>
				<pop:JugePermissionTag ename="serviceTeamMemberManagement">
			<li><a href="/plugin/serviceTeam/router/routerManage/maintainServiceMemberForPopulation.action?module=<s:property value='@com.tianque.service.util.PopulationType@MENTAL_PATIENT'/>&mode=view&id=${population.encryptId}">服务人员</a></li>
				...
				<pop:JugePermissionTag ename="serviceSupervisionMeasuresMentalPatient">
					<li><a href="${path }/plugin/serviceTeam/router/routerManage/maintainServiceRecordForPopulation.action?dailogName=mentalPatientDialog&populationType=${populationType}&id=${population.encryptId}&showRecordType=serviceSupervisionMeasuresView&module=MentalPatient">服务监管措施</a></li>
				</pop:JugePermissionTag>
				<li><a id="personnelTrackInfos">轨迹信息</a></li>
			<pop:JugePermissionTag ename="interviewMentalPatientRecordManagement">
...
// 		$.ajax({
// 			url:'${path}/baseinfo/populationTypeManage/getPopulationTypeByPopulationIdAndType.action?orgInternalCode=${population.orgInternalCode}&populationId=${population.encryptId}&populationType=<s:property value="@com.tianque.service.util.PopulationType@MENTAL_PATIENT"/>',
// 			async:false,
