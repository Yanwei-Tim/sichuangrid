...
<div >
	...
	<input type="hidden" id="domainId" name="helpPersonnel.personId" value="${personnelId}"/>
		...
		<div class="grid_9 lable-right">
			<label class="form-lbl">综治负责人人姓名：</label>
		</div>
		<div class="grid_14">
		...
		<div class="grid_9 lable-right">
			<label class="form-lbl">综治负责人人身份：</label>
		</div>
		<div class="grid_14">
		...
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_9 lable-right">
			<label class="form-lbl">综治负责人人手机：</label>
		</div>
		<div class="grid_14">
		...
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_9 lable-right">
			<label class="form-lbl">综治负责人人电话：</label>
		</div>
		<div class="grid_14">
