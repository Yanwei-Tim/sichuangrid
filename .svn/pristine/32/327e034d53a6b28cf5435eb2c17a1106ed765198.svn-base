...
$(document).ready(function(){
	$("#serviceRecordList").jqGridFunction({
		...
		postData:{
			"searchServiceRecordVo.populationId":'${population.id}',
			"searchServiceRecordVo.populationType":'${population.attentionPopulationType}',
			"searchServiceRecordVo.locationId":'${locationId}',
			"searchServiceRecordVo.locationType":'${locationType}'
		},
		datatype: "json",
		height:360,
		colNames:['id','发生时间','地点','服务人员','内容','附件','创建时间'],
	   	colModel:[
