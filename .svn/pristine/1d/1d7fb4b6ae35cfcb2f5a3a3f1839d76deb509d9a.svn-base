 ...
 */
@Component("fourTeamsPeaceVillageValidator")
public class FourTeamsPeaceVillageValidator implements DomainValidator<FourTeamsPeaceVillage> {
	...
	@Override
	public ValidateResult validate(FourTeamsPeaceVillage domain) {
