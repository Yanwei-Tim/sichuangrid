 ...
 *
 */
@Component("trafficDataConverter")
@Scope("prototype")
public class TrafficDataConverter extends ThreeAbstractDataConverter<Traffic> {

	@Autowired
	private PeopleAspirationDubboService ledgerPeopleAspirationsService;

	@Override
	public ValidateResult validate(Traffic domain, int realRow) {
		return null;
	}

	@Override
	public Traffic persistenceDomain(Traffic domain) {
		...
		return ledgerPeopleAspirationsService.addTraffic(domain);
	}

	@Override
	public Traffic updateDomain(Traffic domain) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Traffic convertToDomain(String[] cellValues, ValidateResult result) {
		// TODO Auto-generated method stub
		return null;
	}
