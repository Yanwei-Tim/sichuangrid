 ...
 */
@Namespace("/fourTeams/issueMessageRemindManage")
@Scope("request")
@Controller("fourTeamsIssueMessageRemindController")
public class FourTeamsIssueMessageRemindController extends BaseAction {
