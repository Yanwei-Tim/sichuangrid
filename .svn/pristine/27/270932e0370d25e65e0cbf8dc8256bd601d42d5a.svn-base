...
import com.tianque.fourTeams.dao.FourTeamsIssueInvestigationMediateDao;

@SuppressWarnings("unchecked")
@Repository("fourTeamsIssueInvestigationMediateDao")
public class FourTeamsIssueInvestigationMediateDaoImpl extends AbstractBaseDao implements
		FourTeamsIssueInvestigationMediateDao {
	...
	public void addIssueInvestigationMediates(
			List<IssueInvestigationMediate> mediates) {
		batchInsertDate(mediates,
				"issueInvestigationMediate.addIssueInvestigationMediate");
	}
	...
	public List<IssueInvestigationMediate> sumIssueInvestigationMediateByOrgAndMonth(
		...
		return getSqlMapClientTemplate()
				.queryForList(
						"issueInvestigationMediate.sumIssueInvestigationMediateByOrgAndMonth",
						condition);
	}
