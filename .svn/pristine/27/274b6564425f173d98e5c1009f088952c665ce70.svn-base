...
<@s.include value="/baseinfo/commonPopulation/jsFunctionInclude.jsp">
	<@s.param name="moduleName">EnterpriseDownKeyTemp</@s.param>
</@s.include>
<script type="text/javascript">
	...
	var gridOption={
		colModel:[
			...
			{name:'organization.orgName',index:'orgInternalCode',label:'所属网格',width:150,sortable:false},
			...
			{name:"type", index:"type", label:'企业类型', sortable:true,formatter:typeFormatter,width:90,align:'center',hidden:true},
			{name:"businessLicense",sortable:true, label: '工商执照号码',width:100},
			{name:"manager", index:"legalPerson", sortable:true,label:'法人代表',width:100},
...
<#assign moduleName="EnterpriseDownKeyTemp"/>
<#assign moduleCName="规下企业"/>
