 ...
 * 
 */
public class AdministrativeOrgTimeLimitStandard extends BaseDomain {
	...
	/** 黄牌验证时限 */
	private Integer yellowLimitVerify;
	/** 红牌验证时限 */
	private Integer redLimitVerify;

	private String itemIds;// 多个IDs
