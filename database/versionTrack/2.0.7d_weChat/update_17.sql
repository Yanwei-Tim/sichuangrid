...
--删除微信中心所有表
DROP TABLE INBOX;
DROP TABLE INBOXATTACHMENT;
DROP TABLE REPLY_MESSAGE;
DROP TABLE FAN;
DROP TABLE WECHAT_GROUP;
DROP TABLE TENCENT_USER;
DROP TABLE wechatSource_Attachment;
DROP TABLE KEYWORD;
DROP TABLE wechat_source;
DROP TABLE REDENVELOPESPAYMENTRECORDS;
DROP TABLE REDENVELOPE;
DROP TABLE TEMPLATEMESSAGERECORD;
DROP TABLE preciseInbox;
