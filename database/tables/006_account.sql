...
'台账类型';
comment on column platformAccountHasAttachFiles.replyFormId is
'回复单编号';
...
create table platformAccountLogs  (
   ...
   exchangeDate      DATE,
   submitToCommittee  NUMBER(1) default 0,
   opinion  varchar2(500) ,
   operateTime   DATE,
   joinMen  varchar2(100),
...
comment on column  platformAccountLogs.joinMen is '参与人';
...
/*==============================================================*/
 create table ledgerPeopleAspirations(
	...
	oldLedgerType           NUMBER(10),
	oldLedgerId           NUMBER(10),
	oldHistoryId           VARCHAR2(20),
	isCanFeedBack number(1),
...
create table ledgerPoorPeople  ( 
   ...
   poorType             varchar2(100),
   requiredType         varchar2(200),
  ...
  is '原事件编号'; 
   ...
   comment on column ledgerpoorpeople.remark is '备注';
...
create table ledgerPoorPeopleMember  (
 ...
 comment on table ledgerPoorPeopleMember
  ...
  is '健康状况';  
  comment on column ledgerPoorPeopleMember.skillsSpeciality
  is '技能特长';  
...
(
  ...
  involvingSteadyInfo    VARCHAR2(500) not null,
