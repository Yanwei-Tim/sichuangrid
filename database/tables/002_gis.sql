...
create table systemLogs_2016_1  (
   id                   NUMBER(10)                      not null primary key,
   orgId                NUMBER(10),
   operationContent     clob,
   logLevel             NUMBER(10),
...
create index idx_syslog_2016_1_loglevel on systemLogs_2016_1 (loglevel);
create index idx_syslog_2016_1_modulename on systemLogs_2016_1 (modulename);
create index idx_syslog_2016_1_operatetime on systemLogs_2016_1 (operatetime);
create index idx_syslog_2016_1_orgcode on systemLogs_2016_1 (orginternalcode);
create index idx_syslog_2016_1_username on systemLogs_2016_1 (username);