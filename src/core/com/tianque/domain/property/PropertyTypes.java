...
public class PropertyTypes {
	 ...
	 * 红袖套队伍类型
	 */
	public final static String RED_CUFF_TEAM_TYPE="红袖套队伍类型";
	/**
	 * 红袖套队伍类别
	 */
	public final static String RED_CUFF_TEAM_SUB_TYPE="红袖套队伍类别";
	
	
	/**
	 * 网格员专兼职情况
	 */
	public final static String GRID_POSITIONTYPE="网格员专兼职情况";
	...
	/** 单位场所-污染源 */
	public final static String INDUSTRY_TYPE = "产业类型";
	public final static String WASTEWATER_TYPE = "废水污染物类型";
	public final static String WASTESOLID_TYPE = "固体污染物类型";
	public final static String RADIOACTION_TYPE = "放射性废物类型";
	public final static String NOISE_TYPE = "噪音测点类型";
	public final static String WASTEGAS_TYPE = "废气污染物类型";
	public final static String ASSESSMENT_TYPE = "环评";
	public final static String LOWASICS_TYPE = "是否在居民楼下";
	public final static String CONCERN_TYPE = "关注-程度";
	public final static String RELATIONSHIP_TYPE = "隶属关系";
	public final static String UNIT_TYPE = "单位类别";
	public final static String SCALE_TYPE = "企业规模";
	public final static String KEYINDUSTRY_TYPE = "重点行业";
	public final static String SUPERVISE_TYPE = "监管类别";
	public final static String CONTAMINATION_TYPE = "污染源类别";
	public final static String TRADE_TYPE = "行业-类别";
	public final static String TRADE_TYPE_SMALL = "行业二级类别";
	public final static String LICENSING_TYPE = "行政许可";
	public final static String BASIN = "所属流域";
	...
	public final static String TASKLIST_ITEM_NAME = "任务清单项目名称";
	...
	public final static String TREATMENTSTATE = "治疗状态";// 严重精神障碍患者治疗状态
	// 研判分析 - 青少年
	...
	// 十户联防字典项
	public final static String ALARMCENTER = "所属接警中心";
	public final static String POLICEROOM = "警务室";
	public final static String MESSAGETYPE = "消息类型";

	/** 见义勇为的数据字典项 */
	public final static String INSURE_SITUATION = "参保情况（大类）";
	public final static String INSURE_SITUATION_SUB = "参保情况（子类）";
	public final static String DISABLE_GRADE = "伤残等级";
	public final static String IS_SACRIFICE = "是否牺牲";
	public final static String AWARD = "见义勇为奖项";
	public final static String DIFFICULT_TYPE_GOOD_SAMARITAN = "见义勇为困难类型";
	...
	/** job策略用到的字典项 */
	public final static String TASKPLOY_TYPE = "任务类型";
	public final static String TASK_FREQUENCY = "任务频率";
	...
	/** 农工委项目字典 */
	public final static String PROJECT_TYPE = "项目类型";
	public final static String BUILLDING_TYPE = "建设分类";
	/** 基础设施建设分类 */
	public final static String INFRASTRUCTURE_BUILLDING_TYPE = "基础设施建设分类";
	public final static String LEDGER_TYPE = "三本台账类型";
	public final static String LEDGER_STATUS = "三本台账状态";
	
	
	/**微信中心*/
	public final static String WECHAT_TYPE = "微信";
	/**微信消息语音提示状态*/
	public final static String WECHAT_INBOX_VOICE_PROMPT_TYPE="微信消息语音提示状态";
	/**
	 * 服务清单类别
	 */
	public final static String POLICY_PROPAGANDA_CATEGORY = "政策法规宣传类别";
	
	public final static String FOOD_SAFTY_CATEGORY = "食品安全协管类别";
	public final static String HEALTH_CARE_PRODUCTS = "食品保健食品";
	public final static String RURAL_FAMILY="农村家宴";
	public final static String FOOD_POISONING="食品中毒";
	
	public final static String DRUGS_SAFTY_CATEGORY = "药品安全协管类别";
	public final static String BUSINESS_MANAGE_CATEGORY = "工商行政管理协管类别";
	public final static String PYRAMID_CATEGORY = "打击非法传销协管类别";
	public final static String PYRAMID_SALES_CATEGORY = "传销类别";
	public final static String UNLICENSED_CATEGORY = "查处取缔无证无照经营协管类别";
	...
	public final static String HELPING_SITUATION_TYPE = "帮扶情况";
	public final static String EXCEPTION_SITUATION_TYPE = "宣传核查异常情况";
	public final static String WORKING_CONTENT_TYPE = "民警带领下工作内容";
	public final static String DANGER_EXCEPTION_TYPE = "治安隐患异常类型";
	public final static String MENTALPATIENT_OUT_REASON = "精神病外出原因";
	public final static String DRUGGY_LIFE_RESOURCE = "吸毒人员生活来源";
	public final static String OPERATING_BRAND = "经营品牌";
	public final static String OPERATING_MODE = "经营方式";
	
	public final static String ECONOMICCHARACTER="经济性质";
}