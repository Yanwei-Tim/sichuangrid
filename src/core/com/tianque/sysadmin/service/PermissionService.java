...
public interface PermissionService {
	...
	public PageInfo<UserCountAboutVo> findUsersAboutUserCount(
			Long orgId, Date loginBeginDate, Date loginEndDate, Date createBeginDate, Date createEndDate,int pageNum, int pageSize, String sortField, 
			String order, Long pcOrMobile, Long isSelectLoginTime, Date beginActivationTime, Date endActivationTime, Long isSelectActivationTime);
