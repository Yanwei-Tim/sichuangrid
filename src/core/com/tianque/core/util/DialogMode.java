...
public interface DialogMode {
	...
	public final String SIGNFILEREMIND = "signFileRemind";// 表示是文件共享资料
	public final String SHAREDFILEREMIND = "sharedFileRemind";// 表示文件签收

	public final String HISTORY_VIEW = "historyView";

	public final String REPORT_MODE = "report";// 上报
	public final String CHECK_MODE = "check";// 审核
	
	public static final String DIALOGMODE_SIGN = "sign";//签收
	
	// 农工委项目新增
	public final String PHOTO_EDIT = "photoEdit";
	public final String BASICINFOMATIONEDIT = "basicInfomationEdit";
	public final String BASICINFOMATIONEDITNATURE = "basicInfoMationEditNature";
