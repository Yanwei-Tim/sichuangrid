...
public class GridProperties {
	...
	//手机客户端上传过来的文件保存到本地服务器中对应的路径
	public static final String MOBILEERRORLOGS = "uploadFile" + fileSeparator + "mobileErrorLogs";
	...
	/**微信消息默认语音提示文件*/
	public static final String DEFAULT_WECHAT_INBOX_VOICE_PROMPT_FLIE = getKey("default_wechat_inbox_voice_prompt_flie");
	//内网访问外网的请求代理服务
