...
import com.tianque.baseInfo.buildDatas.dao.BuilddataStatDao;
 ...
 * @date 2013-3-26
 */
@Component("builddataStatService")
@Transactional
public class BuilddataStatServiceImpl implements BuilddataStatService {
	private final static Logger logger = LoggerFactory
			.getLogger(BuilddataStatServiceImpl.class);
	@Autowired
	private BuilddataStatDao builddataStatDao;
	@Autowired
	...
	private void createHistoryStatistic(int year, int month, String type,
		...
		builddataStatDao.deleteBuilddataStatType(
				statisticSearchVo.getOrginternalcode(), year, month, type);
		fillOrgLevelAndOrgType(statisticSearchVo);
		builddataStatDao.addHistoryStatistic(statisticSearchVo);
