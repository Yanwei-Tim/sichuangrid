package com.tianque.baseInfo.unemployedPeople.validator;
...
@Component("unemployedPeopleValidator")
public class UnemployedPeopleValidatorImpl extends
		AbstractCountrymenValidator<UnemployedPeople> {

	@Override
	public ValidateResult validateSpecializedInfo(UnemployedPeople domain) {
