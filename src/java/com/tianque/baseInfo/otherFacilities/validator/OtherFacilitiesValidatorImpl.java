package com.tianque.baseInfo.otherFacilities.validator;
...
@Component("otherFacilitiesValidator")
public class OtherFacilitiesValidatorImpl implements DomainValidator<OtherFacilities> {
	@Autowired
	...
	@Override
	public ValidateResult validate(OtherFacilities domain) {
