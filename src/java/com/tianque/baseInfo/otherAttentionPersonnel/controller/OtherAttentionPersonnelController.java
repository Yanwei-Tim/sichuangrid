...
@Namespace("/baseinfo/otherAttentionPersonnelManage")
@Transactional
@Controller("otherAttentionPersonnelController")
@Scope("prototype")
public class OtherAttentionPersonnelController extends
		PopulationControllerAdapter<OtherAttentionPersonnel> {

	@Autowired
	OtherAttentionPersonnelService otherAttentionPersonnelService;
	@Autowired
	...
	@Actions({
			@Action(value = "dispatchOperate", results = {
					...
					@Result(name = "search", location = "/baseinfo/otherAttentionPersonnel/searchOtherAttentionPersonnelsDlg.jsp"),
					@Result(name = "view", location = "/baseinfo/otherAttentionPersonnel/viewOtherAttentionPersonnelDlg.jsp"),
					@Result(name = "print", location = "/baseinfo/commonPopulation/printTabPreviewDlg.jsp"),
					@Result(name = "statistic", location = "/baseinfo/otherAttentionPersonnel/otherAttentionPersonnelForStatistics.jsp"),
	...
	public String dispatchOperate() throws Exception {
		actionName = "maintainOtherAttentionPersonnelBaseInfo";
		ajaxUrl = "hasDuplicateOtherAttentionPersonnel";
	...
	@Action(value = "dispatchOtherAttentionPersonnelBusiness", results = {
			@Result(name = "success", location = "/baseinfo/otherAttentionPersonnel/otherAttentionPersonnelDlg.jsp"),
			@Result(name = "error", type = "json", params = { "root",
					"errorMessage" }) })
	...
	@Override
	protected OtherAttentionPersonnel getPopulationFetchOrgById(Long id) {
		OtherAttentionPersonnel population = otherAttentionPersonnelService
	...
	@Action(value = "otherAttentionPersonnelList", results = {
	...
	public String findGridPageByOrgIdAndIsEmphasis() throws Exception {
		if (organizationId == null) {
			...
			gridPage = new GridPage(ControllerHelper.processAllOrgRelativeName(
					otherAttentionPersonnelService
							.findOtherAttentionPersonnelsForPageByOrgId(
	...
	@EncryptAnnotation
	@Actions({
			@Action(value = "deleteOtherAttentionPersonnelByIdsForMobile", results = {
					@Result(name = "success", type = "json", params = { "root",
							"true" }),
					@Result(name = "error", type = "json", params = { "root",
							"errorMessage" }) }),
			@Action(value = "deleteOtherAttentionPersonnelByIds", results = {
					@Result(name = "success", type = "json", params = { "root",
	...
	public String deleteByIds() throws Exception {
		otherAttentionPersonnelService
				.deleteOtherAttentionPersonnelByIds(Arrays
	...
	@Action(value = "hasDuplicateOtherAttentionPersonnel", results = {
			@Result(name = "success", type = "json", params = { "root",
	...
	public String hasDuplicatePopulation() throws Exception {
		...
		hasDuplicatePopulation = otherAttentionPersonnelService
				.existOtherAttentionPersonnel(organizationId,
						population.getIdCardNo(), population.getId());
		return SUCCESS;
	}

	@Actions({
			@Action(value = "maintainOtherAttentionPersonnelBaseInfo", results = {
					...
					@Result(name = "error", type = "json", params = { "root",
							"errorMessage" }) }),
			@Action(value = "maintainOtherAttentionPersonnelBaseInfoForMobile", results = {
					@Result(name = "success", type = "json", params = { "root",
							"true" }),
					@Result(name = "error", type = "json", params = { "root",
							"errorMessage" }) }) })
	...
	public String maintainBaseInfo() throws Exception {
		if (null != population && null != population.getId()) {
			population = otherAttentionPersonnelService
					.updateOtherAttentionPersonnelBaseInfo(population);
		} else {
			population = otherAttentionPersonnelService
					.addOtherAttentionPersonnelBaseInfo(population);
		}
		return SUCCESS;
	}

	@Action(value = "addOtherAttentionPersonnel", results = {
			@Result(name = "success", type = "json", params = { "root",
					"population", "ignoreHierarchy", "false" }),
			@Result(name = "error", type = "json", params = { "root",
					"errorMessage" }) })
	...
	public String maintainBusinessInfo() throws Exception {
		population = otherAttentionPersonnelService
				.updateOtherAttentionPersonnelBusiness(population);
		return SUCCESS;
	}
	...
	public String updateEmphasiseById() throws Exception {
		...
		populationIdList = otherAttentionPersonnelService
				.updateLogOutDetailAndCountByPopulationTypeAndIds(orgId,
						population.getLogoutDetail(),
						BaseInfoTables.OTHERATTENTIONPERSONNEL_KEY, ids);
		return SUCCESS;
	}
	...
	@Actions({
			...
			@Action(value = "viewOtherAttentionPersonnel", results = {
					@Result(name = "success", location = "/baseinfo/otherAttentionPersonnel/otherAttentionPersonnelView.jsp"),
					@Result(name = "error", type = "json", params = { "root",
							"errorMessage" }) }),
	...
	public String viewInfo() throws Exception {
		if (population != null && population.getId() != null) {
			population = otherAttentionPersonnelService
					.getSimpleOtherAttentionPersonnelById(population.getId());
			population.getOrganization().setOrgName(
					ControllerHelper.getOrganizationRelativeName(population
							.getOrganization().getId(), organizationDubboService));
		}
	...
	public String updateDeathByIds() throws Exception {
		populations = otherAttentionPersonnelService.updateDeathByIds(
