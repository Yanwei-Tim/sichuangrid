...
public class ModulTypes {
	...
	public final static String RESIDENTIAL = "住宅";
	...
	public static String Logistics = "寄递物流点";
	...
	/** 寄递物流点 */
	public static String LOGISTICS_KEY = "LOGISTICS";
	/** 全部的单位场所 */
	...
	/** 单位场所的业务信息和规上规下企业用于展示治安负责人和巡查情况 */
	public static Map<String, String> BUSSINESS_AND_SIZED = new HashMap<String, String>();
	// 业务
	...
	static {
		...
		PLACE_COMPANY_PLACE.put(LOGISTICS_KEY, Logistics);
		...
		allModuleKeys.add(LOGISTICS_KEY);
		/** 业务数据 */
		...
		/** 单位场所的业务信息和规上规下企业用于展示治安负责人和巡查情况 */
		BUSSINESS_AND_SIZED.put(SAFETYPRODUCTIONKEY_KEY, SafetyProductionKey);
		BUSSINESS_AND_SIZED.put(FIRESAFETYKEY_KEY, FireSafetyKey);
		BUSSINESS_AND_SIZED.put(SECURITYKEY_KEY, SecurityKey);
		BUSSINESS_AND_SIZED.put(POLLUTIONSOURCE_KEY, PollutionSource);
		BUSSINESS_AND_SIZED.put(ENTERPRISE_KEY, Enterprise);
		BUSSINESS_AND_SIZED.put(ENTERPRISEDOWN_KEY, EnterpriseDown);
		...
		mapKey.put("LOGISTICS_KEY", LOGISTICS_KEY);
		...
		allCompanyPlaceMapKey.add(LOGISTICS_KEY);
		...
		mapKeyCn.put(LOGISTICS_KEY, Logistics);
