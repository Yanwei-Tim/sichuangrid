 ...
 * @author yangpengdian
 */
@Namespace("/baseinfo/routerManage")
@Controller("routerForCompanyPlaceController")
@Scope("prototype")
public class RouterController extends BaseAction {
	...
	@Action(value = "maintainServiceMemberForLocation", results = {
			@Result(name = "success", location = "/template/router/serviceMember/serviceMemberWithObject/serviceTeamMemberListForCompanyPlace.ftl"),
			...
			@Result(name = "add", location = "/template/router/serviceMember/serviceMemberWithObject/serviceMemberWithCompanyPlaceMaintainDlg.ftl") })
	...
	public String findServiceMembersByServiceMemberVo() throws Exception {
		gridPage = new GridPage<ServiceMemberVo>(
				serviceTeamMemberService.findServiceMembersByServiceMemberVo(
						serviceMemberVo, page, rows, sidx, sord));
		return SUCCESS;
	}
