package com.tianque.baseInfo.roadTraffic.validator;
...
@Component("roadTrafficValidator")
public class RoadTrafficValidatorImpl implements DomainValidator<RoadTraffic> {
	@Autowired
	...
	@Override
	public ValidateResult validate(RoadTraffic domain) {
