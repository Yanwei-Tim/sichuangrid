...
@Component("unlicensedManageImportValidator")
public class UnlicensedManageValidatorImpl implements
		DomainValidator<UnlicensedManage> {
	@Autowired
	...
	@Override
	public ValidateResult validate(UnlicensedManage domain) {
	...
	//pc新增修改验证
	public void validatorUnlicensedManage(UnlicensedManage domain) {
