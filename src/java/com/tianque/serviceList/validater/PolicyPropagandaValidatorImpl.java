...
@Component("policyPropagandaImportValidator")
public class PolicyPropagandaValidatorImpl implements
		DomainValidator<PolicyPropaganda> {
	@Autowired
	...
	@Override
	public ValidateResult validate(PolicyPropaganda domain) {
	...
	//pc新增修改验证
	public void validatorPolicyPropaganda(PolicyPropaganda domain) {
