...
import com.tianque.fourTeams.service.FourTeamsIssueTypeService;
import com.tianque.mobile.vo.MobileIssueType;
import com.tianque.sysadmin.service.OrganizationDubboService;

@Transactional
@Service("fourTeamsIssueTypeService")
public class FourTeamsIssueTypeServiceImpl implements FourTeamsIssueTypeService {

	@Autowired
	private OrganizationDubboService organizationDubboService;

	@Autowired
	private FourTeamsIssueTypeDomainDao issueTypeDomainDao;

	@Autowired
	private FourTeamsIssueTypeDao issueTypeDao;
	...
	public boolean deleteIssueTypeById(IssueType issueType) {
		issueTypeDao.deleteIssueTypeById(
				issueType.getIssueTypeDomain().getId(), issueType.getId());
		return true;
	}
