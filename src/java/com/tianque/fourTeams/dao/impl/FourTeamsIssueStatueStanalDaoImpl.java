...
@Repository("fourTeamsIssueStatueStanalDao")
@SuppressWarnings("unchecked")
public class FourTeamsIssueStatueStanalDaoImpl extends AbstractBaseDao implements
		FourTeamsIssueStatueStanalDao {

	@Override
	public IssueStatueStanal addIssueStatueStanal(
			IssueStatueStanal issueStatueStanal) {
		Long id = (Long) getSqlMapClientTemplate().insert(
				"issueStatueStanal.addIssueStatueStanal", issueStatueStanal);
	...
	public void deleteIssueStatueStanal(IssueStatueStanal issueStatueStanal) {
		Map map = new HashMap();
		map.put("orgInternalCode", issueStatueStanal.getOrganization()
				.getOrgInternalCode());
		map.put("year", issueStatueStanal.getYear());
		map.put("month", issueStatueStanal.getMonth());
		getSqlMapClientTemplate().delete(
				"issueStatueStanal.deleteIssueStatueStanal", map);
	}
	...
	public IssueStatueStanal getIssueStatueStanalStatCountByYearAndMonth(
		...
		return (IssueStatueStanal) getSqlMapClientTemplate()
				.queryForObject(
						"issueStatueStanal.getIssueStatueStanalStatCountByYearAndMonth",
						query);
	}
}
