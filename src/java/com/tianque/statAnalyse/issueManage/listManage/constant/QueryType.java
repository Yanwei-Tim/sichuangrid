package com.tianque.statAnalyse.issueManage.listManage.constant;
...
public class QueryType {
	...
	public static final String ISSUE_HANDLE_STAT_TAB = "issuehandleStat";// 事件表名称
	public static final String ISSUE_CLASSIFICATION_STAT_TAB = "issueClassificationStat";
	public static final String ISSUE_STEP_STAT_TAB = "issueStepStat";
