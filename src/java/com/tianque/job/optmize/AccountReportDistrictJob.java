...
/**
 * @Description:三本台账县级报表
 * @author zhangyouwei@hztianque.com
 * @date: 2014-11-20 上午10:03:49
 */
@Component("accountReportDistrictJob")
public class AccountReportDistrictJob extends IScheduleTaskDealSingleBase<Long> {
	private static Logger logger = LoggerFactory
			.getLogger(AccountReportDistrictJob.class);
	@Autowired
	private AccountReportJobOptmizeHelper accountReportJobOptmizeHelper;

	@Override
	public boolean execute(Long districtOrgId, String ownSign) throws Exception {
		return true;
	}
	...
	public String getJobRemark() {
		return ScheduleNameConstant.ACCOUNT_REPORT_DISTRICT;
	}
