...
/**
 * @Description:重点青少年到期提醒job
 * @author zhangyouwei@hztianque.com
 * @date: 2015-6-9 下午04:14:24
 */
@Component("idleYouthTowDispatch")
public class IdleYouthTowDispatch {
	private static Logger logger = LoggerFactory
			.getLogger(IdleYouthTowDispatch.class);
	...
	public void emphasisIdleYouthJob() {
