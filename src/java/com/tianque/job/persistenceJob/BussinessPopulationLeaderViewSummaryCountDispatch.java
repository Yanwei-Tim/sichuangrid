 ...
 */
@Component("bussinessPopulationLeaderViewSummaryCountDispatch")
public class BussinessPopulationLeaderViewSummaryCountDispatch implements
		Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(BussinessPopulationLeaderViewSummaryCountDispatch.class);
	@Autowired
