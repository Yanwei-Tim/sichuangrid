 ...
 */
@Component("issueJointTempDataSyncDispatch")
public class IssueJointTempDataSyncDispatch implements Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(IssueJointTempDataSyncDispatch.class);
	@Autowired
	 ...
	 * 同步数据
	 */
	public void syncIssueJointTempData() {
