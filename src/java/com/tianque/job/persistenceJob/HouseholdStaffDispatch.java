...
/**
 * @Description:户籍转老年人job
 * @author zhangyouwei@hztianque.com
 * @date: 2015-6-10 下午10:46:03
 */
@Component("householdStaffDispatch")
public class HouseholdStaffDispatch implements Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(HouseholdStaffDispatch.class);
