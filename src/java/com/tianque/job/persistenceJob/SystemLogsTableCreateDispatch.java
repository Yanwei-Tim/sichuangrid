...
/**
 * @Description:创建systemlog分表job
 * @author zhangyouwei@hztianque.com
 * @date: 2015-6-11 上午10:47:30
 */
@Component("systemLogsTableCreateDispatch")
public class SystemLogsTableCreateDispatch implements Serializable {
	private static Logger logger = LoggerFactory
			.getLogger(SystemLogsTableCreateDispatch.class);
	@Autowired
