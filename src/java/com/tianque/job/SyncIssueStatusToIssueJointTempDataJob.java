 ...
 */
@Component("syncIssueStatusToIssueJointTempDataJob")
public class SyncIssueStatusToIssueJointTempDataJob implements Job {
	 ...
	 * 同步数据
	 */
	private void syncIssueStatusToIssueJointTempData() {
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		syncIssueStatusToIssueJointTempData();
	}
}
