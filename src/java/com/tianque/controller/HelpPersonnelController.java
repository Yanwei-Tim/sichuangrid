...
@Controller("helpPersonnelController")
@SuppressWarnings("serial")
@Scope("prototype")
public class HelpPersonnelController extends BaseAction {
	@Autowired
	...
	public String findHelpPersonnelForListPage() {
		if (!validatePaceTypeAndId()) {
			gridPage = new GridPage(emptyPage(rows));
			return SUCCESS;
		}
		gridPage = new GridPage(helpPersonnelService.findHelpPersonnel(personnelId, page, rows,
				sidx, sord, personnelType));
		return SUCCESS;
	}
	...
	public String dispatch() {
		if (DialogMode.ADD_MODE.equalsIgnoreCase(mode)) {
			...
			helpPersonnel = helpPersonnelService.getHelpPersonnel(helpPersonnel.getId());
	...
	public String getHelpPersonnelByIdAndPlace() {
		// if(!this.validatePaceTypeAndId()){
		// this.errorMessage = "参数错误";
		// return ERROR;
		// }
		helpPersonnelList = helpPersonnelService.findHelpPersonnelForList(personnelId,
				personnelType);
		return SUCCESS;
	}

	public String searchPersonInCharegeForAutoComplete() {
		if (!this.validatePaceTypeAndId()) {
			this.errorMessage = "参数错误";
			return ERROR;
		}
		helpPersonnelList = helpPersonnelService.searchPersonInCharegeForAutoComplete(personnelId,
				personnelType, tag);
	...
	public String addHelpPersonnel() {
		// if(!validateInput()){
		// this.errorMessage = "参数错误";
		// return ERROR;
		// }
	...
	public String updateHelpPersonnel() {
		// if(!validateInput()){
		// this.errorMessage = "参数错误";
		// return ERROR;
		// }
	...
	public String deleteHelpPersonnel() {
