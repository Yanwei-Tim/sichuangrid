...
public class ProductionMoveCompanyPlaceDatasTwoBuilder extends
		InitializationsRunner {
	private static Logger moveDataLog = LoggerFactory
			.getLogger(MoveCompanyPlaceDatasInitialization.class);

	public ProductionMoveCompanyPlaceDatasTwoBuilder() throws Exception {
	...
	public void builderTestEnv() throws Exception {
		...
		logger.error("产品环境初始化结束!");
		moveDataLog.error("产品环境初始化结束!");
		System.exit(0);
	}
