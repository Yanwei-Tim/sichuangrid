 ...
 */
@Namespace("/peaceVillageManage")
@Scope("request")
@Controller("peaceVillageController")
public class PeaceVillageController extends BaseAction {
	...
	private PeaceVillage peaceVillage;
	private SearchPeaceVillageVo searchPeaceVillageVo;
	private String ids;
	private Long id;
	private Long organizationId;
	private List<PeaceVillage> peaceVillageList;
	...
	public String getPeaceVillageListBySearchVo() {
	...
	public PeaceVillage getPeaceVillage() {
		return peaceVillage;
	}

	public void setPeaceVillage(PeaceVillage peaceVillage) {
		this.peaceVillage = peaceVillage;
	}

	public SearchPeaceVillageVo getSearchPeaceVillageVo() {
	...
	public List<PeaceVillage> getPeaceVillageList() {
		return peaceVillageList;
	}

	public void setPeaceVillageList(List<PeaceVillage> peaceVillageList) {
