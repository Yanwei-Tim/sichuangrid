...
<table width="200" class="tablelist">
	...
	<tr>
		...
		<td class="content"><span><@pop.PropertyDictViewTag name="@com.tianque.domain.property.PropertyTypes@FIRESAFETY_TYPE" defaultValue="${(location.type.id)!}"/></span></td>
  	...
  	<tr>
	    ...
	    <td colspan="4" class="content"><span>${(location.hiddenCases)!}</span></td>
  	</tr>
  	<tr>
