package com.tianque.plugin.dataManage.population.elderlyPeopleTemp.dataConverter;
...
@Component("elderlyPeopleTemp")
public class ElderlyPeopleTempDataConverter extends AbstractTempDataConverter<ElderlyPeopleTemp> {
	@Autowired
	...
	@Autowired
	@Resource(name = "elderlyPeopleTempValidator")
