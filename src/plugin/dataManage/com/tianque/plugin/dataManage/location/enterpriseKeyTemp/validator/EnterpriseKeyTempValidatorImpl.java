package com.tianque.plugin.dataManage.location.enterpriseKeyTemp.validator;
...
@Repository("enterpriseKeyTempValidator")
public class EnterpriseKeyTempValidatorImpl implements
		DomainValidatorTemp<EnterpriseKeyTemp> {
	@Autowired
	...
	@Override
	public ValidateResult validate(EnterpriseKeyTemp domain) {
