package com.tianque.plugin.dataManage.location.rentalHouseTemp.dataConverter;
...
@Component("rentalHouseTempDataConverter")
@Scope("prototype")
public class RentalHouseTempDataConverter extends
		AbstractTempDataConverter<RentalHouseTemp> {
	...
	@Autowired
	@Resource(name = "rentalHouseTempValidator")
	public void setValidator(DomainValidatorTemp validators) {
		super.setValidator(validators);
	}

	@Override
	public RentalHouseTemp persistenceDomain(RentalHouseTemp domain) {
		try {
