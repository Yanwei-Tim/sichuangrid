package com.tianque.plugin.dataManage.location.enterpriseDownKeyTemp.controller;
 ...
 * 数据管理 - 规下企业控制类。
 */
@Namespace("/plugin/dataManage/enterpriseDownKeyTempManage")
@Transactional
@Controller("enterpriseDownKeyTempController")
@Scope("request")
public class EnterpriseDownKeyTempController extends
		AbstractDataManageController<EnterpriseDownKeyTemp, Enterprise> {
	@Autowired
	private EnterpriseService enterpriseService;
	@Autowired
	@Qualifier("enterpriseDownKeyTempService")
	private AbstractDataManageService locationDataManageService;

	@Resource(name = "enterpriseDownKeyTempService")
	...
	public EnterpriseDownKeyTemp getTemp() {
		return temp;
	}

	public void setTemp(EnterpriseDownKeyTemp temp) {
		this.temp = temp;
	}

	public EnterpriseDownKeyTemp getLocation() {
		return population;
	}

	public EnterpriseDownKeyTemp getPopulation() {
		return population;
	}

	public void setLocation(EnterpriseDownKeyTemp Location) {
	...
	@Override
	public List getCompareList(EnterpriseDownKeyTemp temp, Enterprise target) {
