...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path}/aidsPopulations/aidspopulationsPersonColumnList.ftl">区域分布图</a></li>
			<li><a href="${path}/aidsPopulations/aidspopulationsCountList.ftl">列表信息</a></li>
			<li><a href="${path}/aidsPopulations/tendencyChartForAidspopulations.ftl?tableNameKey=
