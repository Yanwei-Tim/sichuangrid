...
import com.tianque.plugin.analysisNew.domain.StatisticsHousePopuComBaseInfoAddCountVo;
...
import com.tianque.plugin.analysisNew.service.PrimaryOrganizationsStatisticsNewService;
...
@Scope("prototype")
@Controller("leaderViewNewController")
public class LeaderViewNewController extends BaseAction {

	private static Logger logger = LoggerFactory
			.getLogger(LeaderViewNewController.class);
	...
	@Autowired
	private StatisticsPopulationNewService statisticsPopulationNewService;
	@Autowired
	private JobMonitorService jobMonitorService;
	@Autowired
	private PrimaryOrganizationsStatisticsNewService primaryOrganizationsStatisticsNewService;
	@Autowired
	...
	public String statisticsBaseInfoAddCountByOrgIdForArea() throws Exception {
		...
		List<StatisticsBaseInfoAddCountVo> datas = leaderViewNewService
	...
	public String statisticalBaseInfoMobile() throws Exception {
		...
		for (String item : list) {
			Map map = leaderViewNewService.personGeneralConditionForMobile(
					orgId, item);
	...
	class GetPopulationDatas implements Runnable {
		...
		@Override
		public void run() {
			populationDatas.addAll(leaderViewNewService
	...
	class GetHouseDatas implements Runnable {
		...
		@Override
		public void run() {
			houseDatas.addAll(leaderViewNewService.statisticsBaseInfo(orgId,
	...
	class GetComDatas implements Runnable {
		...
		@Override
		public void run() {
			comDatas.addAll(companyPlaceLeaderViewNewService
