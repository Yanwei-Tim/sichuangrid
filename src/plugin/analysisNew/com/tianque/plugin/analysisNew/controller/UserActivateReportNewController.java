 ...
 */
@Namespace("/userActivateReportManageNew")
@Controller("userActivateReportNewController")
@Scope("prototype")
public class UserActivateReportNewController extends BaseAction {
	...
	public String userActivateReportSort() throws Exception {
		if (!StringUtil.isStringAvaliable(sortName)) {
			listUserActivateReport = userActivateReportNewService
	...
	public String createUserActivateReportList() throws Exception {
		...
		userActivateReportNewService.createUserActivateReportList(year, month);
		return SUCCESS;
	}
