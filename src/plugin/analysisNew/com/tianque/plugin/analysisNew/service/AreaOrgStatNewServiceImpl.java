...
import com.tianque.plugin.analysisNew.dao.AreaOrgStatNewDao;
import com.tianque.plugin.analysisNew.domain.AreaOrgStatDataVo;
import com.tianque.sysadmin.service.OrganizationDubboService;
import com.tianque.sysadmin.service.PropertyDictService;

@Service("areaOrgStatNewService")
public class AreaOrgStatNewServiceImpl implements AreaOrgStatNewService {

	@Autowired
	private OrganizationDubboService organizationDubboService;
	@Autowired
	private AreaOrgStatNewDao areaOrgStatNewDao;
	@Autowired
	...
	public List<AreaOrgStatDataVo> getAreaOrgStatDateList(Long orgId) {
		...
		List<AreaOrgStatDataVo> resultList = new ArrayList<AreaOrgStatDataVo>();
		...
		for (Organization org : organizationsList) {
			...
			Map<String, Object> map = areaOrgStatNewDao.getAreaOrgStatDate(
