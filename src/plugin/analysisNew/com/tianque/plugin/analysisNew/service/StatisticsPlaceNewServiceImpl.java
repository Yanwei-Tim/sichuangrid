...
@Service("statisticsPlaceNewService")
public class StatisticsPlaceNewServiceImpl implements StatisticsPlaceNewService {
	...
	private int getImportantPlaceCountByTime(String orgInternalCode,
		...
		return statisticsBaseInfoNewDao.getCountFromHistory(map);
	}
