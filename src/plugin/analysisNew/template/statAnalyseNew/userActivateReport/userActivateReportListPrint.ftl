...
function userActivateReportGridPrint(){
	$.ajax({
		url:'/userActivateReportManageNew/userActivateReportSort.action?orgLevelDistance='+'<@s.property value="#parameters.orgLevelDistance"/>'+'&year='+'<@s.property value="#parameters.year"/>'+'&month='+'<@s.property value="#parameters.month"/>'+'&sortName='+'<@s.property value="#parameters.sortName"/>'+'&sort='+'<@s.property value="#parameters.sort"/>',
