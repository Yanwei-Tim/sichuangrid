...
function onOrgChanged(){
	...
	chartCount=$("#<@s.property value='#parameters.type'/>Column").columnChart({
		url: "${path}/baseInfo/statisticManageNew/getStatisticColumn.action?type=<@s.property value='#parameters.type'/>&orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val(),
