...
public class WeChatGroupServiceImpl extends AbstractBaseService implements WeChatGroupService {
	...
	public boolean saveWeChatGroup(TencentUser tencentUser) {
		...
		if (weChatGroupList == null) {
			...
			for (WeChatGroup group : weChatGroupList) {
				weChatGroupDao.updateWeChatGroupById(group);
			}
	...
	public void updateAllRelatedGroups(TencentUser tencentUser,Long groupId,String openId) {
		//修改本地分组(系统)
		if(tencentUser!=null&&tencentUser.getWeChatUserId()!=null&&openId!=null){
    ...
    */
	...
	public WeChatGroup getGroupListByNameAndWeChatUserId(String weChatUserId,String name) {
		...
		if(weChatUserId==null){
			throw new ServiceException("微信号为空!");
		}
		map.put("weChatUserId", weChatUserId);
		map.put("name", name);
		return weChatGroupDao.getGroupListByNameAndWeChatUserId(map);
	}
}
