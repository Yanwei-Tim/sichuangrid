...
public class Constants {
	...
	/**已接入*/
	public static final Long ACCESS = 3l;
	
	/**关键字消息*/
	public static final Long KEYWORDMSG = 1l;
	/**非关键字消息*/
	public static final Long NOT_KEYWORDMSG = 2l;
	
	/**未读消息*/
	public static final Long NOT_READ = 0l;
	/**已读消息*/
	...
	/**有效*/
	public static final Long AVAILABILITY = 1L;
	/**无效*/
	public static final Long INVALID = 2L;
	
	/**无新消息*/
	public static final Long NOT_NEWINBOX = 0L;
	/**有新消息*/
	public static final Long NEWINBOX = 1L;
