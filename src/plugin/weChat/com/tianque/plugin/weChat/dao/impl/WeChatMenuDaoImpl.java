...
public class WeChatMenuDaoImpl extends AbstractBaseDao implements WeChatMenuDao {
	...
	/**
	 * 根据weChatUserId查询所有菜单
	 * @param weChatUserId
	 * @return
	 */
	@Override
	public List<WeChatMenu> getWeChatMenuByWeChatUserId(String weChatUserId) {
		return (List<WeChatMenu>) getSqlMapClientTemplate().queryForList("chatMenu.getWeChatMenuByWeChatUserId", weChatUserId);
	}
	...
	public void deleteWeChatMenuById(Long id) {
		getSqlMapClientTemplate().delete("chatMenu.deleteWeChatMenuById", id);
	}
