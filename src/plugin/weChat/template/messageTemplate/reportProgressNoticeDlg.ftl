...
<div  class="container container_24">
	<form id="maintainForm" method="post" action="">
      <@pop.token />
	    <input type="hidden" name="templateType" value="<@s.property value='@com.tianque.plugin.weChat.constant.MessageTemplateConstant@REPORT_PROGRESS_NOTICE_VALUE'/>"><!-- 消息模板类型 -->
		...
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_4 lable-right">
			<em class="form-req">*</em><label>举报编号：</label>
		</div>	
		<div class="grid_20">
			<input type="text" name="messageTemplate.keywordOne"  maxlength="20"  class='form-txt {required:true,messages:{required:"请输入举报编号"}}'  />
		</div>		
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_4 lable-right">
		...
		<div class="grid_6">
			<input type="text" name="messageTemplate.keywordTow" maxlength="20" id="keywordTow_date_id" readonly  class='form-txt {required:true,messages:{required:"请选择办理时间"}}'  />
		</div>		
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_4 lable-right">
			<em class="form-req">*</em><label>办理进度：</label>
		</div>	
		<div class="grid_20">
			<input type="text" name="messageTemplate.keywordThree" maxlength="20"  class=' form-txt {required:true,messages:{required:"请输入办理进度"}}'  />
		</div>		
		<div class='clearLine'>&nbsp;</div>
		<div id="content">
			<div class="grid_4 lable-right">
			...
			<div class="grid_20 heightAuto">
		    	<textarea name="messageTemplate.remark"  maxlength="100"  style='height:70px;width: 97%'  class=' form-txt {}'></textarea>
			</div>
		</div>
		<div>
			<div class="grid_4 lable-right">
...
$("#keywordTow_date_id").datepicker("setDate",new Date());
//验证网址
