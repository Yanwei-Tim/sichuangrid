...
<div id="content" class="content myDivTop taskListContent">
	<div class="ui-corner-all" id="nav">
		<div class="areaSelect">
			<span class="taskTit">区域选择：</span><@s.include value="/common/orgSelectedComponent.jsp"/> 
		</div>
		...
		<div class="taskBtn">
			...
			<@s.if test="@com.tianque.core.util.ThreadVariable@getUser().getUserName().equals('admin')">
				<a href="javascript:;" style="margin-left:12px;top:-4px;" id="createTableByMonth" ><span class="taskTit">生成月度报表</span></a>
				<a href="javascript:;" style="margin-left:12px;top:-4px;" id="createTableByQuarter" ><span class="taskTit">生成季度报表</span></a>
				<a href="javascript:;" style="margin-left:12px;top:-4px;" id="createTableByYear" ><span class="taskTit">生成年度报表</span></a>
			</@s.if>
		</div>
		<!-- taskBtn -->
	</div>
	...
	<div class="zt_tabs_style">
		<div id="chartsTabs">
			<ul>
				<li id="chartsTabs1" class="taskTit"><a href="${path }/task/statistics/taskListAnalysisColumn.ftl">区域分布图</a></li>
				<li id="chartsTabs2" class="taskTit"><a href="${path }/task/statistics/taskListAnalysisPie.ftl">类型分布图</a></li>
				<li id="chartsTabs3" class="taskTit"><a href="${path }/task/statistics/taskListAnalysisTrend.ftl">趋势图</a></li>
				<#--<li id="chartsTabs4" class="taskTit"><a href="${path }/task/statistics/taskListAnalysisList.ftl">任务清单总况报表</a></li>-->
			</ul>
		</div>
	</div>
	<!--zt_tabs_style -->
