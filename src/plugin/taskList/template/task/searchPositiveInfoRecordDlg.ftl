...
<form id="searchPositiveInfoRecordForm" class="container container_24">
	...
	<div class="grid_7">
		<input type="text"  id="idCard"  name="positiveInfoRecordVo.idCard" class="form-txt" />
	</div>
	<div class="grid_5 lable-right">
		<label class="form-lb1>">电话号码：</label>
	</div>
	<div class="grid_7">
		<input type="text"  id="phone"  name="positiveInfoRecordVo.phone" class="form-txt" />
	</div>
   	<div class="grid_5 lable-right">
	...
	<div class="grid_5">
		<input type="text" id="helpPeople" name="positiveInfoRecordVo.helpPeople" class="form-txt" />
   	</div>
	<div class="grid_7 lable-right">
		<label class="form-lbl">有无异常：</label>
	</div>
	<div class="grid_5">
		<select name="positiveInfoRecordVo.hasException"  class="form-select" >
				<option value=""></option>
