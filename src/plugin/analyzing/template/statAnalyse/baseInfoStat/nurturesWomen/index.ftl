...
<div class="zt_tabs_style">
	<div id="chartsTabs">
	<ul>
		<li><a href="${path }/statAnalyse/baseInfoStat/nurturesWomen/statisticNurturesWomenColumn.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@NURTURES_WOMEN"/>">区域分布图</a></li>
		<li><a href="${path }/statAnalyse/baseInfoStat/nurturesWomen/statisticNurturesWomenList.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@NURTURES_WOMEN"/>">列表信息</a></li>
