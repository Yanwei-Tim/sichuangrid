...
function getUserActivateReportList(orgLevelDistance){
	var url = "/userActivateReportManage/getUserActivateReportList.action?year="+$("#year").val()+"&month="+$("#month").val();
...
$(document).ready(function(){
	...
	var columns = [
		...
		sortName = name;
		sortColumn=sort;
		var url = "/userActivateReportManage/userActivateReportSort.action?year="+$("#year").val()+"&month="+$("#month").val()+"&sortName="+name+"&sort="+sort+"&orgLevelDistance="+$("#type").val();
		$.ajax({
			url:url,
			success:function(data){
				if(data == null){
	...
	var nowMonth=nowDate.getMonth()+1;
		...
		$.ajax({
			url:"${path}/userActivateReportManage/createUserActivateReportList.action?year="+$("#year").val()+"&month="+$("#month").val(),
...
$(".print").click(function(){
		var url = "${path}/statAnalyse/userActivateReport/userActivateReportListPrint.ftl?year="+$("#year").val()+"&month="+$("#month").val()+"&sortName="+sortName+"&sort="+sortColumn+"&orgLevelDistance="+$("#type").val();
