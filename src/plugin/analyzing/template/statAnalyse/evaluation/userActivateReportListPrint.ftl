...
<script>
	var useractivatereportsort_url = '/userActivateReportManage/userActivateReportSort.action?orgLevelDistance=';
...
function userActivateReportGridPrint(){
	$.ajax({
		url:useractivatereportsort_url+'<@s.property value="#parameters.orgLevelDistance"/>'+'&year='+'<@s.property value="#parameters.year"/>'+'&month='+'<@s.property value="#parameters.month"/>'+'&sortName='+'<@s.property value="#parameters.sortName"/>'+'&sort='+'<@s.property value="#parameters.sort"/>',
