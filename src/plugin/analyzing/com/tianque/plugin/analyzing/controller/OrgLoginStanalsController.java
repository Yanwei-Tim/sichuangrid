...
import com.tianque.controller.statanalysethread.StatAnalyseOrgLoginThread;
...
@Controller("orgLoginStanalsController")
@Scope("prototype")
public class OrgLoginStanalsController extends BaseAction {
	@Autowired
	...
	public String findOrgLoginStanalsByOrgIdForListPage() throws Exception {
		...
		orgLoginStanalsList = orgLoginStanalsService.getOrgLoginStanalsForList(
	...
	public String downloadOrgLoginStanals() throws Exception {
		if (orgId == null) {
			...
			records = orgLoginStanalsService.getOrgLoginStanalsForList(nowYear,
					nowMonth, orgId, internalId);
	...
	public void reProduceDate() throws Exception {
		try {
			if (orgId != null) {
				...
				StatAnalyseOrgLoginThread statAnalyseThread = new StatAnalyseOrgLoginThread(
						ThreadVariable.getSession(), orgLoginStanalsService,
