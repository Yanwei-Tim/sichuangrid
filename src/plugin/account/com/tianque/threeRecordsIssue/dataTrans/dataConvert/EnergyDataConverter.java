 ...
 *
 */
@Component("energyDataConverter")
@Scope("prototype")
public class EnergyDataConverter extends ThreeAbstractDataConverter<Energy> {

	@Autowired
	private PeopleAspirationDubboService peopleAspirationDubboService;

	@Override
	public ValidateResult validate(Energy domain, int realRow) {
		return null;
	}

	@Override
	public Energy persistenceDomain(Energy domain) {
		...
		return peopleAspirationDubboService.addEnergy(domain);
	}

	@Override
	public Energy updateDomain(Energy domain) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Energy convertToDomain(String[] cellValues, ValidateResult result) {
		// TODO Auto-generated method stub
		return null;
	}
