 ...
 *
 */
@Component("otherDataConverter")
@Scope("prototype")
public class OtherConverter extends ThreeAbstractDataConverter<Other> {

	@Autowired
	private PeopleAspirationDubboService ledgerPeopleAspirationsService;

	@Override
	public ValidateResult validate(Other domain, int realRow) {
		return null;
	}

	@Override
	public Other persistenceDomain(Other domain) {
		...
		return ledgerPeopleAspirationsService.addOther(domain);
	}

	@Override
	public Other updateDomain(Other domain) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Other convertToDomain(String[] cellValues, ValidateResult result) {
		// TODO Auto-generated method stub
		return null;
	}
