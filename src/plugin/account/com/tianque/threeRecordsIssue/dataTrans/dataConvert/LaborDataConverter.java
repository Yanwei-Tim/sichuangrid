 ...
 *
 */
@Component("laborDataConverter")
@Scope("prototype")
public class LaborDataConverter extends ThreeAbstractDataConverter<Labor> {

	@Autowired
	private PeopleAspirationDubboService ledgerPeopleAspirationsService;

	@Override
	public ValidateResult validate(Labor domain, int realRow) {
		return null;
	}

	@Override
	public Labor persistenceDomain(Labor domain) {
		...
		return ledgerPeopleAspirationsService.addLabor(domain);
	}

	@Override
	public Labor updateDomain(Labor domain) {
		// TODO Auto-generated method stub
		return null;
	}

	@Override
	public Labor convertToDomain(String[] cellValues, ValidateResult result) {
		// TODO Auto-generated method stub
		return null;
	}
