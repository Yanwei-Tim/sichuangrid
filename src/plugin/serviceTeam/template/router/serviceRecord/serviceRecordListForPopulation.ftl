...
$(document).ready(function(){
	...
	$("#serviceRecordList").jqGridFunction({
		...
		colModel:[
		    ...
		    {name:'occurDate',index:"occurDate",label:'服务时间',sortable:true,width:80,align:"center"},
		    {name:'createDate',index:"createDate",label:'记录新增时间',sortable:true,width:120,align:"center"},
		    {name:'occurPlace',index:"occurPlace",label:'服务地点',sortable:true,width:150},
		    {name:'serviceJoiners',index:'serviceJoiners',label:'服务参与人',sortable:false,width:80,align:"center"},
		    {name:'serviceMembers',label:'记录所属人',sortable:false,width:80,align:"center"},
		    <#--{name:'teamName',label:'所属服务团队',sortable:false, width:150,align:"center"},-->
