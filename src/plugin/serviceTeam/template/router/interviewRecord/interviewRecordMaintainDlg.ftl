...
<div class="container container_24">
	...
	<div class="grid_15 ">
		<input type="text" name="druggyTask.place" maxlength="50" id="place" value="${(druggyTask.place)!}" style="width:99%"  class="form-txt {required:true,exculdeParticalChar:true,messages:{required:'地点不能为空',exculdeParticalChar:'不能输入非法字符'}}"/>
	</div>
	<div class='clearLine'>&nbsp;</div>
