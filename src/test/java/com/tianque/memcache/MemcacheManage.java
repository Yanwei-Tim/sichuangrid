...
public class MemcacheManage {
	...
	public MemcacheManage() {
		String[] serversList = { "localhost:11211" };
	...
	public static void main(String[] args) {
		MemcacheManage manage = new MemcacheManage();
		manage.storeCounter("test", 0);
		manage.storeCounter("test", 1);
		// System.out.println(manage.get("7_Druggy_counterTimeOut"));
		// System.out.println(manage.getCounter("7_Druggy"));
	}
}
