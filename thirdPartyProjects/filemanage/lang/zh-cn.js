...
CKFinder.lang['zh-cn'] =
{
	...
	BasketClear			: '清空文件篮',
	BasketRemove		: '从文件篮移除',
	BasketOpenFolder	: '打开文件篮',
	BasketTruncateConfirm : '确认清空文件篮?',
	BasketRemoveConfirm	: '确认从文件篮中移除文件 "%1" ？',
	BasketEmpty			: '文件篮为空, 可拖放文件至其中.',
	BasketCopyFilesHere	: '从文件篮复制至此',
	BasketMoveFilesHere	: '从文件篮移动至此',
