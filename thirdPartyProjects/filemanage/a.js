(function () {
    ...
    i.extend(h.bi.prototype, {
        ...
        vv: function (k) {
            ...
            } while (l = l.getParent()) return null;
        },
        gz: function (k) {
            var l = this.$,
                m = k.$;
            ...
            bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        var w = t.selectSingleNode(u + "\100\x70\x6c\165\147\151\x6e\x73"),
                            x = w && w.value;
    ...
    (function () {
        ...
        var s = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            t = ['Node', "\155\145\x73\163\141\147\x65"];

        function u(E) {
            var F = t.reverse().join(''),
                G = E.tools.of(),
                H = G['se' + "\164\110\x74\155\x6c"];
            H.call(G, E.qX());
            ...
            bz: function tC(E) {
                ...
                E.on('uiReady', function tu(H) {
                        ...
                        exec: function (L) {
                            ...
                            if (M) {
                                var N = window.screen.width * 0.8,
                                    ...
                                    P = 'menubar=no,location=no,status=no,toolbar=no,scrollbars=yes,jy=yes';
                                P += ',width=' + N;
                                P += ',height=' + O;
                    ...
                    E.bD('DownloadFile', {
                        exec: function (L) {
                            var M = J.data().cG;
                            if (M) if (L.config.directDownload) window.location = M.folder.getUrl() + M.name + '?download';
                            else window.location = L.connector.composeUrl('DownloadFile', {
                                FileName: M.name
    ...
    n.button.prototype = {
        ...
        er: function (p, q) {
            ...
            if (p.cg.inPopup && !p.cg.inUrlPopup) q.push(' onkeydown="window.parent.opener.CKFinder._.uiButtonKeydown(', v, ', event);" onfocus="window.parent.opener.CKFinder._.uiButtonFocus(', v, ', event);" onclick="window.parent.opener.CKFinder._.callFunction(', u, ', this); return false;">');
            else q.push(' onkeydown="window.parent.CKFinder._.uiButtonKeydown(', v, ', event);" onfocus="window.parent.CKFinder._.uiButtonFocus(', v, ', event);" onclick="window.parent.CKFinder._.callFunction(', u, ', this); return false;">');
        ...
        m.add('container', {
            ...
            pV: function (p) {
                ...
                var u = p.config.className ? 'class="' + p.config.className + '"' : '',
                    ...
                    x = k.et('<iframe style="' + s + 'height:' + q + '"' + u + ' frameBorder="0"' + ' src="' + (g ? 'javascript:void(function(){' + encodeURIComponent(w) + '}())' : '') + '"' + ' tabIndex="' + r + '"' + ' allowTransparency="true"' + '></iframe>', p.ax.getDocument());
                        ...
                        w.oW('beforeDroppable', B, function jS(D, E) {
                            ...
                            try {
                                ...
                                var H = new a.iD(w.app, 'copyFileToFolder', {
                                    ...
                                    I = window.top[a.hf + "\143\x61\x74\151\157\x6e"][a.hg + "\x73\164"],
        ...
        function q(w) {
            ...
            if (z.getName() == 'input') i.setTimeout(function () {
                var D = this.app.aG['filesview.filesview'][0],
                    E = D.data();
                if (A == 'sortby') E.cN = B;
                else if (A == 'view_type') E.dA = B;
                else if (A == 'display_filename') E.display.filename = !!C;
        ...
        m.add('basket', {
            ...
            bz: function tG(r) {
                ...
                r.bD('FolderPasteMoveBasket', {
                    exec: function (v) {
                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && s.toLowerCase().replace(a.jG, '') != a.ed.replace(a.jG, '') || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1));
                        else {
                            var w = v.aV;
                            if (!w) return;
    ...
    (function () {
        ...
        function A(P) {
            ...
            function au(aP) {
                ...
                else if (am.search('t') != -1 && aa.fi - aa.y < S + aT) gR = aa.fi - S;
                else gR = aa.y;
                if (aa.eS - U[1] > gs.width - aT) pw = gs.width + U[1];
                else if (am.search('r') != -1 && aa.eS - aa.x < R + aT) pw = aa.x + R;
                else pw = aa.eS;
                if (aa.fi - U[2] > gs.height - aT) aq = gs.height + U[2];
                else if (am.search('b') != -1 && aa.fi - aa.y < S + aT) aq = aa.y + S;
                else aq = aa.fi;
                P.move(gP, gR);
