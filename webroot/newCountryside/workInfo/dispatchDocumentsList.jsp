...
<div class="ui-corner-all" id="nav" >
	<div class="btnbanner btnbannerData">
		...
		<pop:JugePermissionTag ename="searchWorkInfo">
		<a id="search" href="javascript:void(0)"><span>高级搜索</span></a>
		</pop:JugePermissionTag>
		<span class="lineBetween"></span>
		<pop:JugePermissionTag ename="addWorkInfo">
		<a id="add" href="javascript:void(0)" ><span>写发文</span></a>
		</pop:JugePermissionTag>
		<pop:JugePermissionTag ename="sendWorkInfo">
		<a id="send" href="javascript:void(0)"><span>发文</span></a>
		</pop:JugePermissionTag>
		<pop:JugePermissionTag ename="deleteWorkInfo">
...
$(document).ready(function(){
	$("#dispatchDocumentsList").jqGridFunction({
		...
		multiselect:true,
		<pop:JugePermissionTag ename="viewWorkInfo">
	...
	function titleFont(el,options,rowData){
		return "<pop:JugePermissionTag ename='viewWorkInfo'><a href='javascript:viewDialog("+rowData.id+")'></pop:JugePermissionTag>"+rowData.title+"<pop:JugePermissionTag ename='viewWorkInfo'></a></pop:JugePermissionTag>";
	}
	function operateFormatter(el, options, rowData){
		return "<pop:JugePermissionTag ename='updateWorkInfo'><a href='javascript:;' onclick='updateDispatch(event,"+rowData.id+");'><span>修改</span></a> | </pop:JugePermissionTag><pop:JugePermissionTag ename='deleteWorkInfo'><a href='javascript:;' onclick='deleteDispatch(event,"+rowData.id+");'><span>删除</span></a></pop:JugePermissionTag>";
	}
