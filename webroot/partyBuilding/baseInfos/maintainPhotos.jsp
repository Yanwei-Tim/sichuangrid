...
<pop:token />
	...
	<input type="hidden" name="caseImageUpload.baseInfoType" value="<s:property value="#parameters.baseInfoType"/>"/>
	<c:choose>
	    ...
	    <c:otherwise>
	    	<input type="hidden" name="caseImageUpload.organization.id" value="${basicCase.organization.id }" />
	    </c:otherwise>
	</c:choose>
