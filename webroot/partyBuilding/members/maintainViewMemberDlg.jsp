...
<table width="200" class="tablelist">
  ...
  <tr>
    ...
    <td class="content" colspan="3" ><span><fmt:formatDate value="${steadyWork.registrationTime}" type="date" pattern="yyyy-MM-dd HH:mm:ss" /></span></td>
  </tr>
  <s:iterator value="steadyWork.peopleInfos" var="peopleInfo">
  		 <tr>
		  	<td class="title"><label>姓名</label></td>
		    <td class="content"><span><s:property value="#peopleInfo.name"/> </span></td>
		    <td class="title"><label>常住地址</label></td>
		   <td class="content" colspan="3"><span><s:property value="#peopleInfo.permanentAddress"/></span></td>
		  </tr>
		  <tr>
		    <td class="title"><label>身份证号</label></td>
		    <td class="content"><span><s:property value="#peopleInfo.idCardNo"/></span></td>
		    <td class="title"><label>出生年月</label></td>
		    <td class="content" colspan="3" ><span><fmt:formatDate value="${birthDay}" type="date" pattern="yyyy-MM-dd" /></span></td>
		  </tr>
		  <tr>
		    ...
		    <td class="content" colspan="3" ><span><s:property value="#peopleInfo.mobileNumber"/></span></td>
		  </tr>
		
		  <tr>
		    <td class="title"><label>是否党员</label></td>
		    <td class="content"><span><c:choose><c:when test='${peopleInfo.isPartyMember}'>是</c:when><c:otherwise>否</c:otherwise></c:choose></span></td>
