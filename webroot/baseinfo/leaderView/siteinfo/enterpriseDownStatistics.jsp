...
var title = "规下企业";	
		jQuery(document).ready(function() {		
			...
			$("#searchHighA").click(function(){
				$("#statisticsDialog").createDialog({
					...
					modal:true,
					url: '${path}/baseinfo/siteinfo/enterprise/searchEnterpriseCondition.jsp?keyType='+"enterpriseDownKey",
					buttons: {
						"查询" : function(event){
		...
		function getDialogParam(isSearch){
			return {
				...
				title: title+'信息',
				modal:true,
				url: '${path}/baseinfo/siteinfo/enterprise/enterpriseListForStatistics.jsp?isSearch='+isSearch+'&keyType='+"enterpriseDownKey",
				buttons: {
			   		"关闭" : function(){
			        	$(this).dialog("close");
			   		}
