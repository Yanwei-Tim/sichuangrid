...
var title = "消防安全重点";
		jQuery(document).ready(function() {		
			...
			$("#searchHighA").click(function(){
				$("#statisticsDialog").createDialog({
					...
					modal:true,
					url: '${path}/baseinfo/siteinfo/fireSafety/searchFireSafetyEnterpriseCondition.jsp?keyType='+"fireSafetyKey",
					buttons: {
						"查询" : function(event){
		...
		function getDialogParam(isSearch){
			return {
				...
				title: title+'信息',
				modal:true,
				url: '${path}/baseinfo/siteinfo/fireSafety/fireSafetyEnterpriseListForStatistics.jsp?isSearch='+isSearch+'&keyType='+"fireSafetyKey",
				buttons: {
			   		"关闭" : function(){
			        	$(this).dialog("close");
			   		}
