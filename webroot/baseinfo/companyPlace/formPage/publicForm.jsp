...
<!-- 寄递物流点 -->
<div id="jiDiLogisticsFormDiv" >
	<div class="grid_4 lable-right">
		<em class="form-req">*</em>
		<label class="form-lb1">经营品牌：</label>
	</div>
	<div class="grid_8">
		<select class="form-txt {required:true,messages:{required:'请选择经营品牌'}}" name="companyPlace.operatingBrand.id">
			<pop:OptionTag name="@com.tianque.domain.property.PropertyTypes@OPERATING_BRAND" defaultValue="${companyPlace.operatingBrand.id}"></pop:OptionTag>
		</select>
	</div>
	<div class="grid_4 lable-right">
		<em class="form-req">*</em>
		<label class="form-lb1">经营方式：</label>
	</div>
	<div class="grid_8">
		<select class="form-txt {required:true,messages:{required:'请选择经营方式'}}" name="companyPlace.operatingMode.id">
			<pop:OptionTag name="@com.tianque.domain.property.PropertyTypes@OPERATING_MODE" defaultValue="${companyPlace.operatingMode.id}"></pop:OptionTag>
		</select>
	</div>
	<div class='clearLine'>&nbsp;</div>
	...
	<div class="grid_8">
		<input type="text" name="companyPlace.userName" id="" maxlength="15" style="width: 99%" value='${companyPlace.userName }' class="form-txt {required:true,isLawful:true,exculdeParticalChar:true,minlength:2,maxlength:20, messages:{required:'请输入负责人',isLawful:'您输入了非法脚本，请重新输入！',exculdeParticalChar:'不能输入非法字符',minlength:$.format('负责人至少需要输入{0}个字符'),maxlength:$.format('负责人最多需要输入{0}个字符')}}" />
	</div>
	<div class="grid_4 lable-right">
		<em class="form-req">*</em>
	...
	<div class="grid_8">
<%-- 		<input type="text" name="companyPlace.mobileNumber" id="" maxlength="11" style="width: 99%" value='${companyPlace.mobileNumber }' class="form-txt {mobile:true,messages:{mobile:'手机号码输入只能是以1开头的11位数字'}}" title="请输入11位以1开头的联系手机  例如：13988888888" /> --%>
		<input type="text" name="companyPlace.telePhone" id="telePhone"  maxlength="13"  value="${companyPlace.telePhone}"  
				class='form-txt isAnonymity {required:true,phoneAndMobile:true,messages:{required:"请输入联系电话",phoneAndMobile:$.format("请输入以固定电话：028-87653333或者手机：15102888888为格式的号码")}}' />
	</div>
	<div class='clearLine'>&nbsp;</div>
</div>
</div>