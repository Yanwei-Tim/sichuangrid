...
<%@ include file="/includes/baseInclude.jsp" %>
    <div id="floatingPopulation" class="container container_24">
		...
		<div class="grid_7">
   			<input type="text" name="population.certificateNumber" id="certificateNumber" maxlength="30"  value='${population.certificateNumber }'class="form-txt" />
   		</div>
   		<div class='clearLine'>&nbsp;</div>
   		<div  class="grid_4 lable-right">
		...
		<div class="grid_7">
   			...
   			class="form-txt {registerDate:true,messages:{registerDate:'登记日期小于流入时间'}}" />
   		</div>
		<div  class="grid_4 lable-right">
		...
		<div class="grid_7">
   			...
   			class="form-txt {expectedDatedue:true,expectedDatedue1:true,messages:{expectedDatedue:'预计到期日期不能小于登记日期',expectedDatedue1:'预计到期日期不能小于流入时间'}}"" />
   		</div>
   		<div class='clearLine'>&nbsp;</div>
   		<div  class="grid_4 lable-right">
		...
		<div class="grid_7">
			<select name="population.stayLocationType.id" id="stayLocationType" class="form-txt" >
		...
		<div  class="grid_7 lable-right">
			<input type="checkbox" name="population.hasMarriedProve" value="true" <s:if test="population.hasMarriedProve">checked</s:if>/>是否有婚育证明
		</div>
		<div class='clearLine'>&nbsp;</div>
   </div>
