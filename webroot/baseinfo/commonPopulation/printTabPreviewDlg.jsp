...
<style type="text/css">
		*{
		...
		.mod_print .b .tablelist td,
		.mod_print .b .tablelist th{
			padding:0.3em 0.5em;
			border:1px solid #333;
		}
		.mod_print .b #pListPager td{
			padding:0em 0em;
...
$(document).ready(function(){
	 var titleDivs='<h1>'+printTitleStr+'&nbsp;&nbsp;</h1>'; 
	 if($('input:checkbox:checked[name="printOptions"]').length>0){//tab页加载
	 ...
	 }else if(printLoadUrlStr!=''){//无tab页加载
	 	//titleDivs+='<div class="printtitle" id="printReusltName0">'+title+'</div><div class="b" id="printReuslt0"></div><br/>';
	 	titleDivs+='<div class="b" id="printReuslt0"></div><br/>';
	 	$("#printArea").html(titleDivs);
	 	$("#printReuslt0").load(printLoadUrlStr);
        //$("#printReusltName0").css("display","block");
	 }
});
