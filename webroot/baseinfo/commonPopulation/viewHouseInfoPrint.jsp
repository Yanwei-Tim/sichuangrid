...
<table width="200" class="tablelist">
  ...
  <tr>
    <td class="title"><label>房屋地址</label></td>
    <td class="content"><span>${houseInfo.address}</span></td>
    <td class="title"><label>现居住人数</label></td>
    <td class="content" colspan="2"><span>${houseInfo.personNum}</span></td>
  </tr>
  <tr>
  ...
  <s:if test='true==houseInfo.isRentalHouse'>
	<tr>
