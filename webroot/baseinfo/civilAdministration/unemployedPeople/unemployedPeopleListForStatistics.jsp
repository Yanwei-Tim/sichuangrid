...
function operateFormatter(el,options,rowData){
	return "<pop:JugePermissionTag ename='viewUnemployedPeople'> <a href='javascript:;' onclick='viewDialog(event,"+rowData.id+");'><U><font color='#6633FF'>查看</font></U></a></pop:JugePermissionTag>";
}
var gridOption = {
	colModel:[
		...
		{name:"currentAddress",label:"常住地址", width:200},
		{name:"unemploymentReason", label:"失业原因",sortable:false,formatter:unemploymentReasonFormatter, width:100},
		{name:"unemploymentDate",label:"失业时间", width:100},
		...
		{name:"upEnterWorkDate", label:"参加工作时间",sortable:false, width:100,hidden:true},
		{name:"originalWorkUnit", label:"原工作单位名称",width:120,sortable:false,hidden:true},
		{name:"originalWorkUnitType", label:"原单位类型", width:200,sortable:false,hidden:true},
