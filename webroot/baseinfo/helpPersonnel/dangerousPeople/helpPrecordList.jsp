...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#helpPrecordList").jqGridFunction({
			...
			colModel:[
				...
				{name:"helpPersonnelName", sortable:false, label: '走访人员',width:200},
			...
			ondblClickRow: viewdangerousPeopleHelpPre,
		...
		$("#addHelpPrecord").click(function(){
			...
			$("#helpPrecordDialog").createDialog({
				...
				height: 400,
				title:'新增走访情况',																										
				url:'${path}/baseinfo/helpPrecord/dispatch.action?personnelId='+domainId+'&personnelType=<s:property value="#parameters.dangerousPersonKeyType"/>&mode=add&precordType=dangerousPeopleHelp',
				buttons: {
					"保存" : function(event){
		...
		$("#updateHelpPrecord").click(function(){
			...
			$("#helpPrecordDialog").createDialog({
				...
				height: 400,
				title:'修改走访情况',
				url:'${path}/baseinfo/helpPrecord/dispatch.action?helpPrecord.id='+selectedId+'&mode=edit&precordType=dangerousPeopleHelp',
				buttons: {
					"保存" : function(event){
				      $("#helpPrecordForm").submit();
				   },
	...
	function viewdangerousPeopleHelpPre(){
		var selectedId = $("#helpPrecordList").getGridParam("selrow");
		if(selectedId==null){
		  return;
		}
		$("#helpPrecordDialog").createDialog({
			...
			height: 400,
			title:'查看走访情况',
			url:'${path}/baseinfo/helpPrecord/dispatch.action?helpPrecord.id='+selectedId+'&mode=view&precordType=dangerousPeopleHelp',
			buttons: {
			   "关闭" : function(){
			        $(this).dialog("close");
			   }
