...
<div id="dialog-form" title="" class="container container_24">
	...
	<pop:token />
		...
		<div class="grid_15" id="selectPerson" style="line-height:20px;">
			<input type="text" name="floorperson.personInChargeName" id="personName" class="form-txt" width=228px>
		</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#placeTypeNames").val($("#lettingHouseTypeName").val());
		$("#placeName").val($("#lettingHouseAddr").val());
