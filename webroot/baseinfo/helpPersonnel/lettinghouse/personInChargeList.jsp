...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#personInChargeList").jqGridFunction({
			...
			ondblClickRow: viewlettinghouseHelpPre,
			...
			$.confirm({
				...
				$.ajax({
					...
					success:function(responseData){
						$("#personInChargeList").setRowData(responseData.trId,responseData);
	...
	function viewlettinghouseHelpPre(){
		var selectedId = $("#personInChargeList").getGridParam("selrow");
		if(selectedId==null){
		  return;
		}
