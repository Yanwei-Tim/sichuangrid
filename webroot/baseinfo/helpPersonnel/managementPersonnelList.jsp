...
<div class="content">
	<div class="ui-cornRr-all" id="nav">
			<a id="addHelp" href="javascript:void(0)" ><span>新增</span></a>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#helpPersonnelList").jqGridFunction({
			...
			colModel:[
				...
				{name:"name", sortable:false, index:"name", label: '管理服务人员姓名'},
				{name:"identity", sortable:false, label: '管理服务人员身份'},
			...
			ondblClickRow: viewHelpPersonnel,
		...
		$("#addHelp").click(function(){
			...
			$("#helpPersonnelDialog").createDialog({
				...
				height: 250,
				title:'新增管理服务人员信息',
				url:'${path}/baseinfo/helpPersonnel/dispatch.action?personnelId='+domainId+'&personnelType=<s:property value="#parameters.keyType"/>&mode=add&personType=management',
				buttons: {
					"保存" : function(event){
		...
		$("#updateHelp").click(function(){
			...
			$("#helpPersonnelDialog").createDialog({
				...
				height: 250,
				title:'修改管理服务人员信息',
				url:'${path}/baseinfo/helpPersonnel/dispatch.action?helpPersonnel.id='+id[0]+'&mode=edit&personType=management',
				buttons: {
					"保存" : function(event){
				      $("#helpPersonnelForm").submit();
				   },
		...
		$("#logoutHelp").click(function(){
			...
			$.confirm({
				title:"确认注销",
				message:"该管理服务人员信息注销后，将无法恢复,您确认注销该人员信息吗?",
				width: 300,
				okFunc: function(){
				$.ajax({
	...
	function viewHelpPersonnel(){
		...
		$("#helpPersonnelDialog").createDialog({
			...
			height: 250,
			title:'查看管理服务人员信息',
			url:'${path}/baseinfo/helpPersonnel/dispatch.action?helpPersonnel.id='+id[0]+'&mode=view&personType=management',
			buttons: {
			   "关闭" : function(){
			        $(this).dialog("close");
			   }
