...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		if(isHelpPersonnel()){
			$("#poorPeopleHelpPrecord").show();
		}else{
			$("#poorPeopleHelpPrecord").hide();
		}
		$("#helpPersonnelList").jqGridFunction({
			...
			ondblClickRow: viewpoorPeopleHelp,
		...
		$("#addHelp").click(function(){
			...
			$("#helpPersonnelDialog").createDialog({
				...
				height: 250,
				title:'新增综治人员信息',
				url:'${path}/baseinfo/helpPersonnel/dispatch.action?personnelId='+domainId+'&personnelType=<s:property value="#parameters.poorPeopleKeyType"/>&mode=add&personType=poorpopleHelp',
				buttons: {
					"保存" : function(event){
		...
		$("#updateHelp").click(function(){
			...
			$("#helpPersonnelDialog").createDialog({
				...
				height: 250,
				title:'修改综治人员信息',
				url:'${path}/baseinfo/helpPersonnel/dispatch.action?helpPersonnel.id='+id[0]+'&mode=edit&personType=poorpopleHelp',
				buttons: {
					"保存" : function(event){
				      $("#helpPersonnelForm").submit();
				   },
	...
	function viewpoorPeopleHelp(){
		...
		$("#helpPersonnelDialog").createDialog({
			...
			height: 250,
			title:'查看综治人员信息',
			url:'${path}/baseinfo/helpPersonnel/dispatch.action?helpPersonnel.id='+id[0]+'&mode=view&personType=poorpopleHelp',
			buttons: {
			   "关闭" : function(){
			        $(this).dialog("close");
			   }
	...
	function isHelpPersonnel(){
		...
		$.ajax({
			...
			data:{
				...
				"personnelType":$("#poorPeopleKeyType").val()
			},
			success:function(responseData){
