...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		$("#helpPrecordList").jqGridFunction({
			...
			ondblClickRow: viewsuperiorHelpPre,
		...
		$("#addHelpPrecord").click(function(){
			...
			$("#helpPrecordDialog").createDialog({
				...
				height: 400,
				title:'新增走访情况',
				url:'${path}/baseinfo/helpPrecord/dispatch.action?personnelId='+domainId+'&personnelType=<s:property value="#parameters.superiorKeyType"/>&mode=add&precordType=superiorHelp',
				buttons: {
					"保存" : function(event){
		...
		$("#updateHelpPrecord").click(function(){
			...
			$("#helpPrecordDialog").createDialog({
				...
				height: 400,
				title:'修改走访情况',
				url:'${path}/baseinfo/helpPrecord/dispatch.action?helpPrecord.id='+selectedId+'&mode=edit&precordType=superiorHelp',
				buttons: {
					"保存" : function(event){
				      $("#helpPrecordForm").submit();
				   },
	...
	function viewsuperiorHelpPre(){
		...
		$("#helpPrecordDialog").createDialog({
			...
			height: 400,
			title:'查看走访情况',
			url:'${path}/baseinfo/helpPrecord/dispatch.action?helpPrecord.id='+selectedId+'&mode=view&precordType=superiorHelp',
			buttons: {
			   "关闭" : function(){
			        $(this).dialog("close");
			   }
