...
<table width="200" class="tablelist">
  <tr>
    ...
    <s:if test='null!=population.imgUrl && !"".equals(population.imgUrl)'>
		<img id="druggyPopuOfImg" name="population.imgUrl" src="" width="148px"/>
	</s:if>
	<s:else>
  ...
  <tr>
   ...
   <tr>
	 ...
	 <td class="content"    >${population.qbusinessRemark }</td>
  </tr>
...
$(document).ready(function(){
	...
	if(null!=$("#_imgUrl").val() && $("#_imgUrl").val()!=""){//添加随机数保证IE下的图片查看没问题
		$("#druggyPopuOfImg").attr("src",$("#_imgUrl").val()+"?r="+Math.random());
	}
});
