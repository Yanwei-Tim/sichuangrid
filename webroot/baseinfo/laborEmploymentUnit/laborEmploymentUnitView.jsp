...
<table width="200" class="tablelist">
  <tr>
	...
	<s:else>
		<img id="img" name="location.imgUrl" src="${path }/resource/images/head.png" width="148px"/>
	</s:else></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="content"><span>${location.post}</span></td>
    <td class="title"><label>联系方式</label></td>
   <td class="content"><span>${location.postTelephone}</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="content"><span>${location.registeredCapital }</span></td>
    <td class="title"><label>经济性质</label></td>
    <td class="content" colspan="4"><span>
    <pop:PropertyDictViewTag name="@com.tianque.domain.property.PropertyTypes@ACTUALCOMPANY_ECONOMICNATURE" defaultValue="${location.economicNature.id}" />
    </span></td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="title"><label>劳资负责人 </label></td>
    <td class="content"><span>${location.principal }</span></td>
    <td class="title"><label>联系方式</label></td>
    <td class="content" colspan="2"><span>${location.principalTelephone }</span></td>
  </tr>
  <tr>
    <td class="title"><label>社会保险登记号 </label></td>
    <td class="content"><span>${location.insureNumber }</span></td>
  ...
  <tr>
	 ...
	 <td class="content"><span id="">
	 <pop:PropertyDictViewTag name="@com.tianque.domain.property.PropertyTypes@ACTUALCOMPANY_SUPERVISORYLEVEL" defaultValue="${location.supervisoryLevel.id}" />
	</span></td>
  ...
  <tr>		
	 ...
	 <td class="content"><span id="">
	  <pop:PropertyDictViewTag name="@com.tianque.domain.property.PropertyTypes@ACTUALCOMPANY_FIREFIGHTINGLEVEL" defaultValue="${location.fireFightingLevel.id}" />
</span></td>	
