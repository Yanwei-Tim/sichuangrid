...
<div id="unsettledPopulationListDiv">
<div style="width: 100%;">
...
$(document).ready(function(){
	...
	function operateFormatter(el, options, rowData){
		return " <pop:JugePermissionTag ename="viewUnsettledPopulation"><a href='javascript:viewUnsettledPopulation("+rowData.id+")'><U><font color='#6633FF'>查看</font></U></a></pop:JugePermissionTag>";
	}
	...
	$("#unsettledPopulationList").jqGridFunction({
		...
		<pop:JugePermissionTag ename="viewUnsettledPopulation">
		     ondblClickRow:viewUnsettledPopulation,
...
function viewUnsettledPopulation(rowid){
	if(rowid==null){
			return;
	}
	var unsettledPopulation =  $("#unsettledPopulationList").getRowData(rowid);
	$("#viewUnsettledPopulationMaintanceDialog").createDialog({
		width:dialogWidth,
		height:dialogHeight,
		title:'查看'+title+'信息',
		url:'${path}/baseinfo/unsettledPopulationManage/dispatchOperate.action?mode=view&unsettledPopulation.id='+unsettledPopulation.id,
		buttons: {
	   		"关闭" : function(){
	        	$(this).dialog("close");
	   		}
