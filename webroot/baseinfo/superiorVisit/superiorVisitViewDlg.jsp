...
<%@ include file="/includes/baseInclude.jsp" %>
	...
	<input id="populationType" type="hidden" name="population.populationType" value="${populationType}" />
		<div id=tabs>
			<ul>
				<li id="populationBaseInfo"><a href="${path}/baseinfo/superiorVisitManage/viewCommonPopulation.action?population.id=${population.encryptId}">基本信息</a> </li>
				<li><a href="${path}/baseinfo/superiorVisitManage/viewSuperiorVisit.action?population.id=${population.encryptId}">业务信息</a> </li>
				<pop:JugePermissionTag ename="serviceTeamMemberManagement">
					<li><a href="/plugin/serviceTeam/router/routerManage/maintainServiceMemberForPopulation.action?module=<s:property value='@com.tianque.service.util.PopulationType@SUPERIOR_VISIT'/>&mode=view&id=${population.encryptId}">服务人员</a></li>
				...
				<pop:JugePermissionTag ename="searchSuperiorVisitHistoryManagement">
					<li><a href="${path }/baseinfo/superiorVisitHistoryManage/dispatchOperate.action?mode=viewList&id=${population.encryptId }">上访历史信息</a></li>
				</pop:JugePermissionTag>
			</ul>
   		</div>
  </div>
...
// 		$.ajax({
// 			url:'${path}/baseinfo/populationTypeManage/getPopulationTypeByPopulationIdAndType.action?orgInternalCode=${population.orgInternalCode}&populationId=${population.encryptId}&populationType=<s:property value="@com.tianque.service.util.PopulationType@SUPERIOR_VISIT"/>',
// 			async:false,
