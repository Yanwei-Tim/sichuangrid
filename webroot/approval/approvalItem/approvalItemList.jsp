...
<div class="content">
	...
	<div class="issueProgram clearfix">
		<div class="issueLeft">
			...
			<%-- <div class="resultNum">共有<span id="issueApprovalItemListTotal">0</span>条结果</div> --%>
		</div>
...
function selectApprovalItem(){
	...
	var pageData = {"approvalItemVo.status":"<s:property value='@com.tianque.approval.domain.property.ApprovalItemStatus@IN_PROCESS'/>","page":1,"rows":10,"sidx":"id","sord":"desc"};
	$.ajax({
		async : true,
		url : pageUrl,
		data :pageData,
		success : function(data) {
			...
			$("#issueApprovalItemListTotal").html("<lable>"+$("#records").val()+"</lable>");
...
function search(){
	...
	var initParam = {
			"searchtxt":condition,
			"approvalItemVo.status":"<s:property value='@com.tianque.approval.domain.property.ApprovalItemStatus@IN_PROCESS'/>",
