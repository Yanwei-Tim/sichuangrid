...
.cf {zoom:1;}
	...
	body{background:#518fe6 url(/resource/system/images/login/cqhechuan/smlbg.png) repeat-x;}
	//.product-login-ctt{overflow:hidden;width:100%;height:100%;background:#17a1e6 url(/resource/system/images/login/cqhechuan/index_bj.jpg) no-repeat center center;}
	.product-login .DL_log_bj img{	
	position:absolute;left:50%;margin-left:-620px;z-index:-1;top:63%;margin-top:-385px;
}
	.copyright{width:100%;height:100%;margin:55px 0 0 0;_margin:1% 0 0;font:12px/45px "";color:#fff;text-align: center;}
	.product-logCon{width:100%;padding-top: 60px;text-align:center;}
	.product-login .logo{width:672px;height:62px;margin-bottom:210px;margin-left:54px;}
	.product-form{margin-left: 38px;overflow: hidden;}
	.product-form_dl{position:absolute;left:50%;margin-left:-360px;}
	.product-logform .inputSearch{float:left;width:270px;height:38px;*display:inline;*zoom:1;padding:0 0 0 10px;font:14px/38px "microsoft yahei";color:#95A2AE;background:url(/resource/system/images/login/cqhechuan/textbg.png) no-repeat;}
	...
	.product-logform .inputSearchSecret a{width:95px;height:40px;display:inline-block;*display:inline;*zoom:1;text-decoration:none;color:#fff;text-align:center;background: url(/resource/system/images/login/cqhechuan/log.png) no-repeat;}
	.product-logform .inputSearchCheckbox{_margin:10px 0 0 10px;font:12px/38px "";color:#fff;}
	...
	.loginBox{ position:absolute;top:54%;left:50%;width:780px;height:390px;margin-top:-185px;margin-left:-390px;}
...
<div class="product-login-ctt">
	...
	<div class="DL_log_bj"><img src="${resource_path}/resource/system/images/login/cqhechuan/bg.png" /></div>
	<div class="loginBox">
	<div class="logo"><img src='${resource_path}/resource/system/images/login/cqhechuan/logo.png'/></div>
