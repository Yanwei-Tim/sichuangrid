...
<!--         </li> -->
        <li class="item on">
            ...
            <ul class="subItem">
            	<pop:JugePermissionTag ename='taskListAnalysisManagge'>
            		<li><a href="#chartPageAnalysisManage-chartMap" class="cur" baseurl="/hotModuel/task/statistics/taskListAnalysis.ftl" >任务清单总览</a></li>
            	</pop:JugePermissionTag>
	            <pop:JugePermissionTag ename='floatSituationManage'>
	            	<li><a href="#chartPageAnalysisManage-chartMap" baseurl="/hotModuel/task/statistics/floatSituation.ftl" >流动人口</a></li>
	            </pop:JugePermissionTag>	
	            <pop:JugePermissionTag ename='policeStatisticsManage'>
	            	<li><a href="#chartPageAnalysisManage-chartMap" baseurl="/hotModuel/task/statistics/policeStatistics.ftl" >民警带领下开展工作</a></li>
	            </pop:JugePermissionTag>
	            <pop:JugePermissionTag ename='exceptionStatisticsManage'>
	            	<li><a href="#chartPageAnalysisManage-chartMap" baseurl="/hotModuel/task/statistics/exceptionStatistics.ftl" >异常情况报告</a></li>
	            </pop:JugePermissionTag>
	            <pop:JugePermissionTag ename='specialPopulationsManage'>
	            	<li><a href="#chartPageAnalysisManage-chartMap" baseurl="/hotModuel/task/statistics/specialPopulations.ftl" >特殊人群</a></li>
	            </pop:JugePermissionTag>
	            <pop:JugePermissionTag ename='hiddengerStatisticsManage'>
	            	<li><a href="#chartPageAnalysisManage-chartMap" baseurl="/hotModuel/task/statistics/hiddengerStatistics.ftl" >发现治安隐患</a></li>
	            </pop:JugePermissionTag>
	            <pop:JugePermissionTag ename='mapAnalysisManage'>
	            	<li><a href="#chartPageAnalysisManage-chartMap" baseurl="/hotModuel/judgmentAnalysis/chartPage/map/index.ftl" >地图分析</a></li>
	            </pop:JugePermissionTag>
            </ul>
        </li>
    </ul>
		...
		$("#accordion a").click(function(){
         ...
         if(flag == 'show'){
      		...
      		if(jsflag==undefined || jsflag=='' || !$("#"+jsflag)[0]){     			
      			//$('#accordion a').eq(0).click().closest(".subItem:hidden").prev().addClass("sssssssssssssssssssss").click();
      			$('#accordion a').eq(0).click();
      			$('#accordion .subItem').eq(0).find("a:first").click();
      		}else{
