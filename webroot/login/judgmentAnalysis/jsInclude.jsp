...
<!-- 研判分析 -->
<link rel="stylesheet" href="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/styles/jqx.base.css" type="text/css" />
<link rel="stylesheet" href="${resource_path}/resource/judgmentAnalysis/css/main.css" />

<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxcore.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxdata.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxbuttons.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxscrollbar.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxgrid.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxgrid.selection.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxgrid.columnsresize.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxgrid.pager.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxdatatable.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/jqwidgets/jqxtreegrid.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/scripts/demos.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/echarts/echarts.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/widget.js"></script>
<script src="${resource_path}/resource/judgmentAnalysis/js/base.js"></script>
