...
<style type="text/css">
	...
	.product-login-ctt{overflow:hidden;width:100%;height:100%;background:#B13B23 url(/resource/system/images/login/red/loginb.jpg) no-repeat center center;}
	.copyright{width:100%;margin:3% 0 0;_margin:1% 0 0;font:12px/45px "";color:#fff;text-align: center;}
	.product-logCon{width: 850px;margin:60px 0 0 -425px;text-align:center;position:absolute;top:50%;left:50%;}
...
<div class="product-login-ctt">
	<div class="product-login" id="productLogin">
	    <div class="product-logCon">
	    	<div class="logo"><img src='/resource/system/images/login/red/logo.png'/></div>
