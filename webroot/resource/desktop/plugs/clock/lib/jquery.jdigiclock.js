...
(function($) {
    $.fn.extend({
        ...
        jdigiclock: function(options) {
            ...
            var defaults = {
                clockImagesPath: '/desktop/resource/plugs/clock/images/clock/',
                weatherImagesPath: '/desktop/resource/plugs/clock/images/weather/',
                lang: 'en',
                am_pm: false,
            ...
            return this.each(function() {
                ...
                html    += '<p id="left_arrow"><img src="/desktop/resource/plugs/clock/images/icon_left.png" /></p>';
                html    += '<p id="right_arrow"><img src="/desktop/resource/plugs/clock/images/icon_right.png" /></p>';
    ...
    $.fn.getWeather = function(el) {
        ...
        $.getJSON('/desktop/resource/plugs/clock/lib/proxy/' + proxy + '?location=' + el.weatherLocationCode + '&metric=' + el.weatherMetric, function(data) {
            ...
            el.find('#forecast_container').append('<div id="update"><img src="/desktop/resource/plugs/clock/images/refresh01.png" alt="reload" title="reload" id="reload" />' + el.timeUpdate + '</div>');
