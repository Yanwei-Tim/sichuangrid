...
<div id="dialog-form" title="短信提示语模版" class="container container_24">
	...
	<c:if test='${mode=="edit"}'>
	<input  type="hidden" name="smsMessageMark.id" value="${smsMessageMark.id}" />
	<input  type="hidden" name="smsMessageMark.dealType" value="${smsMessageMark.dealType}" />
	<input  type="hidden" name="smsMessageMark.operationtType" value="${smsMessageMark.operationtType}" />
    <div class="grid_4 lable-right">
		<label >类型：</label>
	</div>
	<div class="grid_6 lable-right">
	...
	<div style="display:inline;float:left;height:110px;line-height:110px;width:81.667%;">
		<textarea name="smsMessageMark.model" style="height:95px;"
		 class="form-txt" id="myContact-remark" maxlength="55">${smsMessageMark.model}</textarea>
	</div>
	<div style="clear:both"></div>
