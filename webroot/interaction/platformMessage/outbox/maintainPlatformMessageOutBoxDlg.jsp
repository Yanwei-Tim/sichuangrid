...
<div  class="container container_24 cf">
	<form id="maintainForm" method="post" action="">
		...
		<input type="hidden" name="platformMessage.originatorsDate" value="<fmt:formatDate value="${platformMessage.originatorsDate}" type="date" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
		...
		<div class="grid_16" id="Grid_List_10">
		...
		<div class="grid_20 heightAuto">
			...
			<c:if test='${"outboxForward"==mode || "inboxForward"==mode || "workBenchForward"==mode}'>
...
$(document).ready(function(){
	...
	}else if("${mode}"=="inboxForward" || "${mode}"=="workBenchForward"){
