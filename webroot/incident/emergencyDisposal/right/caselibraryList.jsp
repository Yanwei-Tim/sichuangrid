...
<script type="text/javascript">
	$(function(){
		//$("#incident_"+getSelectId()).click();
		ifDegreed();
	})
	/*右上侧点击某条列表中的数据*/
	function hideLoading(){
	//	$("#incidentCaseLibraryLeft").hide();
	}
	...
	function cleanViewCaseLibraryStepsDates(){
		$("#viewFeedbacksDate").empty();
		$("#viewFeedbacksName").empty();
		$("#viewStepsDate").empty();
		$("#viewStepsName").empty();
		}
	function cleanViewDatas(){
		$("#caseCategory").empty();
		$("#caseDegree").empty();
		cleanViewCaseLibraryStepsDates();
		}
