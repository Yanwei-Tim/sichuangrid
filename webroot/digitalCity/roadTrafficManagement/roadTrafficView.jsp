...
<table width="200" class="tablelist">
  <tr>
    ...
    <td colspan="3" class="content" id="roadTrafficOrgName">${location.organization.orgName}</td>
     <td class="imagesTX" rowspan="7">
    <s:if test='null!=population.imgUrl && !"".equals(population.imgUrl)'>
		<img id="roadTrafficImg" name="population.imgUrl" src="" width="148px"/>
	</s:if>
	<s:else>
