        ...
        <ul class="subnavbar">
            <pop:JugePermissionTag ename="statAdministrativeRegradedPoint">
			     <li><a href="javascript:void(0)"
				    onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/statRegradedPointManage/dispatch.action?internalId=<s:property value="@com.tianque.domain.property.OrganizationType@ADMINISTRATIVE_REGION"/>')"><span><span><s:property value="#request.name"/></span></span></a></li>
			</pop:JugePermissionTag>
			<pop:JugePermissionTag ename="statFunctionalRegradedPoint">
			     <li><a href="javascript:void(0)"
                    onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/statRegradedPointManage/dispatch.action?internalId=<s:property value="@com.tianque.domain.property.OrganizationType@FUNCTIONAL_ORG"/>')"><span><span><s:property value="#request.name"/></span></span></a></li>
            </pop:JugePermissionTag>
	   </ul> 
	</pop:JugePermissionTag>
	<pop:JugePermissionTag ename="peopleInformation">
        <ul class="subnavbar">
            <pop:JugePermissionTag ename="issueStatusStat">
			     <li><a href="javascript:void(0)"
				    onclick="asyncMiddleLevelOpen(this,'${path}/stat/statAnalyseIssueStatueManage/dispatch.action?mode=initDate')"><span><span><s:property value="#request.name"/></span></span></a></li>
	        </pop:JugePermissionTag>
	    </ul> 
	</pop:JugePermissionTag>
    <pop:JugePermissionTag ename="locationInformation">
        <ul class="subnavbar">
            <pop:JugePermissionTag ename="issueTypeStat">
			     <li><a href="javascript:void(0)"
				    onclick="asyncMiddleLevelOpen(this,'${path}/issueTypeStanal/issueTypeStanalManage/dispatch.action?mode=initDate')"><span><span><s:property value="#request.name"/></span></span></a></li>
	        </pop:JugePermissionTag>
	    </ul> 
	</pop:JugePermissionTag>
    <pop:JugePermissionTag ename="contradictionInvestigation">
        <ul class="subnavbar">
            <pop:JugePermissionTag ename="issueInvestigationMediate">
			     <li><a href="javascript:void(0)"
				    onclick="asyncMiddleLevelOpen(this,'${path}/issueInvestigationMediate/issueInvestigationMediateManage/dispatch.action','normalState')"><span><span><s:property value="#request.name"/></span></span></a></li>
	        </pop:JugePermissionTag>
	    </ul> 
    </pop:JugePermissionTag>
    <pop:JugePermissionTag ename="baseDataStatistics">
        <ul class="subnavbar">
            <pop:JugePermissionTag ename="importantPersonelStat">
			     <li><a href="javascript:void(0)"
				    onclick="asyncMiddleLevelOpen(this,'${path}/baseInfoStatistics/dispatch.action?mode=personnel')"><span><span><s:property value="#request.name"/></span></span></a></li>
			</pop:JugePermissionTag>
            <pop:JugePermissionTag ename="importantLocaltionStat">
			     <li><a href="javascript:void(0)"
				    onclick="asyncMiddleLevelOpen(this,'${path}/baseInfoStatistics/dispatch.action?mode=place')"><span><span><s:property value="#request.name"/></span></span></a></li>
	        </pop:JugePermissionTag>
	    </ul> 
    </pop:JugePermissionTag>
    <pop:JugePermissionTag ename="superviseIssueList">
        <ul class="subnavbar">
			<li><a href="javascript:void(0)"
				onclick="asyncMiddleLevelOpen(this,'${path}/issue/issueManage/dispatch.action?mode=superviseList')"><span><span><s:property value="#request.name"/></span></span></a></li>
	    </ul> 
	</pop:JugePermissionTag>
</div>
<script>
