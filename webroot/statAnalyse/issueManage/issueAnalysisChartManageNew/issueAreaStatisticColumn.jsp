...
function onOrgChanged(){
	...
	var chartCount=$("#issueColumn").columnChart({
		url: "${path}/issueAnalysisChartManageNew/getStatisticColumn.action?orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val()+"&searchType="+$("#searchType").val()+"&quarter="+$("#quarter").val(),
		moduleName:"事件处理统计",
		textx:-150,
		quantity:'个数'
	});
