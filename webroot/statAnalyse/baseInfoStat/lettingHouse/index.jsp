...
<div class="zt_tabs_style">
	<div id="chartsTabs">
	<ul>
		<li><a href="${path }/statAnalyse/baseInfoStat/lettingHouse/statisticsLettingHouseColumn.jsp">区域分布图</a></li>
		<!-- -->
		  
		<li><a href="${path }/statAnalyse/baseInfoStat/lettingHouse/statisticsLettingHousePie.jsp">隐患程度分布图</a></li>
		
		
		<li><a href="${path }/statAnalyse/baseInfoStat/lettingHouse/statisticLettingHouseList.jsp">列表信息</a></li>
