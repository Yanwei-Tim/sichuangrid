...
<div class="zt_tabs_style">
	...
	<ul>
	<!-- 
		<li><a href="${path }/statAnalyse/baseInfoStat/totalStatistic/statisticsPositiveinfoPie.jsp">类型分布图</a></li>
		...
		<li><a href="${path }/statAnalyse/baseInfoStat/totalStatistic/statisticTotalList.jsp?type=<s:property value='#parameters.type'/>">列表信息</a></li>
		 -->
		<li><a href="${path }/statAnalyse/baseInfoStat/totalStatistic/statisticTotalListColumn.jsp?type=${type}">区域分布图</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/totalStatistic/statisticTotalPie.jsp?type=${type}">类型分布图</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/totalStatistic/statisticTotalList.jsp?type=${type}">列表信息</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/common/tendencyChartForPositiveinfo.jsp?tableNameKey=${type}
				">趋势图</a></li>
	</ul>
	</div>
...
function setOptionsWhenShowInfo(name, orgId){
	...
	}else if(name.indexOf("重症精神障碍患者") != -1){
		title='重症精神障碍患者';
