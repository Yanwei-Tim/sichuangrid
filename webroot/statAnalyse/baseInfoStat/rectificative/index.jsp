...
<div class="zt_tabs_style">
	<div id="chartsTabs">
	<ul>	
			<li><a href="${path }/statAnalyse/baseInfoStat/rectificative/rectificativePersonColumnList.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/rectificative/rectificativePersonPieList.jsp">类型分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/rectificative/rectificativePersonCountList.jsp">列表信息</a></li>
