...
function onOrgChanged(){
	...
	chartCount=$("#departmentPartyColumn").columnChart({
		url: "${path}/baseInfo/primaryOrganizationStat/primaryOrgnizationColmunData.action?type=departmentParty&orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val(),
