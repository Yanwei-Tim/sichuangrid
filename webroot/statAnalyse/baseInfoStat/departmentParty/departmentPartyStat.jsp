...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/baseInfoStat/departmentParty/departmentPartyColumnList.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/departmentParty/departmentPartyCountList.jsp">列表信息</a></li>
		</ul>
	</div>
</div>
