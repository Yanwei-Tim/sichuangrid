...
<div id="importPersonSituationPrint"  style="overflow: auto;height:100%;width:100%">
   <style type="text/css">
   ...
   <div id="personSituationGridbox" class="SigmaReportPrint" style="overflow: auto;height:100%;width:100%"></div>
</div>
<script>
...
$(document).ready(function(){
	$.ajax({
		...
		success:function(data){
			...
			$("#title_personSituationGridbox").html(data.orgName+"人员总况报表");
		}
	 })
		var context = {};
		var columns = [
...
function importPersonelSituationPrint(){
	$.ajax({
		url:'/baseInfoStat/statisticsPersonnel/getStatisticsImportantPersonlList.action?orgId='+'<s:property value="#parameters.parentOrgId"/>'+'&year='+'<s:property value="#parameters.year"/>'+'&month='+'<s:property value="#parameters.month"/>'+'&typeTableName='+'<s:property value="#parameters.typeTableName"/>',
		success:function(data){
