...
<div class="zt_tabs_style">
	...
	<ul>
	<!-- -->
		<li><a href="${path }/statAnalyse/baseInfoStat/actualHouse/statisticsActualHouseColumn.jsp">区域分布图</a></li>
		
		<li><a href="${path }/statAnalyse/baseInfoStat/actualHouse/statisticsActualHousePie.jsp">类型分布图</a></li>
			 
		<li><a href="${path }/statAnalyse/baseInfoStat/actualHouse/statisticActualHouseList.jsp">列表信息</a></li>
