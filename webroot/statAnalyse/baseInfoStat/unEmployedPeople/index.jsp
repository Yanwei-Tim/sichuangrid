...
<div class="zt_tabs_style">
	...
	<ul>
		...
		<li><a href="${path }/statAnalyse/baseInfoStat/unEmployedPeople/statisticUnEmployedPeopleColumn.jsp">区域分布图</a></li>
		 
		<li><a href="${path }/statAnalyse/baseInfoStat/unEmployedPeople/statisticUnEmployedPeopleList.jsp">列表信息</a></li>
