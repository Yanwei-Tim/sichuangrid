...
function onOrgChanged(){
	$.ajax({
		url:'${path}/baseInfo/primaryOrganizationStatNew/primaryOrganizationStatisticList.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val(),
...
// 	setTimeout('onOrgChanged()',350);
	...
	$("#createStatistic").click(function(){
		$.ajax({
			url:'${path}/baseInfo/primaryOrganizationStatNew/createHistoryStatistic.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=primaryOrganizations",
	...
	$(".print").click(function(){
		$("#zongkuangPrint").createDialog({
			...
			url:'${path}/statAnalyse/baseInfoStat/organizationStatNew/primaryOrganizationPrintNew.jsp?parentOrgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=${type}&moduleName="+document.title,
			buttons: {
			   "打印" : function(){
				print();
		  	   },
