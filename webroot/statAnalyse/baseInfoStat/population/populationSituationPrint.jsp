...
function importPersonelSituationPrint(){
	$.ajax({
		url:'/baseInfoStat/statisticsPopulation/getStatisticsPopulationList.action?orgId='+'<s:property value="#parameters.parentOrgId"/>'+'&year='+'<s:property value="#parameters.year"/>'+'&month='+'<s:property value="#parameters.month"/>'+'&populationType='+'<s:property value="#parameters.populationType"/>',
		success:function(data){
