...
function onOrgChanged(){
	var chartCount=$("#importantPlaceColumn").columnChart({
		url: "${path}/baseInfoStat/statisticsPlace/getStatisticsImportantPlaceColumn.action?orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val()+"&typeTableName=IMPORTANTPLACE",
