...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/baseInfoStat/importantPlace/statisticsImportantPlaceColumn.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/importantPlace/statisticsImportantPlacePie.jsp">类型分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/importantPlace/statisticsImportantPlaceList.jsp">列表信息</a></li>
...
function setOptionsWhenShowInfo(name, orgId){
	if(name.indexOf("安全生产重点") != -1){
		title='安全生产重点';
		url = '${path}/baseinfo/siteinfo/enterprise/enterpriseListForStatistics.jsp?keyType=safetyProductionKey&orgIdForStat='+orgId;
	}else if(name.indexOf("消防安全重点") != -1){
		title='消防安全重点';
		url = '${path}/baseinfo/siteinfo/enterprise/enterpriseListForStatistics.jsp?keyType=fireSafetyKey&orgIdForStat='+orgId;
	}else if(name.indexOf("治安重点") != -1){
		title='治安重点';
		url = '${path}/baseinfo/siteinfo/enterprise/enterpriseListForStatistics.jsp?keyType=securityKey&orgIdForStat='+orgId;
	}else if(name.indexOf("学校") != -1){
		title='学校we';
		url = '${path}/baseinfo/siteinfo/school/schoolListForStatistics.jsp?orgIdForStat='+orgId;
	}else if(name.indexOf("其他场所") != -1){
		title='其他场所1';
		url = '${path}/baseinfo/siteinfo/otherLocale/otherLocaleListForStatistics.jsp?orgIdForStat='+orgId;
	}
}
