...
<div class="zt_tabs_style">
	...
	<ul>
		...
		<li><a href="${path }/statAnalyse/baseInfoStat/handicapped/statisticHandicappedColumn.jsp">区域分布图</a></li>
		 <li><a href="${path }/statAnalyse/baseInfoStat/handicapped/statisticHandicappedPie.jsp">类型分布图</a></li>
		<li><a href="${path }/statAnalyse/baseInfoStat/handicapped/statisticHandicappedList.jsp">列表信息</a></li>
