...
function onOrgChanged(){
	...
	chartCount=$("#${type}Column").columnChart({
		url: "${path}/baseInfo/primaryOrganizationStat/primaryOrgnizationColmunData.action?type=primaryOrganizations&orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val(),
