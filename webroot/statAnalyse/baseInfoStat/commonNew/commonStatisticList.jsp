...
function onOrgChanged(){
	$.ajax({
		url:'${path}/baseInfo/statisticManageNew/getBaseInfoStatisticList.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=${type}",
...
$(document).ready(function(){
	...
	$("#createStatistic").click(function(){
		$.ajax({
			url:'/baseInfo/statisticManageNew/createHistoryStatistic.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=${type}",
	...
	$(".print").click(function(){
		$("#${type}PrintDlg").createDialog({
			...
			url:'${path}/statAnalyse/baseInfoStat/commonNew/commonStatisticPrint.jsp?parentOrgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=${type}&moduleName="+document.title,
			buttons: {
			   "打印" : function(){
				print();
		  	   },
