...
function getDepartmentParty(){
	$.ajax({
		url:'${path}/baseInfo/departmentPartyManageNew/departmentPartyStatisticList.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+'&orgLevelDistance=<s:property value="#parameters.orgLevelDistance"/>',
