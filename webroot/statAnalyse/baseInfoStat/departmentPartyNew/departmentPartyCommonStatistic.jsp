...
<div id="departmentPartyColumn" class="SigmaReport"></div>
<script type="text/javascript">
var chartCount;
function onOrgChanged(){
	if(!isGrid()){
		chartCount=$("#departmentPartyColumn").columnChart({
			url: "${path}/baseInfo/primaryOrganizationStatNew/primaryOrgnizationColmunData.action?type=departmentParty&orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val(),
