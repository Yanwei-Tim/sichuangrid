...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/baseInfoStat/aidNeedPopulation/poorPeoplePersonColumnList.jsp">区域分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/aidNeedPopulation/poorPeoplePieList.jsp">类型分布图</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/aidNeedPopulation/poorPeopleCountList.jsp">列表信息</a></li>
