...
function onOrgChanged(){
	var chartCount=$("#SimplyColumn").columnChart({
		url: "/baseInfoStat/companyPlaceStanalsManage/getStatisticsCompanyPlaceColumn.action?moduleType=${moduleType}&orgId="+getCurrentOrgId()+"&year="+$("#cyear").val()+"&month="+$("#cmonth").val(),
