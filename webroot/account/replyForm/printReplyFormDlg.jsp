...
<div >
	<style>
	.printReplyForm{margin-top: 5px;width:96%; border-left:1px solid #CCC; border-top:1px solid #CCC; border-collapse:collapse;background:#fff;}
	.printReplyForm td{height:26px;line-height:26px;text-indent:5px;border-right:1px solid #ccc;border-bottom:1px solid #ccc; border-collapse:collapse; word-break:break-all; word-warp:break-word;}
	.printReplyForm .btitle{background:#ECF1F8; font:bold 12px/26px ""; padding:0 0 0 5px;}
	.printReplyForm .title{width:14%;font:normal 12px/26px ""; color:#000; padding:0 0 0 5px;}
	</style>
	<table  width="96%" border="0" cellpadding="0" cellspacing="0">
        ...
        <table width="96%" border="0" cellpadding="10" cellspacing="0" style="margin:0 0 0 0;text-align:center;border-collapse:collapse;width:96%;" class="printReplyForm">
        <tr>
       	...
       	<tr class="tr1" height="60">
       		...
       		<td colspan="3" style="text-align:left;font-Size:10px; height:20px;word-break:break-all;word-wrap:break-word">
            	...
            	<p align="right" valign="bottom" style="margin-right:20px;"> 
            		&nbsp;&nbsp;&nbsp;&nbsp;
            	<c:if test="${fn:length(replyForm.attachFiles) > 0}">
                   	<div class="smallText" id="gallery<s:property value="id"/>">
						<span class="filetype-clip"></span>附件：
						<c:forEach items="${replyForm.attachFiles}" var="issueAttachFile">
						   	${issueAttachFile.fileName};
                        </c:forEach>
                      	</div>
		           </c:if>
            	</p>
