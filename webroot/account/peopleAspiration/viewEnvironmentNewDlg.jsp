		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${environment.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${environment.beneficiaryNumber}</td>
					</tr>
					<c:if test="${environment.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENVIRONMENT_BUILD_TYPE" defaultValue="${environment.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       	...
			       	<tr>
			        	...
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENVIRONMENT_PROJECT" defaultValue="${environment.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			     	<c:if test="${environment.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">治理类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@ENVIRONMENT_PROJECT_SUB" defaultValue="${environment.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
					<tr>
						<td class="title">治理数量</td><td class="contable">${environment.governNumber}</td>
					</tr>
					<tr>
						<td class="title">建设起点</td><td class="contable">${environment.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${environment.toAddress}</td>
					</tr>
					<tr>
						<td class="title">建设规模及建设内容</td><td class="contable">${environment.content}</td>
					</tr>
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${environment.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${environment.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${environment.gapFund}</td>
					</tr>
