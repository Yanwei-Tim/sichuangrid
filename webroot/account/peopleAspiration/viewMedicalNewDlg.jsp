		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${medical.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${medical.beneficiaryNumber}</td>
					</tr>
					<c:if test="${medical.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@MEDICAL_BUILD_TYPE" defaultValue="${medical.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       	...
			       	<tr>
			        	...
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@MEDICAL_PROJECT" defaultValue="${medical.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			     	<c:if test="${medical.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">项目内容</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@MEDICAL_PROJECT_SUB" defaultValue="${medical.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<tr>
						<td class="title">建设起点</td><td class="contable">${medical.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${medical.toAddress}</td>
					</tr>
					<tr>
						<td class="title">建设工程量</td><td class="contable">${medical.buildArea}</td>
					</tr>
					<tr>
						<td class="title">设备</td><td class="contable">${medical.equipment}</td>
					</tr>
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${medical.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${medical.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${medical.gapFund}</td>
					</tr>
