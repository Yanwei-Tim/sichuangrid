				...
				<tbody>
					...
					<c:if test="${labor.projectCategory.id != null}">
			       	<tr>
			        	...
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LABOR_PROJECT" defaultValue="${labor.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${labor.projectSubCategory.id != null}">
			       	<tr>
			        	<td class="title">项目类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LABOR_PROJECT_SUB" defaultValue="${labor.projectSubCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${labor.projectSubContentCategory.id != null}">
			       	<tr>
			        	<td class="title">项目内容</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LABOR_PROJECT_CONTENT" defaultValue="${labor.projectSubContentCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	
			      	<c:if test="${labor.degree.id != null}">
			       	<tr>
			        	<td class="title">本人学历</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LEDGER_DEGREE" defaultValue="${labor.degree.id}" /></td>
			       	</tr>
			       	</c:if> 	
			       	<tr>
						<td class="title">本人技能特长</td><td class="contable">${labor.skill}</td>
					</tr>
			       <c:if test="${labor.ageLevel.id != null}">
			       	<tr>
			        	<td class="title">年龄段</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LABOR_AGE" defaultValue="${labor.ageLevel.id}" /></td>
			       	</tr>
			       	</c:if> 
			        <c:if test="${labor.crippleLevel.id != null}">
			       	<tr>
			        	<td class="title">残疾等级</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LABOR_CRIPPLE" defaultValue="${labor.crippleLevel.id}" /></td>
			       	</tr>
			       	</c:if> 
			       <c:if test="${labor.dignity.id != null}">
			       	<tr>
			        	<td class="title">身份性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@LABOR_DIGNITY" defaultValue="${labor.dignity.id}" /></td>
			       	</tr>
			       	</c:if> 
			        <tr>
						<td class="title">工资拖欠工程项目名称</td><td class="contable">${labor.projectName}</td>
					</tr>
					<tr>
						<td class="title">工资拖欠施工单位</td><td class="contable">${labor.company}</td>
					</tr>
					<tr>
						<td class="title">工资拖欠施工单位地址</td><td class="contable">${labor.yawnAddr}</td>
					</tr>
					<tr>
						<td class="title">工资拖欠施工单位联系人姓名</td><td class="contable">${labor.yawnContactor}</td>
					</tr>
					<tr>
						<td class="title">联系电话</td><td class="contable">${labor.yawnMobile}</td>
					</tr>
					
			       	<tr>
						<td class="title">涉及人数</td><td class="contable">${labor.relationNumber}</td>
					</tr>
					<tr>
						<td class="title">涉及金额（万元）</td><td class="contable">${labor.money}</td>
					</tr>
