		...
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
			       ...
			       <tr>
						<td class="title">工程名称</td><td class="contable">${traffic.projectName}</td>
					</tr>
			       	<tr>
						<td class="title">受益人口</td><td class="contable">${traffic.beneficiaryNumber}</td>
					</tr>
					<c:if test="${traffic.buildType.id != null}">
			       	<tr>
			        	<td class="title">建设性质</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_BUILD_TYPE" defaultValue="${traffic.buildType.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.projectCategory.id != null}">
			       	<tr>
			        	<td class="title">项目类别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_PROJECT" defaultValue="${traffic.projectCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.roadCategory.id != null}">
			       	<tr>
			        	<td class="title">道路类别</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_ROAD" defaultValue="${traffic.roadCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.roadSurfaceCategory.id != null}">
			       	<tr>
			        	<td class="title">路面类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_ROADSURFACE" defaultValue="${traffic.roadSurfaceCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.securityCategory.id != null}">
			       	<tr>
			        	<td class="title">安保设施类型</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_SECURITY" defaultValue="${traffic.securityCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.passengerCategory.id != null}">
			       	<tr>
			        	<td class="title">班线客运</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_PASSENGER" defaultValue="${traffic.passengerCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.publicTransportCategory.id != null}">
			       	<tr>
			        	<td class="title">城市公共交通</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_PUBLIC_TRANSPORT" defaultValue="${traffic.publicTransportCategory.id}" /></td>
			       	</tr>
			       	</c:if>
					<c:if test="${traffic.passengerManageCategory.id != null}">
			       	<tr>
			        	<td class="title">客运站管理</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_PASSENGER_MANAGE" defaultValue="${traffic.passengerManageCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<c:if test="${traffic.passengerBuildCategory.id != null}">
			       	<tr>
			        	<td class="title">客运站建设</td><td class="contable">
			        	<pop:PropertyDictViewTag name="@com.tianque.plugin.account.property.PropertyTypes@TRAFFIC_PASSENGER_BUILD" defaultValue="${traffic.passengerBuildCategory.id}" /></td>
			       	</tr>
			       	</c:if>
			       	<tr>
						<td class="title">建设起点</td><td class="contable">${traffic.fromAddress}</td>
					</tr>
					<tr>
						<td class="title">建设讫点</td><td class="contable">${traffic.toAddress}</td>
					</tr>
					<tr>
						<td class="title">桥宽</td><td class="contable">${traffic.rodeWide}</td>
					</tr>
					<tr>
						<td class="title">桥长</td><td class="contable">${traffic.rodeLength}</td>
					</tr>
					<tr>
						<td class="title">里程(公里)</td><td class="contable">${traffic.mileage}</td>
					</tr>
					<tr>
						<td class="title">宽</td><td class="contable">${traffic.wide}</td>
					</tr>
					<tr>
						<td class="title">备注</td><td class="contable">${traffic.remark}</td>
					</tr>
					
			       	<tr>
						<td class="title">计划资金(万元)</td><td class="contable">${traffic.plannedInvestment}</td>
					</tr>
					<tr>
						<td class="title">自筹资金(万元)</td><td class="contable">${traffic.selfFund}</td>
					</tr>
						<tr>
						<td class="title">缺口资金(万元)</td><td class="contable">${traffic.gapFund}</td>
					</tr>
