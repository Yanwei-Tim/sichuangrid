...
<input type="hidden" id="isHideOrgSearchOrg" value="${isFun}"/>
 ...
 <div>
   ...
   <br/><br/><br/><br/>
   <jsp:include page="/account/informationAnalysis/mould/currentYearCollectByMonthSumMould.jsp"  flush="true"/>
...
function initYearCollect(){
	var statGridCollect = initCurrentYearCollectGridCollect("当年分月建账情况分析表汇总",false);
...
function getPrimaryOrgStat(statGridCollect){
	$.ajax({
		...
		data:{
			...
			"accountReport.reportType":<s:property value="@com.tianque.plugin.account.constants.LedgerReportType@YEAR_COLLECT_MONTH_SUM"/>,
