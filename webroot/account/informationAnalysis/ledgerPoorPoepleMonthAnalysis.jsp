...
<input type="hidden" id="isHideOrgSearchOrg" value="${isFun}"/>
 ...
 <div>
   ...
   <br/><br/><br/><br/>
   <jsp:include page="/account/informationAnalysis/mould/ledgerPoorPeopleMonthDoneMould.jsp"  flush="true"/>
...
function initYearCollect(){
	var ledgerPoorPeopleOrgStatGridCollect = initLedgerPoorPeopleGridCollect("本月困难群众信息收集情况分析表",false);
	getPrimaryOrgStat(ledgerPoorPeopleOrgStatGridCollect, 4);
	
	var ledgerPoorPeopleOrgStatGridDone = initLedgerPoorPeopleGridDone("本月困难群众信息办结情况分析表",false);
	getPrimaryOrgStat(ledgerPoorPeopleOrgStatGridDone, 5);
}

function getPrimaryOrgStat(ledgerPoorPeopleStatisticalGrid, reportType){
	$.ajax({
