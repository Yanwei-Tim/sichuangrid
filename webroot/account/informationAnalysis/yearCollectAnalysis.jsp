...
<input type="hidden" id="isHideOrgSearchOrg" value="${isFun}"/>
 ...
 <div>
   ...
   <br/><br/><br/><br/>
   <jsp:include page="/account/informationAnalysis/mould/yearCollectMould.jsp"  flush="true"/>
...
function initYearCollect(){
	var ledgerPeopleOrgStatGrid = initLedgerPeopleGrid("民生信息累计收集情况分析表",false);
	var ledgerPoorPeopleOrgStatGrid = initLedgerPoorPeopleGrid("困难群众信息累计收集情况分析表",false);
	var ledgerSteadyWorkOrgStatGrid = initLedgerSteadyWorkGrid("稳定信息累计收集情况分析表",false);
	getPrimaryOrgStat(ledgerPeopleOrgStatGrid, ledgerPoorPeopleOrgStatGrid, ledgerSteadyWorkOrgStatGrid);
}

function getPrimaryOrgStat(ledgerPeopleStatisticalGrid, ledgerPoorPeopleStatisticalGrid, ledgerSteadyWorkStatisticalGrid){
	$.ajax({
		...
		success:function(data){
			...
			ledgerPeopleStatisticalGrid.bindData(data);
			ledgerPoorPeopleStatisticalGrid.bindData(data);
