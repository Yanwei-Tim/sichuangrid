...
<div id="tabList">
	<ul>
	<c:if test="${isJg}">
		<li><a href="${path}/account/informationAnalysis/currentYearCollectByMonthSum.jsp">汇总&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="${path}/account/informationAnalysis/currentYearCollectByMonthDetail.jsp?orgType=1">乡镇详情&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="${path}/account/informationAnalysis/currentYearCollectByMonthDetail.jsp?orgType=0">县级详情&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
	</c:if>
	<c:if test="${isTown}">
		<li><a href="${path}/account/informationAnalysis/currentYearCollectByMonthSum.jsp">汇总&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
		<li><a href="${path}/account/informationAnalysis/currentYearCollectByMonthDetail.jsp?orgType=1">村级详情&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
	</c:if>
