...
<input type="hidden" id="isHideOrgSearchOrg" value="${isFun}"/>
 ...
 <div>
   ...
   <br/><br/><br/><br/>
   <jsp:include page="/account/informationAnalysis/mould/ledgerPeopleMontDoneMould.jsp"  flush="true"/>
...
function initYearCollect(){
	var ledgerPeopleOrgStatGridCollect = initLedgerPeopleGridCollect("本月民生信息收集情况分析表",false);
	getPrimaryOrgStat(ledgerPeopleOrgStatGridCollect, 4);
	
	var ledgerPeopleOrgStatGridDone = initLedgerPeopleGridDone("本月民生信息办结情况分析表",false);
	getPrimaryOrgStat(ledgerPeopleOrgStatGridDone, 5);
}

function getPrimaryOrgStat(ledgerPeopleStatisticalGrid, reportType){
	$.ajax({
