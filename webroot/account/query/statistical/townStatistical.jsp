...
<table style="width: 6000px;" class="countlist" id="tableId">
	<tr> 
		...
		中江县三本台账工作民生信息情况统计表(城乡规划建设与管理类)(第一部分)
		</td>
		<td colspan="35" id="timeShow" style="height: 50px;text-align: center;font-size: 24px;color: black;font-weight: bold;">
		中江县三本台账工作民生信息情况统计表(城乡规划建设与管理类)(第二部分)
		</td>
	</tr>
	<tr>
		...
		<td colspan="35" style="text-align: center;font-size: 14px;">数据收集期间： <s:date name="searchVo.beginCreateDate" format="yyyy年MM月dd日" />——<s:date name="searchVo.endCreateDate" format="yyyy年MM月dd日" /></td>
	</tr>
	...
	<tr class="countlistHead" style="text-align: center;">
		...
		<td colspan="8" style="text-align: center;">城市管理</td>
		<td colspan="8" style="text-align: center;">城市街道</td>
		<td colspan="9" style="text-align: center;">市政公共设施</td>
		<td colspan="8" style="text-align: center;">市政环卫</td>
		<td colspan="9" style="text-align: center;">村镇规划建设管理</td>
		<td colspan="7" style="text-align: center;">住房保障</td>
		<td colspan="9" style="text-align: center;">建筑质量安全</td>
