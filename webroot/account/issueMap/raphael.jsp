...
<link rel="stylesheet" type="text/css" href="${resource_path}/resource/external/blockBox/css/blackbox.css" />
<script src="${resource_path}/resource/external/blockBox/js/jquery.blackbox.js"></script>
<script>
	function createRaphael(id){
		var holder=$.bflow({
			id:id,
			url:'${path}/threeRecordsIssues/issueManage/viewIssueMap.action?peopleAspirations.id=${peopleAspirations.id}&ledgerType=${peopleAspirations.ledgerType}'
		});
		return holder;
	}
	$(function(){
