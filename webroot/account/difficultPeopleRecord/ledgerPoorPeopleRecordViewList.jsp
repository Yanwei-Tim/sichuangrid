...
.handleTop {
	...
	height: 15px;
	background:
		url(data:image/png;base64,)
		no-repeat;
}
</style>
<%
...
<div class="content"><jsp:include
	page="${path}/account/difficultPeopleRecord/poorPeopleForViewButtons.jsp" />
<div style="clear: both;"></div>
<div style="width: 100%;">
<table id="ledgerPoorPeopleList">
</table>
<div id="ledgerPoorPeopleListPager"></div>
</div>
...
function initIssueCount(){
	$.ajax({
        url: "/threeRecordsIssue/ledgerPoorPeopleManage/getIssueCount.action",
        data: {
        	"leaderView":"0",
        	"functionalOrgType":"<s:property value='#parameters.functionalOrgType'/>",
    		"sourceTypeInternalId":"<s:property value='#parameters.sourceType'/>",
...
function getSelectedIds(){
	var selectedIds = $("#ledgerPoorPeopleList").jqGrid("getGridParam", "selarrrow");
	var strs = new Array();
...
function getData(selectedId){
	return $("#ledgerPoorPeopleList").getRowData(selectedId);
}

function hasRowSelected(){
	if(null != $("#ledgerPoorPeopleList").getGridParam("selrow")){
		return true;
	}
	return false;
}
...
function getSelectedData(){
	var selectedId = $("#ledgerPoorPeopleList").getGridParam("selrow"); 
	return $("#ledgerPoorPeopleList").getRowData(selectedId);
}
...
function viewPoorPeope(rowid){
	...
	var selectedIssue =  $("#ledgerPoorPeopleList").getRowData(rowid);
...
function onOrgChanged(isEvaluate){
	if(undefined==$("#ledgerPoorPeopleList").attr("id")){return;}
	$("#ledgerPoorPeopleList").setGridParam({
...
$(document).ready(function(){
	$("#ledgerPoorPeopleList").jqGridFunction({
		datatype: "local",
		colModel:[
		...
		loadComplete: function(){
			var count=$("#ledgerPoorPeopleList").getGridParam("records");
			if(!isNaN(count)){
