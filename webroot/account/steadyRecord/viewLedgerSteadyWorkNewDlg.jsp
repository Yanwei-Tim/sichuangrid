...
<%
request.setAttribute("peopleAspirations",request.getAttribute("ledgerSteadyWork"));
%>
	...
	<div class="issueContentInfo">
		<div class="tableBox">
			<table class="newTableList">
				<tbody>
					<tr>
						<td class="title">编号</td><td class="contable">${ledgerSteadyWork.serialNumber}</td>
					</tr>
					<tr>
						<td class="title">建卡类型</td><td class="contable">${ledgerSteadyWork.createTableType.displayName}</td>
					</tr>
					<tr>
						<td class="title">发生网格</td><td class="contable">${ledgerSteadyWork.occurOrg.orgName}</td>
					</tr>
			        <tr class="resolveTheContradictions securityPrecautions emergencies">
						<td class="title">登记时间</td><td class="contable"><fmt:formatDate value="${ledgerSteadyWork.registrationTime}" type="date" pattern="yyyy-MM-dd" /><c:if test="${ not empty ledgerSteadyWork.hours && ledgerSteadyWork.hours!=null && not empty  ledgerSteadyWork.minute && ledgerSteadyWork.minute!=null}">${ledgerSteadyWork.hours }:${ledgerSteadyWork.minute }</c:if></td>
					</tr>
					<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">主要反映人</td><td class="contable">${ledgerSteadyWork.name}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">反映人身份证号</td><td class="contable">${ledgerSteadyWork.idCardNo}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">反映人联系电话</td><td class="contable">${ledgerSteadyWork.mobileNumber}</td>
			       	</tr>
			       	
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">性别</td><td class="contable">${ledgerSteadyWork.gender.displayName}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">是否党员</td><td class="contable">
			        		<s:if test="ledgerSteadyWork.isPartyMember==1">是</s:if>
	          				<s:elseif test="ledgerSteadyWork.isPartyMember==0">否</s:elseif>
	          				<s:else>未知</s:else>
			        	</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">职业或身份</td><td class="contable">${ledgerSteadyWork.position.displayName}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">常驻地址</td><td class="contable">${ledgerSteadyWork.permanentAddress}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">登记人</td><td class="contable">${ledgerSteadyWork.registrant}</td>
			       	</tr>
			       	
			       	
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">涉稳类型</td><td class="contable">${ledgerSteadyWork.steadyWorkType.displayName}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">涉稳问题类型</td><td class="contable">${ledgerSteadyWork.steadyWorkProblemType.displayName}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">备注</td><td class="contable">${ledgerSteadyWork.otherRemark}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">涉稳事项</td><td class="contable">${ledgerSteadyWork.involvingSteadyInfo}</td>
			       	</tr>
			       	
			       	
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">稳控责任人</td><td class="contable">${ledgerSteadyWork.steadyUser}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">化解责任部门</td><td class="contable">${ledgerSteadyWork.resolveUnit}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">化解责任人</td><td class="contable">${ledgerSteadyWork.resolveUser}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">稳定预警级别</td><td class="contable">${ledgerSteadyWork.steadyWorkWarnLevel.displayName}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions emergencies otherManage">
			        	<td class="title">预警日期</td><td class="contable"><s:date name="ledgerSteadyWork.steadyWorkWarnLevelDate" format="yyyy年MM月dd日" /></td>
			       	</tr>
			       	
			       	<tr class="socialConditions  ">
			        	<td class="title">服务联系人</td><td class="contable">${ledgerSteadyWork.serverContractor} ${ledgerSteadyWork.serverTelephone}</td>
			       	</tr>
			   <!--     	<tr class="specialPopulations">
			       	...
			       	<tr class="securityPrecautions">
			        	<td class="title">服务职务</td><td class="contable">${ledgerSteadyWork.serverJob}</td>
			       	</tr>
			       	<tr class="contradiction resolveTheContradictions">
			        	<td class="title">服务联系人单位</td><td class="contable">${ledgerSteadyWork.bookingUnit}</td>
			       	</tr>
			       	<!--<c:forEach var="infos" items="${ledgerSteadyWork.ledgerSteadyWorkPeopleInfos}">
			       		<tr class="contradiction resolveTheContradictions">
			        		<td class="title">涉嫌人员</td><td class="contable">${infos.name}</td>
			       		</tr>
			       		<tr class="contradiction resolveTheContradictions">
			        		<td class="title">联系方式</td><td class="contable">${infos.mobileNumber}</td>
			      		</tr>
			      		<tr class="contradiction resolveTheContradictions">
			        		<td class="title">身份证</td><td class="contable">${infos.idCardNo}</td>
			      	 	</tr>
			       	</c:forEach>-->
			       	<tr>
			...
			<div><h3 style="color: blue;">涉稳人员或涉稳群体代表：</h3></div>
			<c:forEach items="${ledgerSteadyWork.ledgerSteadyWorkPeopleInfos}" var="Infos" varStatus="remember">
				<table class="newTableList">
				<tbody>
					<tr>
						<td class="title">姓名</td><td class="contable">${Infos.name}</td>
					</tr>
					<tr>
						<td class="title">性别</td><td class="contable">${Infos.gender.displayName}</td>
					</tr>
					<tr>
						<td class="title">联系电话</td><td class="contable">${Infos.mobileNumber}</td>
					</tr>
					<tr>
						<td class="title">出生年月</td><td class="contable"><fmt:formatDate value="${Infos.birthDay }" pattern='yyyy-MM-dd'/></td>
					</tr>
					<tr>
						<td class="title">身份证号</td><td class="contable">${Infos.idCardNo}</td>
					</tr>
					<tr>
						<td class="title">是否党员</td><td class="contable">
							<c:if test="${Infos.partyMember == true}">是</c:if>
	          				<c:if test="${Infos.partyMember == false}">否</c:if>
						</td>
					</tr>
					<tr>
						<td class="title">住址</td><td class="contable">${Infos.permanentAddress}</td>
					</tr>
					<tr>
						<td class="title">职业或身份</td><td class="contable">${Infos.position.displayName}</td>
					</tr>
				</tbody>
			</table>
			<p>&nbsp;</p>
							...
							<li id="2012-12-11">
								...
								<c:if test="${(content != null && not empty content) || (issueLogAttachFilesMap[id] != null && fn:length(issueLogAttachFilesMap[id])>0 )}">
			                        <div class="smallText" style="word-wrap:break-word;overflow:hidden;">
											<span>工作措施:</span><span>${content }</span><br>
											<span>交流地点:</span><span>${address }</span><br>
											<span>参与人:</span><span>${joinMen }</span>
									</div>
