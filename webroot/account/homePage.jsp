...
function queryHomePageNeedDoCount(){
	// 待办数统计
	var issueTypes = [];
	$("#tabList a").each(function(){
		issueTypes.push($(this).attr("href").split("&issueType=")[1]);
	});
	$.get("${path}/threeRecordsIssue/ledgerAccountReportManage/queryHomePageNeedDoCount.action",{"issueTypes":issueTypes.join(","),"orgId":getCurrentOrgId()},function(countMap){
