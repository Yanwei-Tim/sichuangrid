	...
	<form id="maintainAccountLogsForm" method="post" action="" >
		...
		<div class="grid_4 lable-right">
   		...
   		<div class="grid_18" style="height: 120px">
   			<textarea rows="4" name="accountLogs.content" id="content" style="width: 99%" class='form-txt {required:true,maxlength:300,messages:{required:"工作措施及内容必须输入",maxlength:"工作措施及内容最多需要输入300个字符"}}' 
		...
		<div id="finishTypeDiv11">
            ...
            <div class="multipeSelectCtt" id="zcfUl" dataId='zcf'>
                ...
                <label><input id="zcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@REALCOMPLETE'/>">实质办结</label>
            ...
            <div class="multipeSelectCtt" id="fcfUl"  dataId='fcf'>
                ...
                <label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@ITEM'/>">落实帮扶</label>
                <label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@IMPLEMENT'/>">整合项目</label>
                <label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@INTEGRATE_PROJECT'/>">纳入项目库</label>
                ...
                <label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@REPORT_TO_LIFE'/>" disabled>呈报市民生工作台账办公室</label>
...
var REPORT_TO_LIFE="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@REPORT_TO_LIFE'/>";
