...
<div class="container container_24" >
	<form id="maintainAccountLogsForm" method="post" action="" >
		...
		<div class="grid_4 lable-right">
   		...
   		<div class="grid_4 lable-right" >
   			<em class="form-req">*</em>
   			<label class="form-lb1">帮扶措施及落实情况：</label>
   		</div>
   		<div class="grid_18" style="height: 120px">
   			<textarea rows="4" name="accountLogs.content" id="content" style="width: 99%" class='form-txt {required:true,maxlength:300,messages:{required:"帮扶措施及落实情况",maxlength:"帮扶措施及落实情况最多需要输入300个字符"}}' 
		...
		<div id="finishTypeDiv11">
            ...
            <div class="multipeSelectCtt" id="zcfUl" dataId='zcf'>
                ...
                <label><input id="zcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@REAL_SOLVE_TROUBLE'/>">实质性解决困难</label>
				<label><input id="zcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@NOT_POOR'/>">脱贫</label>
				<label><input id="zcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@LOW_INDEMNITY'/>">纳入低保</label>
				<label><input id="zcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@FIVE_INDEMNITY'/>">纳入五保</label>
				<label><input id="zcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@QUESTIONEND'/>">问题中止</label>
				</div>
            </div>

            <div class="multipeSelectCtt" id="fcfUl"  dataId='fcf'>
                <div class="propertyMulSelect">
                <label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@POLICYSOLUTION'/>">政策解答</label>
				<label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@ITEM'/>">纳入项目库</label>
				...
				<label><input id="fcfRadio" name="accountLogs.finishType" type="radio" value="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@REPORT_TO_OFFICE'/>" disabled>呈报困难群众台账办公室</label>
...
var REPORT_TO_OFFICE="<s:property value='@com.tianque.xichang.working.flow.constant.FinishType@REPORT_TO_OFFICE'/>";
	        ...
	        $(form).ajaxSubmit({
				success: function(data){
					if('add'=='<s:property value="#parameters.mode[0]"/>'){
						...
						//$("#poorPeopleDialog").dialog("close");
						$("div[id='accountLogsDialog']").dialog("close");
