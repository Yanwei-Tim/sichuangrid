...
<style>
.accountType{overflow:auto;}
.countlist td{border-right:1px solid;border-bottom:1px solid;}
.countlist th{border:1px solid;border-top:1px solid;}
.countlist td,.countlist th{text-align:center;font-size:12px;font-weight:normal;line-height:24px;}
.countlist .delleft{border-left:none;}
.countlist .deltop{border-top:none;}
</style>
...
<table width="100%" cellspacing="0" class="countlist">
  <tr>
    ...
    <th height="24" colspan="11" scope="col" class="delleft">诉求类别</th>
  </tr>
  <tr>
    <td width="67" height="25">水利类</td>
    <td width="55">交通类</td>
    <td width="58">能源类</td>
    <td width="72">教育科技类</td>
    <td width="48">文体类</td>
    <td width="70">医疗卫生类</td>
    <td width="110">劳动和社会保障类</td>
    <td width="79">环境保护类</td>
    <td width="101">城乡规划建设与管理类</td>
    <td width="61">农业类</td>
    <td width="71">其他</td>
  </tr>
  <tr>
