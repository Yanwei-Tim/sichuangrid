...
<div class="accountType">
	<table width="100%" cellspacing="0"  class="countlist">
	  <tr class="countlistHead">
	    ...
	    <th width="101" rowspan="2" scope="col" class="delleft">合计</th>
	  ...
	  <tr class="rowCount">
	    <th width="25" rowspan="5" scope="row" class="deltop">村、社区累计</th>
	  ...
	  <tr class="rowCount">
	    <td width="18" rowspan="3">其中</td>
	    <td width="90">实质性办结数</td>
	  </tr>
	  <tr class="rowCount">
	    <td>程序性办结数</td>
	  </tr>
	  ...
	  <tr class="rowCount">
	    <th rowspan="7" scope="row" class="deltop">村、社区本月合计</th>
...
function getReportType(){
	return "<s:property value='@com.tianque.xichang.working.report.constant.ReportType@VILLAGEMOULD'/>"
}
</script>
