...
<div class="accountType">
	<table width="100%" cellspacing="0" class="countlist">
	  ...
	  <tr class="rowCount">
	    <th width="82" rowspan="4" scope="row" class="deltop">全市本月建账</th>
	  ...
	  <tr class="rowCount">
	    <th rowspan="8" class="deltop" scope="row">全市本月办结</th>
	    <td colspan="3" class="deltop" scope="row">合计</td>
	  </tr>
	  <tr class="rowCount">
...
function getReportType(){
	return "<s:property value='@com.tianque.xichang.working.report.constant.ReportType@XICHANG_THREE_MOULD'/>";
}
</script>