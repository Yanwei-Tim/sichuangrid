	...
	$("#searchChildSteadyWork").click(function(event){
		...
		$("#steadyWorkDialog").createDialog({
			...
			title:'稳定工作台账表查询-请输入查询条件',
 	 		url:'${path}/xichang/working/steadyWork/maintainSearchSteadyWorkDlg.jsp?type=done&orgId='+TREE_ORG_ID+'&state='+1+"&displayLevel="+$("#displayLevel").val(),
			buttons: {
		   		"查询" : function(event){
					searchSteadyWork();
		        	$(this).dialog("close");
