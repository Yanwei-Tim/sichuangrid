...
<table id='tb' class="tb" border=0 cellpadding=0 cellspacing=0 style='margin:10px 10px;border-collapse:collapse;table-layout:fixed;width:703pt'>
	<s:if test='"add".equals(mode)'>
	<tr>
		<td colspan=10 height=44 id="reportName" class=head style='text-align:center;border:0px;height:33.0pt;font-size:25px; font-weight:bold;'>${dailyYear.name}年<span id="selectedMonthForCity"></span>${organization.orgName}矛盾纠纷排查情况表</td>
	</tr>
	</s:if>
	<s:else>
		<tr>
			<td colspan=10 height=44 id="reportName" class=head style='text-align:center;border:0px;height:33.0pt;font-size:25px; font-weight:bold;'>${disputEsexamine.name}</td>
		</tr>
		</s:else>
	<tr>
		...
		<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@MONTH_REPORT">
			<td colspan=5 class=head style="border:0px; border-bottom:1px solid gray; text-align:right;margin-right:20px;">填报月份：
	  	...
	  	<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@QUARTER_REPORT">
		  	<td colspan=5 class=head style="border:0px; border-bottom:1px solid gray; text-align:right;margin-right:20px;">填报季度：
			  	<select id="reportTime" <s:if test='!"add".equals(mode)'>disabled="disabled"</s:if>>
					<s:iterator value="dateMap" id="date" >
					    <s:property value="#date"/>
						<option value='<s:property value="key"/>'><s:property value="value"/></option>
	  	...
	  	<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@SEMIYEARLY_REPORT">
		  	<td colspan=5 class=head style="border:0px; border-bottom:1px solid gray; text-align:right;margin-right:20px;">填报半年度：
			  	<select id="reportTime" <s:if test='!"add".equals(mode)'>disabled="disabled"</s:if>>
	  	...
	  	<s:if test="reportTypeInternalId==@com.tianque.domain.property.DirectoryReportType@YEAR_REPORT">
		  	<td colspan=5 class=head style="border:0px; border-bottom:1px solid gray; text-align:right;margin-right:20px;">填报年度：
	...
	<tr id='c_0_' >
		...
		<td name="totalCityFinishcount" yearCountTarget="totalYearFinishcount" finishRateMolecule="totalCityFinishrate-molecule" class="toDataJosn" countName="totalUnFinishcount-data" countTarget="totalUnFinishcount">${disputEsexamine.totalCityFinishcount}</td>
	...
	<tr id='c_406_' >
		...
		<td class=label  >排查数</td>
		<td name="religionCityIssuecount" yearCountTarget="religionYearIssuecount" class="toDataJosn" countName="religionUnIssuecount-data" countTarget="religionUnIssuecount">${disputEsexamine.religionCityIssuecount}</td>
	...
	<tr id='c_406_' >
		...
		<td class=label >调处数</td>
		<td name="religionCityDealcount" yearCountTarget="religionYearDealcount" class="toDataJosn" countName="religionUnDealcount-data" countTarget="religionUnDealcount">${disputEsexamine.religionCityDealcount}</td>
	...
	<tr id='c_407_' >
		...
		<td class=label >排查数</td>
		<td name="soldierCityIssuecount" yearCountTarget="soldierYearIssuecount" class="toDataJosn"  countName="soldierUnIssuecount-data" countTarget="soldierUnIssuecount">${disputEsexamine.soldierCityIssuecount}</td>
	...
	<tr id='c_407_' >
		...
		<td class=label >调处数</td>
		<td name="soldierCityDealcount" yearCountTarget="soldierYearDealcount" class="toDataJosn"  countName="soldierUnDealcount-data" countTarget="soldierUnDealcount">${disputEsexamine.soldierCityDealcount}</td>
	...
	<tr id='c_408_' >
		...
		<td class=label >排查数</td>
		<td name="removeCityIssuecount" yearCountTarget="removeYearIssuecount" class="toDataJosn"  countName="removeUnIssuecount-data" countTarget="removeUnIssuecount">${disputEsexamine.removeCityIssuecount}</td>
	...
	<tr id='c_408_' >
		...
		<td class=label >调处数</td>
		<td name="removeCityDealcount" yearCountTarget="removeYearDealcount" countName="removeUnDealcount-data" countTarget="removeUnDealcount" class="toDataJosn">${disputEsexamine.removeCityDealcount}</td>
	...
	<tr id='c_409_' >
		...
		<td class=label >排查数</td>
		<td name="assetsCityIssuecount" yearCountTarget="assetsYearIssuecount" countName="assetsUnIssuecount-data" countTarget="assetsUnIssuecount" class="toDataJosn">${disputEsexamine.assetsCityIssuecount}</td>
	...
	<tr id='c_409_' >
		...
		<td class=label >调处数</td>
		<td name="assetsCityDealcount" yearCountTarget="assetsYearDealcount" countName="assetsUnDealcount-data" countTarget="assetsUnDealcount" class="toDataJosn">${disputEsexamine.assetsCityDealcount}</td>
	...
	<tr id='c_410_' >
		...
		<td class=label >排查数</td>
		<td name="landBoundariesCityIssuecount" yearCountTarget="landBoundariesYearIssuecount" countName="landBoundariesUnIssuecount-data" countTarget="landBoundariesUnIssuecount" class="toDataJosn">${disputEsexamine.landBoundariesCityIssuecount}</td>
	...
	<tr id='c_410_' >
		...
		<td class=label >调处数</td>
		<td name="landBoundariesCityDealcount" yearCountTarget="landBoundariesYearDealcount" countName="landBoundariesUnDealcount-data" countTarget="landBoundariesUnDealcount" class="toDataJosn" >${disputEsexamine.landBoundariesCityDealcount}</td>
	...
	<tr id='c_411_' >
		...
		<td class=label >排查数</td>
		<td name="economyCityIssuecount" yearCountTarget="economyYearIssuecount" countName="economyUnIssuecount-data" countTarget="economyUnIssuecount" class="toDataJosn">${disputEsexamine.economyCityIssuecount}</td>
	...
	<tr id='c_411_' >
		...
		<td class=label >调处数</td>
		<td name="economyCityDealcount" yearCountTarget="economyYearDealcount" countName="economyUnDealcount-data" countTarget="economyUnDealcount" class="toDataJosn">${disputEsexamine.economyCityDealcount}</td>
	...
	<tr id='c_412_' >
		...
		<td class=label >排查数</td>
		<td name="labourCityIssuecount" yearCountTarget="labourYearIssuecount" countName="labourUnIssuecount-data" countTarget="labourUnIssuecount" class="toDataJosn">${disputEsexamine.labourCityIssuecount}</td>
	...
	<tr id='c_412_' >
		...
		<td class=label >调处数</td>
		<td name="labourCityDealcount" yearCountTarget="labourYearDealcount" countName="labourUnDealcount-data" countTarget="labourUnDealcount" class="toDataJosn">${disputEsexamine.labourCityDealcount}</td>
	...
	<tr id='c_413_' >
		...
		<td class=label >排查数</td>
		<td name="ltdCityIssuecount" yearCountTarget="ltdYearIssuecount" countName="ltdUnIssuecount-data" countTarget="ltdUnIssuecount" class="toDataJosn">${disputEsexamine.ltdCityIssuecount}</td>
	...
	<tr id='c_413_1' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="ltdYearDealcount" name="ltdCityDealcount" countName="ltdUnDealcount-data" countTarget="ltdUnDealcount">${disputEsexamine.ltdCityDealcount}</td>
	...
	<tr id='c_414_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="environYearIssuecount" name="environCityIssuecount" countName="environUnIssuecount-data" countTarget="environUnIssuecount">${disputEsexamine.environCityIssuecount}</td>
	...
	<tr id='c_414_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="environYearDealcount" name="environCityDealcount" countName="environUnDealcount-data" countTarget="environUnDealcount">${disputEsexamine.environCityDealcount}</td>
	...
	<tr id='c_415_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="judicialYearIssuecount" name="judicialCityIssuecount" countName="judicialUnIssuecount-data" countTarget="judicialUnIssuecount">${disputEsexamine.judicialCityIssuecount}</td>
	...
	<tr id='c_415_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="judicialYearDealcount" name="judicialCityDealcount" countName="judicialUnDealcount-data" countTarget="judicialUnDealcount">${disputEsexamine.judicialCityDealcount}</td>
	...
	<tr id='c_416_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn"  yearCountTarget="adminYearIssuecount" name="adminCityIssuecount" countName="adminUnIssuecount-data" countTarget="adminUnIssuecount">${disputEsexamine.adminCityIssuecount}</td>
	...
	<tr id='c_416_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="adminYearDealcount" name="adminCityDealcount" countName="adminUnDealcount-data" countTarget="adminUnDealcount">${disputEsexamine.adminCityDealcount}</td>
	...
	<tr id='c_417_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="schoolYearIssuecount" name="schoolCityIssuecount" countName="schoolUnIssuecount-data" countTarget="schoolUnIssuecount">${disputEsexamine.schoolCityIssuecount}</td>
	...
	<tr id='c_417_1' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="schoolYearDealcount" name="schoolCityDealcount" countName="schoolUnDealcount-data" countTarget="schoolUnDealcount">${disputEsexamine.schoolCityDealcount}</td>
	...
	<tr id='c_418_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="seaYearIssuecount" name="seaCityIssuecount" countName="seaUnIssuecount-data" countTarget="seaUnIssuecount">${disputEsexamine.seaCityIssuecount}</td>
	...
	<tr id='c_418_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="seaYearDealcount" name="seaCityDealcount" countName="seaUnDealcount-data" countTarget="seaUnDealcount">${disputEsexamine.seaCityDealcount}</td>
	...
	<tr id='c_419_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="cadreYearIssuecount" name="cadreCityIssuecount" countName="cadreUnIssuecount-data" countTarget="cadreUnIssuecount">${disputEsexamine.cadreCityIssuecount}</td>
	...
	<tr id='c_419_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="cadreYearDealcount" name="cadreCityDealcount" countName="cadreUnDealcount-data" countTarget="cadreUnDealcount">${disputEsexamine.cadreCityDealcount}</td>
	...
	<tr id='c_420_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="vilthYearIssuecount" name="vilthCityIssuecount" countName="vilthUnIssuecount-data" countTarget="vilthUnIssuecount">${disputEsexamine.vilthCityIssuecount}</td>
	...
	<tr id='c_420_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="vilthYearDealcount" name="vilthCityDealcount" countName="vilthUnDealcount-data" countTarget="vilthUnDealcount">${disputEsexamine.vilthCityDealcount}</td>
	...
	<tr id='c_421_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="jobYearIssuecount" name="jobCityIssuecount" countName="jobUnIssuecount-data" countTarget="jobUnIssuecount">${disputEsexamine.jobCityIssuecount}</td>
	...
	<tr id='c_421_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="jobYearDealcount" name="jobCityDealcount" countName="jobUnDealcount-data" countTarget="jobUnDealcount">${disputEsexamine.jobCityDealcount}</td>
	...
	<tr id='c_422_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="familyYearIssuecount" name="familyCityIssuecount" countName="familyUnIssuecount-data" countTarget="familyUnIssuecount">${disputEsexamine.familyCityIssuecount}</td>
	...
	<tr id='c_422_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="familyYearDealcount" name="familyCityDealcount" countName="familyUnDealcount-data" countTarget="familyUnDealcount">${disputEsexamine.familyCityDealcount}</td>
	...
	<tr id='c_423_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="patientYearIssuecount" name="patientCityIssuecount" countName="patientUnIssuecount-data" countTarget="patientUnIssuecount">${disputEsexamine.patientCityIssuecount}</td>
	...
	<tr id='c_423_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="patientYearDealcount" name="patientCityDealcount" countName="patientUnDealcount-data" countTarget="patientUnDealcount">${disputEsexamine.patientCityDealcount}</td>
	...
	<tr id='c_424_' >
		...
		<td class=label >排查数</td>
		<td class="toDataJosn" yearCountTarget="otherYearIssuecount" name="otherCityIssuecount" countName="otherUnIssuecount-data" countTarget="otherUnIssuecount">${disputEsexamine.otherCityIssuecount}</td>
	...
	<tr id='c_424_' >
		...
		<td class=label >调处数</td>
		<td class="toDataJosn" yearCountTarget="otherYearDealcount" name="otherCityDealcount" countName="otherUnDealcount-data" countTarget="otherUnDealcount">${disputEsexamine.otherCityDealcount}</td>
	...
	<tr id='c_425_' >
		...
		<td class="toDataJosn" yearCountTarget="issuelowYearStagescount" name="issuelowCityStagescount" countName="issuelowUnStagescount-data" countTarget="issuelowUnStagescount">${disputEsexamine.issuelowCityStagescount}</td>
	...
	<tr id='c_426_' >
		...
		<td class=label >起数</td>
		<td class="toDataJosn" yearCountTarget="issuemidYearStagescount" name="issuemidCityStagescount" countName="issuemidUnStagescount-data" countTarget="issuemidUnStagescount">${disputEsexamine.issuemidCityStagescount}</td>
	...
	<tr id='c_427_' >
		...
		<td class=label >起数</td>
		<td class="toDataJosn" yearCountTarget="issuehighYearStagescount" name="issuehighCityStagescount" countName="issuehighUnStagescount-data" countTarget="issuehighUnStagescount">${disputEsexamine.issuehighCityStagescount}</td>
	...
	<tr id='c_428_' >
		...
		<td class=label >起数</td>
		<td name="issuehigherCityStagescount" class="toDataJosn" yearCountTarget="issuehigherYearStagescount" countName="issuehigherUnStagescount-data" countTarget="issuehigherUnStagescount">${disputEsexamine.issuehigherCityStagescount}</td>
		<td name="issuehigherCountyStagescount" class="toDataJosn" yearCountTarget="issuehigherYearStagescount" countName="issuehigherUnStagescount-data" countTarget="issuehigherUnStagescount">${disputEsexamine.issuehigherCountyStagescount}</td>
		<td name="issuehigherTwonStagescount" class="toDataJosn" yearCountTarget="issuehigherYearStagescount" countName="issuehigherUnStagescount-data" countTarget="issuehigherUnStagescount">${disputEsexamine.issuehigherTwonStagescount}</td>
		<td name="issuehigherVilStagescount" class="toDataJosn" yearCountTarget="issuehigherYearStagescount" countName="issuehigherUnStagescount-data" countTarget="issuehigherUnStagescount">${disputEsexamine.issuehigherVilStagescount}</td>
	...
	<tr id='c_429_' >
		...
		<td class=label >排查数</td>
		<td name="imptCityImptIssuecount" class="toDataJosn" yearCountTarget="imptYearImptIssuecount" countName="imptUnImptIssuecount-data" countTarget="imptUnImptIssuecount">${disputEsexamine.imptCityImptIssuecount}</td>
	...
	<tr id='c_429_' >
		...
		<td class=label >调处数</td>
		<td name="imptCityImptDealcount" class="toDataJosn" yearCountTarget="imptYearImptDealcount" countName="imptUnImptDealcount-data" countTarget="imptUnImptDealcount">${disputEsexamine.imptCityImptDealcount}</td>
	...
	<tr id='c_429_' >
		...
		<td class=label >成功数</td>
		<td name="imptCityImptFinishcount" class="toDataJosn" yearCountTarget="imptYearImptFinishcount" countName="imptUnImptFinishcount-data" countTarget="imptUnImptFinishcount">${disputEsexamine.imptCityImptFinishcount}</td>
	...
	<tr id='c_430_'>
		...
		<td name="concentrateCityFinishcount" class="toDataJosn" yearCountTarget="concentrateYearFinishcount" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateCityFinishcount}</td>
		<td name="concentrateCountyFinishcount" class="toDataJosn" yearCountTarget="concentrateYearFinishcount" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateCountyFinishcount}</td>
		<td name="concentrateTwonFinishcount" class="toDataJosn" yearCountTarget="concentrateYearFinishcount" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateTwonFinishcount}</td>
		<td name="concentrateVilFinishcount" class="toDataJosn" yearCountTarget="concentrateYearFinishcount" countName="concentrateUnFinishcount-data" countTarget="concentrateUnFinishcount">${disputEsexamine.concentrateVilFinishcount}</td>
	...
	<tr height=37 >
		...
		<td colspan=4 class=bottom>四川省社会治安综合治理委员会办公室制</td>
	</tr>
	<tr>
