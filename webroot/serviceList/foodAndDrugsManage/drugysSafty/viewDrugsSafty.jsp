...
<tr>
		 ...
		 <td class="content" colspan="3"><span>${drugsSafty.organization.orgName }</span></td>
</tr>
<tr>
...
$(document).ready(function(){
	...
	$("#replyInfos").click(function(){
		...
		if($("#showTaskListReply").html()==""){
			$.get(PATH+"/serviceList/drugsSaftyManage/getReplyList.action",{'sidx':'replydate','sord':'asc','reply.serviceId':$("#drugsSaftyId").val()},function(data){
