...
<div class="content myDivTop taskListContent">
	...
	<div class="zt_tabs_style">
		<div id="chartsTabs">
			<ul>
				<li id="chartsTabs1"><a href="${path }/task/statistics/policeStatisticsColumn.ftl?type=<@s.property value="@com.tianque.domain.property.PropertyTypes@EXCEPTION_SITUATION_TYPE"/>">区域分布图</a></li>
				<li id="chartsTabs2"><a href="${path }/task/statistics/policeStatisticsPie.ftl?type=<@s.property value="@com.tianque.domain.property.PropertyTypes@EXCEPTION_SITUATION_TYPE"/>">类型分布图</a></li>
				<li id="chartsTabs3"><a href="${path }/task/statistics/policeStatisticsTrend.ftl?type=<@s.property value="@com.tianque.domain.property.PropertyTypes@EXCEPTION_SITUATION_TYPE"/>">趋势图</a></li>
			</ul>
		</div>
	</div>
	<!-- zt_tabs_style -->
