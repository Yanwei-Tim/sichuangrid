   ...
   <@pop.JugePermissionTag ename="importantOrganizationStat">
	...
	<ul class="subnavbar">
		...
		<li><a href="javascript:void(0)"
			...
			<li><a href="javascript:void(0)"
				onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/baseInfoStat/population/commonPopulation.jsp?populationType=<@s.property value="@com.tianque.core.util.BaseInfoTables@FLOATINGPOPULATION_KEY"/>')"><span>流动人口</span></a></li>
			<li><a href="javascript:void(0)"
				onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/baseInfoStat/population/commonPopulation.jsp?populationType=<@s.property value="@com.tianque.core.util.BaseInfoTables@HOUSEHOLDSTAFF_KEY"/>')"><span>户籍人口</span></a></li>
			<li><a href="javascript:void(0)"
				onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/baseInfoStat/population/commonPopulation.jsp?populationType=<@s.property value="@com.tianque.core.util.BaseInfoTables@UNSETTEDPOPULATION_KEY"/>')"><span>未落户人口</span></a></li>
			<li><a href="javascript:void(0)"
...
<@pop.JugePermissionTag ename="importantPersonelStat_stat">
	<ul class="subnavbar">
		<@pop.JugePermissionTag ename="importantPersonelStat_stat">
			...
			<li><a href="javascript:void(0)"
				onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/baseInfoStat/positiveinfo/index.jsp')"><span>刑释人员</span></a></li>
			<li><a href="javascript:void(0)"
...
<@pop.JugePermissionTag ename="importantHouseStat_stat">
	<ul class="subnavbar">
			...
			<li><a href="javascript:void(0)"
				onclick="asyncMiddleLevelOpen(this,'${path}/statAnalyse/baseInfoStat/actualHouse/index.jsp')"><span>房屋信息</span></a></li>
	</ul>
</@pop.JugePermissionTag>
