...
<div class="zt_tabs_style">
	<div id="chartsTabs">
	<ul>
		<li><a href="${(path)!}/statAnalyse/baseInfoStat/doubleNewOrganizations/newEconomicOrganization/economicColumn.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@NEW_ECONOMIC"/>">区域分布图</a></li>

		<li><a href="${(path)!}/statAnalyse/baseInfoStat/doubleNewOrganizations/newEconomicOrganization/economicList.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@NEW_ECONOMIC"/>">列表信息</a></li>
