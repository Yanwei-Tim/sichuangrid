...
function onOrgChanged(){
	$("#positiveinfoPie").pieChart({
		url:"${path}/baseInfoStat/statisticsPopulation/getStatisticsPopulationPie.action?orgId="+getCurrentOrgId()+"&year="+$("#queryYear").val()+"&month="+$("#queryMonth").val()+"&populationType=<@s.property value='#parameters.populationType'/>",
