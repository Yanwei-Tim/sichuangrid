...
<div id="chartsTabs">
	<ul>
		<li><a href="${path }/statAnalyse/baseInfoStat/population/commonPopylationColumn.ftl">区域分布图</a></li>
		<li><a href="${path }/statAnalyse/baseInfoStat/population/statisticsPopulationPie.ftl">类型分布图</a></li>
		<li><a href="${path }/statAnalyse/baseInfoStat/population/populationList.ftl">列表信息</a></li>
