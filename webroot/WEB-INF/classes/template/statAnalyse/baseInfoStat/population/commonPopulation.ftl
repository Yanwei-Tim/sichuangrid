...
<@s.include value="/common/orgSelectedComponent.jsp"/>
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyse/baseInfoStat/population/commonPopylationColumn.ftl?populationType=<@s.property value='#parameters.populationType[0]'/>">区域分布图</a></li>
			<@s.if test='#parameters.populationType[0]=="householdStaff"'>
			<li><a href="${path }/statAnalyse/baseInfoStat/population/statisticsPopulationInfoPie.ftl?populationType=<@s.property value='#parameters.populationType[0]'/>">类型分布图</a></li>
			</@s.if>
			<li><a href="${path }/statAnalyse/baseInfoStat/population/populationList.ftl?populationType=<@s.property value='#parameters.populationType[0]'/>">列表信息</a></li>
			<li><a href="${path }/statAnalyse/baseInfoStat/population/tendencyChartForPopulation.ftl?tableNameKey=
