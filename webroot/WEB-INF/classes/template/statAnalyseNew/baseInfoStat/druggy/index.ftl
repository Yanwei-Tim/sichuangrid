...
<div class="zt_tabs_style">
	<div id="chartsTabs">
		<ul>
			<li><a href="${path }/statAnalyseNew/baseInfoStat/druggy/druggyPersonColumnList.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@DRUGGY"/>">区域分布图</a></li>
			<li><a href="${path }/statAnalyseNew/baseInfoStat/druggy/druggyPersonPieList.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@DRUGGY"/>">类型分布图</a></li>
			<li><a href="${path }/statAnalyseNew/baseInfoStat/druggy/druggyCountList.ftl?type=<@s.property value="@com.tianque.service.util.PopulationType@DRUGGY"/>">列表信息</a></li>
