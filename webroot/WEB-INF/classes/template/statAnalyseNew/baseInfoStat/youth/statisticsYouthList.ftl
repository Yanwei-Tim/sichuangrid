...
function onOrgChanged(){
	$.ajax({
		url:'${path}/baseInfo/statisticManageNew/getBaseInfoStatisticList.action?domainName='+encodeURI($("#queryBygroup").val())+'&orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=<@s.property value="@com.tianque.service.util.PopulationType@ALL_YOUTH_POPULATION"/>",
...
$(document).ready(function(){
	...
	$("#createStatistic").click(function(){
		$.ajax({
			url:'/baseInfo/statisticManageNew/createHistoryStatistic.action?orgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=<@s.property value="@com.tianque.service.util.PopulationType@ALL_YOUTH_POPULATION"/>",
	...
	$(".print").click(function(){
		$("#<@s.property value="@com.tianque.service.util.PopulationType@ALL_YOUTH_POPULATION"/>PrintDlg").createDialog({
			...
			url:'${path}/statAnalyseNew/baseInfoStat/common/commonStatisticPrint.ftl?parentOrgId='+getCurrentOrgId()+"&year="+$("#year").val()+"&month="+$("#month").val()+"&type=<@s.property value="@com.tianque.service.util.PopulationType@ALL_YOUTH_POPULATION"/>&moduleName="+document.title,
			buttons: {
			   "打印" : function(){
				print();
		  	   },
