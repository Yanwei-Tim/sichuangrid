...
function onOrgChanged(){
	$("#idleyouthPie").pieChart({
		url:"${path}/baseInfo/statisticManageNew/getStatisticPie.action?orgId="+getCurrentOrgId()+"&year="+$("#iqueryYear").val()+"&month="+$("#iqueryMonth").val()+"&type=<@s.property value='#parameters.type'/>&domainName=闲散青少年人员类型",
