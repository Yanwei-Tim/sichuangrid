...
var title = "学校";	
		jQuery(document).ready(function() {		
			...
			$("#searchHighA").click(function(){
				$("#statisticsDialog").createDialog({
					...
					modal:true,
					url: '${(path)!}/baseinfo/siteinfo/school/searchSchool.jsp',
					buttons: {
						"查询" : function(event){
			...
			$("#refreshOrgTree1").click(function(){
				...
				$("#searchByPlaceName").attr("value","请输入学校名称");
			});
			var layout=function(){
		...
		function getDialogParam(isSearch){
			return {
				...
				title: title+'信息',
				modal:true,
				url: '${(path)!}/baseinfo/siteinfo/school/schoolListForStatistics.jsp?isSearch='+isSearch,
				buttons: {
			   		"关闭" : function(){
			        	$(this).dialog("close");
			   		}
...
<div class="btnbanner">
	...
	<div class="ui-widget autosearch">
		<input type="text" value="请输入学校名称" class="searchtxt" id="searchByPlaceName" style="width:215px;" maxlength="18" onfocus="if(this.value == '请输入学校名称') this.value = '';" onblur="if(this.value == '') this.value = '请输入学校名称';">
