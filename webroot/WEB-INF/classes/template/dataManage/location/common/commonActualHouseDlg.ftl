...
<@s.include value="/includes/baseInclude.jsp"/>
		<input type="hidden" id="tempClassName" value="${tempClassName}" />
		<input type="hidden" id="targetClaimOrgId" value="${(targetClaimOrgId)!}" />
		...
		<div class="grid_4 lable-right">
 		...
 		<div class="grid_4 lable-right">
 			...
 			<div class="grid_10">
				...
				class="form-txt {isCodeValidate:true,isHouseCodeExist:true,messages:{isCodeValidate:'只能输入英文和数字',isHouseCodeExist:'此房屋编号已经存在'}}" />
 			</div>
 		<@s.if test='"actualHouseTempDialog".equals(#parameters.dailogName[0])'>
	 		<input type="checkbox" style="display: none;" id="isRentalHouse"  name="houseInfo.isRentalHouse" value="false" />
 		</@s.if>
 		<@s.else>
 		...
 		<div class="grid_4 lable-right">
				<em class="form-req">*</em>
				<label class="form-lb1">房屋准确地址：</label>
		</div>
			...
			<div id="building" >
	 			<div class="grid_3">
	 			 	<input type="text"   id="community"  name="houseInfo.community"  maxlength="20"  value="${(houseInfo.community)!}" style="width: 93%"
	 			 		class="form-txt {community:true,messages:{community:'该房屋准确地址不存在，请重新输入房屋编号'}}" />
	 			</div>
	 			<div class="grid_3">
	 	   		 	<label class="form-lbl">小区</label>
	 			</div>
	 			<div class="grid_2">
		 			<input type="text"  id="block"   name="houseInfo.block"  maxlength="8"  value="${(houseInfo.block)!}" style="width: 93%"	class="form-txt" />
	 			</div>
	 			<div class="grid_1">
	 		     	<label class="form-lbl">幢</label>
	 			</div>
	 			<div class="grid_2">
	 			 	<input type="text"  id="unit"  name="houseInfo.unit"  maxlength="6"  value="${(houseInfo.unit)!}" style="width: 93%"	class="form-txt" />
	 			</div>
	 			<div class="grid_2">
	 		 	 	<label class="form-lbl">单元</label>
	 			</div>
	 			<div class="grid_2">
	 			 	<input type="text"  id="room"   name="houseInfo.room"  maxlength="10"  value="${(houseInfo.room)!}" style="width: 93%"	class="form-txt" />
	 			</div>
	 			<div class="grid_1">
			...
			<div class="grid_8">
				<input type="text"  id="_address"   name="houseInfo.address"  maxlength="50"  value="${(houseInfo.address)! }"
					class="form-txt {address:true,messages:{address:'请输入房屋准确地址'}}" />
			</div>
			<div class="grid_4 lable-right">
				<label class="form-lb1">房产证地址：</label>
			</div>
			<div class="grid_8">
				<input type="text" name="houseInfo.houseAddress" id="houseAddress" maxlength="100" value="${(houseInfo.houseAddress)!}"
					class="form-txt {exculdeParticalChar:true,minlength:2,maxlength:100,messages:{exculdeParticalChar:'不能输入非法字符',minlength:'房产证地址至少需要输入2个字符',maxlength:'房产证地址最多需要输入100个字符'}}" />
			</div>
			<div class='clearLine'>&nbsp;</div>
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.buildingName" id="buildingName" maxlength="100" value="${(houseInfo.buildingName)!}"
					class="form-txt {exculdeParticalChar:true,minlength:2,maxlength:100,messages:{exculdeParticalChar:'不能输入非法字符',minlength:'建筑物名称至少需要输入2个字符',maxlength:'建筑物名称最多需要输入100个字符'}}" />
			</div>
			<div class="grid_4 lable-right">
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.propertyName" id="propertyName" maxlength="100" value="${(houseInfo.propertyName)!}"
					class="form-txt {exculdeParticalChar:true,minlength:2,maxlength:100,messages:{exculdeParticalChar:'不能输入非法字符',minlength:'物业管理单位名称至少需要输入2个字符',maxlength:'物业管理单位名称最多需要输入100个字符'}}" />
			</div>
			<div class="grid_4 lable-right">
				<label class="form-lb1">代表人/业主：</label>
			</div>
			<div class="grid_8">
				<input type="text" name="houseInfo.manager" id="houseOwner" maxlength="30" value="${(houseInfo.manager)!}"
					class="form-txt {exculdeParticalChar:true,minlength:2,maxlength:30,messages:{exculdeParticalChar:'不能输入非法字符',minlength:'代表人或业主至少需要输入2个字符',maxlength:'代表人或业主最多需要输入30个字符'}}" />
			</div>
			<div class='clearLine'>&nbsp;</div>
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.houseOwnerIdCardNo" id="houseOwnerIdCardNo" maxlength="18" value="${(houseInfo.houseOwnerIdCardNo)!}"
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.telephone" id="telephone" maxlength="20" value="${(houseInfo.telephone)!}" title="请输入由数字和-组成的联系电话,例如：0577-88888888或者88888888"
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.houseDoorModel" id="houseDoorModel" maxlength="30" value="${(houseInfo.houseDoorModel)!}"
				 	class="form-txt {minlength:2,maxlength:50,messages:{minlength:'房屋户型至少需要输入2个字符',maxlength:'房屋户型最多需要输入30个字符'}}" />
			</div>
			<div class="grid_4 lable-right">
				<label class="form-lb1">建成年份：</label>
			</div>
			<div class="grid_8">
				<input type="text" name="houseInfo.builtYear" id="builtYear" maxlength="4" value="${(houseInfo.builtYear)!}"
			...
			<div class="grid_4 lable-right">
				<label class="form-lb1"><@s.if test="'rentalHouseTempDialog'==#parameters.dailogName[0]">出租房面积</@s.if><@s.else>本户建筑面积</@s.else>：</label>
			</div>
			<div class="grid_7">
				<input type="text" name="houseInfo.houseArea" id="houseArea" maxlength="15" value="${(houseInfo.houseArea)!}"
					class="form-txt {decimal:true,range:[0,9999999.99],messages:{decimal:'请输入非负数 ，保留两位位小数点',range: '请输入0至9999999.99之间的非负数 '}}" maxlength="10" />
			</div><div class="grid_1">m<sup>2</sup></div>
			<div class="grid_4 lable-right">
				<label class="form-lb1"><@s.if test="'rentalHouseTempDialog'==#parameters.dailogName[0]">出租房结构</@s.if><@s.else>房屋结构</@s.else>：</label>
			</div>
			<div class="grid_8">
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.houseRightNumber" id="houseRightNumber" maxlength="50" value="${(houseInfo.houseRightNumber)!}"
					class="form-txt {minlength:2,maxlength:80,messages:{minlength:'房屋权证号至少需要输入2个字符',maxlength:'房屋权证号最多需要输入80个字符'}}" />
			</div>
			<div class='clearLine'>&nbsp;</div>
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.landRightsNumbe" id="landRightsNumbe" maxlength="30" value="${(houseInfo.landRightsNumbe)!}"
					class="form-txt {minlength:2,maxlength:80,messages:{minlength:'土地权证号至少需要输入2个字符',maxlength:'土地权证号最多需要输入30个字符'}}" />
			</div>
			<div class="grid_4 lable-right">
				<label class="form-lb1">发证时间：</label>
			</div>
			<div class="grid_8">
				<input type="text" name="houseInfo.landRightsNumbeDate" id="landRightsNumbeDate" maxlength="50" value="<@s.date name="houseInfo.landRightsNumbeDate" format="yyyy-MM-dd" />"
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.name" id="name" maxlength="20" value="${(houseInfo.name)!}"
					class="form-txt {exculdeParticalChar:true,minlength:2,maxlength:30,messages:{exculdeParticalChar:'不能输入非法字符',minlength:'产权人名称至少需要输入2个字符',maxlength:'产权人名称最多需要输入20个字符'}}" />
			</div>
			<div class='clearLine'>&nbsp;</div>
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.certificateNumbe" id="certificateNumbe" maxlength="20" value="${(houseInfo.certificateNumbe)!}"
					class="form-txt {exculdeParticalChar:true,minlength:2,maxlength:50,messages:{exculdeParticalChar:'不能输入非法字符',minlength:'证件号码至少需要输入2个字符',maxlength:'证件号码最多需要输入20个字符'}}" />
			</div>
			<div class='clearLine'>&nbsp;</div>
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.propertyPersonTel" id="propertyPersonTel" maxlength="20" value="${(houseInfo.propertyPersonTel)!}" title="请输入由数字和-组成的联系电话,例如：0577-88888888或者88888888"
					class='form-txt {telephone:true,messages:{telephone:$.format("固定电话不合法，只能输入数字和横杠（-）")}}' />
			</div>
			<div class="grid_4 lable-right">
			...
			<div class="grid_8">
				<input type="text" name="houseInfo.propertyPersonMobile" id="propertyPersonMobile" maxlength="11" value="${(houseInfo.propertyPersonMobile)!}"
			...
			<div class="grid_20">
				<textarea rows="4" name="houseInfo.remark" id="remark" class="form-txt {minlength:2,maxlength:300,messages:{minlength:'备注至少需要输入2个字符',maxlength:'备注最多需要输入300个字符'}}" style="width: 99%">${(houseInfo.remark)! }</textarea>
			</div>
	...
	function procRentalHouseTab(doc){
		if(doc.attr("checked")){
			...
			$("#"+dialogName).addTabToDialog(
				{
					title:"出租房",
					url:'${path}/plugin/dataManage/${tempClassName}Manage/dispatch.action?mode=updateRentalHouse&dailogName=${tempClassName}Dialog&tempClassName=${tempClassName}&from='+$("#from").val()+'&targetOrgId='+$("#targetClaimOrgId").val(),
					index:1
				}
			)
			if("${id}" == null){
