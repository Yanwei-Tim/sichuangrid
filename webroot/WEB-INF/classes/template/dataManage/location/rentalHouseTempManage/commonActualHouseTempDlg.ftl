...
<div id="dialog-form" title="出租房" class="container container_24">
	<form id="maintainForm" method="post" action="${path}/plugin/dataManage/${tempClassName}Manage/updateLocationTempBase.action">
		...
		<input id="houseInfoId"	type="hidden" name="location.id" value="${(location.id)!}" />
		...
		<div class="grid_4 lable-right">
 		...
 		<div class="grid_18">
 			<@s.if test='"updateRentalHouseTemp".equals(mode)'>
	 			<input type="text"  id="rentalHouseTempOrgName"  name="location.organization.orgName"  readonly  value="${(location.organization.orgName)!}" style="width: 99%"	class="form-txt{isGridOrganization:true,messages:{isGridOrganization:'网格只能属于片组片格'}}" />
 			</@s.if><@s.else>
 				<input type="text"  id="houseInfoOrgName"  name="houseInfo.organization.orgName"  readonly  value="${(location.organization.orgName)!}" style="width: 99%"	class="form-txt" />
 			</@s.else>
 		...
 		<div class="grid_4 lable-right">
			<em class="form-req">*</em>
 			...
 			<div class="grid_10">
				<input type="text" id="houseCode"  name="location.houseCode"  value="${(location.houseCode)!}"  maxlength="50" style="width: 99%"
				class="form-txt {required:true,isCodeValidate:true,isHouseCodeExist:true,messages:{required:'请输入房屋编号',isCodeValidate:'不能输入非法字符',isHouseCodeExist:'此房屋编号已经存在'}}" />
 			</div>
 		...
 		<div class="grid_4 lable-right">
			...
			<div id="building" >
 			<div class="grid_3">
 			 	<input type="text"   id="community"  name="location.community"  maxlength="20"  value="${(location.community)!}" style="width: 93%"
 			 		class="form-txt {community:true,messages:{community:'该房屋地址不存在，请重新输入房屋编号'}}" />
 			</div>
 			<div class="grid_2">
			...
			<div id="otherAddress" class="grid_15" style="display:none">
				<input type="text"  id="address"   name="location.address"  maxlength="50"  value="${(location.address )!}" style="width: 99%"
					class="form-txt {address:true,messages:{address:'请输入房屋地址'}}" />
			</div>
			<div class='clearLine'>&nbsp;</div>
			...
			<div class="grid_7 form-left">
				<input type="text" name="location.buildingName" id="buildingName" maxlength="100" value="${(location.buildingName)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.propertyName" id="propertyName" maxlength="100" value="${(location.propertyName)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.houseOwner" id="houseOwner" maxlength="30" value="${(location.houseOwner)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.houseOwnerIdCardNo" id="houseOwnerIdCardNo" maxlength="18" value="${(location.houseOwnerIdCardNo)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.telephone" id="telephone" maxlength="20" value="${(location.telephone)!}" title="请输入由数字和-组成的联系电话,例如：0577-88888888或者88888888"
			...
			<div class="grid_7">
				<input type="text" name="location.houseDoorModel" id="houseDoorModel" maxlength="30" value="${(location.houseDoorModel)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.builtYear" id="builtYear" maxlength="4" value="${(location.builtYear)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.houseArea" id="houseArea" maxlength="15" value="${(location.houseArea)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.houseRightNumber" id="houseRightNumber" maxlength="50" value="${(location.houseRightNumber)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.landRightsNumbe" id="landRightsNumbe" maxlength="30" value="${(location.landRightsNumbe)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.landRightsNumbeDate" id="landRightsNumbeDate" maxlength="50" value="<@s.date name="location.landRightsNumbeDate" format="yyyy-MM-dd" />"
			...
			<div class="grid_7">
				<input type="text" name="location.name" id="name" maxlength="20" value="${(location.name)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.certificateNumbe" id="certificateNumbe" maxlength="20" value="${(location.certificateNumbe)!}"
			...
			<div class="grid_7">
				<input type="text" name="location.propertyPersonTel" id="propertyPersonTel" maxlength="20" value="${(location.propertyPersonTel)!}" title="请输入由数字和-组成的联系电话,例如：0577-88888888或者88888888"
					class='form-txt {telephone:true,messages:{telephone:$.format("固定电话不合法，只能输入数字和横杠（-）")}}' />
			</div>
			<div class="grid_4 lable-right">
			...
			<div class="grid_7">
				<input type="text" name="location.propertyPersonMobile" id="propertyPersonMobile" maxlength="11" value="${(location.propertyPersonMobile)!}"
