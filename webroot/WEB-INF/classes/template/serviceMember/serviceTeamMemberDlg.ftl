...
<div id="newServiceManageTeam" class="container container_24">
	<form action="${path}/plugin/serviceTeamMemberManage/maintainServiceTeamMember.action?mode=${mode}" method="post" id="serviceTeamMemberForm">
		<@pop.token />
		...
		<div class="grid_3 lable-right">
			<em class="form-req"></em><label class="form-lb1">职位 </label>
		</div>
		<div class="grid_8">
			<input type="text" style="width: 95%" name="serviceTeamMemberBase.job" id="job" value='${(serviceTeamMemberBase.job)!}' class="form-txt" />
		</div>
		<div class="grid_4 lable-right">
			<em class="form-req lable-right" ></em><label class="form-lb1">出生年份 </label>
		</div>
		<div class="grid_8">
			<input type="text" name="serviceTeamMemberBase.birthday" id="birthday" maxlength="32"
			readonly="readonly"  class="form-txt" value='<@s.date name="serviceTeamMemberBase.birthday" format="yyyy-MM-dd" />' />
		</div>
		<div class='clearLine'>&nbsp;</div>
		<div class="grid_3 lable-right">
