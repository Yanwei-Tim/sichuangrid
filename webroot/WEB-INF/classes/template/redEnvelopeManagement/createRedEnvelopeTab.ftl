...
<div class="container_24">
	<form id="createRedEnvelopeForm" method="post" action="${path}/redEnvelopeManage/addRedEnvelope.action">
	<@pop.token />
	<input type="hidden" id="currentOrgIdForRedEnvelope" name="redEnvelope.org.id">
	...
	<div class="grid_6 randomEnvelope">
		<input type="text"  name="redEnvelope.min_value" class='form-txt {required:true,messages:{required:"请输入最小金额"}}' />
	</div>
	...
	<div class="grid_6 randomEnvelope">
		<input type="text"  name="redEnvelope.max_value" class='form-txt {required:true,messages:{required:"请输入最大金额"}}' />
	</div>
	...
	<div class="grid_6 singleEnvelope">
		<input type="text" id="singleEnvelope_value_id" maxlength="10" class="form-txt {required:true,decimal:true,range:[1.00,200],messages:{required:'请输入单个红包金额',decimal:'请输入非负数 ，最多保留两位小数点',range:'金额只能输入1到200之间的数'}}" />
	...
	<div class="grid_6">
		<input type="text" id="redEnvelope_act_name"  name="redEnvelope.act_name" maxlength="10" class='form-txt {required:true,messages:{required:"请输入活动名称"}}' />
	</div>
	<div style="clear:both"></div>	
	<div class="grid_4 lable-right">
		<em class="form-req">*</em>
	...
	<div class="grid_6">
		...
		<input type="text"  name="redEnvelope.send_name" id="send_name_id" maxlength="10" class='form-txt {required:true,messages:{required:"请输入商户名称"}}' />
	</div>
	<div style="clear:both"></div>
	<div class="grid_4 lable-right">
		<em class="form-req">*</em>
	...
	<div class="grid_6">
		<input type="text" id="remark"  name="redEnvelope.remark" maxlength="15" class='form-txt {required:true,messages:{required:"请输入备注"}}' />
	</div>
	<div style="clear:both"></div>
	<div class="grid_4 lable-right">
		<em class="form-req">*</em>
	...
	<div class="grid_6">
		<input type="text" id="wishWords" name="redEnvelope.wishing" maxlength="20" class='form-txt {required:true,messages:{required:"请输入祝福语"}}' />
	</div>
	<div style="clear:both"></div>
	<div class="grid_3 lable-right">
	...
	<div class="grid_6">
		<input type="text"  name="redEnvelope.mch_id" maxlength="15" class='form-txt {required:true,messages:{required:"请输入微信支付商户号"}}' />
	</div>
	...
	<div class="grid_6">
		<input type="text"  name="redEnvelope.apiKey" maxlength="32" class='form-txt {required:true,messages:{required:"请输入微信支付商户号API密钥"}}' />
	</div>
	...
	<div class="grid_6">
		<input type="text" id="redEnvelopeWxappid_Id" readonly  name="redEnvelope.wxappid" class='form-txt {required:true,messages:{required:"请选择微信公众平台appID"}}' />
		<input type="hidden" id="weChatUserId_Id"  name="redEnvelope.weChatUserId" />
	</div>
	<div class="grid_2">
	...
	<button type="button" onclick="submitForm()" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only " role="button" aria-disabled="false"><span class="ui-button-text">保存</span></button>
	</div>
	<div style="clear:both"></div>
		...
		<div class="cf">
			<div class="redBox fl">
				...
				<div class="redCont">
					...
					<div class="inforDet">你参加<span class="act">某某活动</span>，成功获得<span class="com">商户某某</span>赠送的红包。</div>
			...
			<div class="redBox fr">
				...
				<div class="redCont">
					...
					<div class="date">xx月xx日</div>
					<div class="inforDet">你成功领取了<span class="com">商户某某</span>发的红包。<br/>红包金额：<label class="price"></label>元</div>
					<div class="wishWords">祝福语！</div>
					<div class="more"><a href="javascript:;">详情</a></div>
				</div>
			</div>
		</div>
...
$(".randomEnvelope").hide();
//获取当前orgId
var currentOrgIdForRedEnvelope = getCurrentOrgId();
$("#currentOrgIdForRedEnvelope").val(currentOrgIdForRedEnvelope);
	//红包类型切换
	...
	function submitForm(){
		...
		$("#createRedEnvelopeForm").submit();
	}
	
	//表单验证
	$("#createRedEnvelopeForm").formValidate({
