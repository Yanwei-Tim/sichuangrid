...
<div class="content">
	<jsp:include page="${path}/fourTeamsManage/fourTeamsIssueManage/convenienceServiceTeam/convenienceFourTeamsIssueForViewButtons.jsp"/>
...
function onOrgChanged(isEvaluate){
	...
	$("#issueList").setPostData({
		...
		"fourTeamsType":"<s:property value='@com.tianque.domain.property.FourTeamsType@CONVENIENCESERVICETEAM'/>",
