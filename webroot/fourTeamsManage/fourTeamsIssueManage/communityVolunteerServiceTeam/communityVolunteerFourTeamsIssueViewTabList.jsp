...
<div id="tabList">
	<ul>
		<li><a href="${path}/fourTeamsManage/fourTeamsIssueManage/communityVolunteerServiceTeam/communityVolunteerFourTeamsIssueForViewList.jsp?viewType=need&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">待办</a> </li>
		...
		-->
		<li><a href="${path}/fourTeamsManage/fourTeamsIssueManage/communityVolunteerServiceTeam/communityVolunteerFourTeamsIssueForViewList.jsp?viewType=done&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">已办</a></li>
		<li><a href="${path}/fourTeamsManage/fourTeamsIssueManage/communityVolunteerServiceTeam/communityVolunteerFourTeamsIssueForViewList.jsp?viewType=completed&orgLevel=<s:property value='#getFullOrgById.organization.orgLevel.internalId'/>&keyId=<s:property value='#getFullOrgById.organization.id'/>&functionalOrgType=<s:property value='#getFullOrgById.organization.functionalOrgType.id'/>">已办结</a></li>
