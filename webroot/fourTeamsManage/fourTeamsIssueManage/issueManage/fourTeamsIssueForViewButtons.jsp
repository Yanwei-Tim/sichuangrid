...
<div class="ui-corner-all nav-buttons" id="nav">
	...
	<pop:JugePermissionTag ename="publicltyCassDoneJurisdictionsIssue">
	...
	<a href="javascript:void(0)" id="grade" style="display: none"><span>打分</span></a>
	<a href="javascript:void(0)" id="gradeHistory"><span>打分详情</span></a>
	...
	<a href="javascript:void(0)" class="jqsubgridButton" id="dealTop" style="display: none"><span class="yijian">办理</span></a>
	<!--<a href="javascript:void(0)" class="jqsubgridButton" id="reportToTop" style="display: none"><span class="yijian">上报指挥中心</span></a>-->
	<div id="searchDiv" style="display:inline-block;*display:inline;zoom:1;overflow:hidden;"> 
	...
	<select onchange="onOrgChanged(this.value)" id="_statusTypeSelect" class="form-txt" style="display: none; width: 70px; float: right;">
		<option value="" selected>全部</option><option value="0">未验证</option><option value="1">已验证</option>
	</select>
