...
.dlg_innerBox .delItemBox a{padding:0 10px;color:#f60;}
   ...
   <div id="issueEdit" class="container container_24">
		<div id=tabs>
			<ul>
				<li><a href="${path}/fourTeamsIssueManage/dispatch.action?mode=editIssueProcessRecord&keyId=<s:property value='issue.id'/>">修改处理过程</a> </li>
				<li><a href="${path}/fourTeamsIssueManage/dispatch.action?mode=edit&keyId=<s:property value='keyId'/>">修改事件处理信息</a> </li>
			</ul>
   		</div>
  </div>
<script>
