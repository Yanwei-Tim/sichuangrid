...
<form id="searchIssueForm" method="post" action="">
		...
		<input id="statusType_search" name="statusType" type="hidden">
   		<div>
   			<div class="grid_3 lable-right">
				<label class="form-lbl">事件类型：</label>
			</div>
			<c:choose>
			    <c:when test="${selectedIssueType == '' || selectedIssueType == 'undefined' }">
			...
			<div class="grid_3 lable-right">
				<label class="form-lbl">评价类型：</label>
			</div>
			<div class="grid_5 lable-right">
				<select id="evaluateType" name="searchIssueVo.evaluateType" style="width:150px">
			...
			<c:if test="${tag =='done'}">
			<div class="grid_3 lable-right">
				<label class="form-lbl">承办情况：</label>
			</div>
			<div class="grid_5 lable-right">
				<select id="issueState" name="searchIssueVo.issueState" style="width:150px">
				<option value="-1">全部</option>
				<option value="1">办理中</option>
				<option value="150">待验证</option>
				<option value="300">已验证</option>
				</select>
			</div>
			</c:if>
			<div class='clearLine'>&nbsp;</div>
...
$(document).ready(function(){
	$("#statusType_search").val($("#_searchStatusType").val());
