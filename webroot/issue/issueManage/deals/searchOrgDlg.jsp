...
<div class="content" >
	<div id="search-condition-form" title="查询" class="container container_24">
		...
		<input type="hidden" id="report12345" value="${report12345}"/>
...
$(document).ready(function(){
	...
	function getSearchAction(){
		if ($("#mode").val()=="searchTarget"){
			return "${path}/issues/issueManage/searchTransferTarget.action?mode=list";
		}else if ($("#mode").val()=="searchTells"){
			return "${path}/issues/issueManage/searchTellTarget.action?mode=list";
		}else{
			return 	"";
		}
	}
